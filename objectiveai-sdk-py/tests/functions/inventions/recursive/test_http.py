...
from objectiveai_sdk.functions.inventions.recursive.http import create_function_invention_recursive
...
globals().update(http_test_suite(
    ...
    chunk_to_unary=objectiveai_sdk_pyo3.function_invention_recursive_chunk_to_unary,
    normalize=objectiveai_sdk_pyo3.normalize_function_invention_recursive_for_tests,
    cases=[
        HttpTestCase(
