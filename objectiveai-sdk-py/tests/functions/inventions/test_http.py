...
from objectiveai_sdk.functions.inventions.http import create_function_invention
...
globals().update(http_test_suite(
    ...
    chunk_to_unary=objectiveai_sdk_pyo3.function_invention_chunk_to_unary,
    normalize=objectiveai_sdk_pyo3.normalize_function_invention_for_tests,
    cases=[
        HttpTestCase(
