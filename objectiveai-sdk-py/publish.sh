#!/usr/bin/env bash
# Publishes objectiveai-sdk-py to PyPI as the `objectiveai-sdk` distribution.
#
...
#   bash objectiveai-sdk-py/publish.sh --build-only     # local single-platform sdist+wheel
#
# Output is captured to .logs/publish/objectiveai-sdk-py.txt.
#
# Setup (one-time):
#   - PYPI_API_TOKEN must be set as a repo secret (and TEST_PYPI_API_TOKEN
#     for --test). See .github/workflows/publish-objectiveai-sdk-py.yml.
...
WORKFLOW_FILE=".github/workflows/publish-objectiveai-sdk-py.yml"
