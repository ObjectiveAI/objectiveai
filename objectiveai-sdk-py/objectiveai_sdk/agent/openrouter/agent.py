...
class Agent(BaseModel):
    ...
    repetition_penalty: Optional[Annotated[float, Field(ge=-3.4028234663852886e+38, le=3.4028234663852886e+38)]] = Field(None, description='Repetition penalty (0.0 to 2.0). Values > 1.0 penalize repetition.', json_schema_extra={'omitempty': True})
    ...
    top_p: Optional[Annotated[float, Field(ge=-3.4028234663852886e+38, le=3.4028234663852886e+38)]] = Field(None, description='Nucleus sampling probability (0.0 to 1.0).', json_schema_extra={'omitempty': True})
