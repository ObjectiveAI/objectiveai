...
from objectiveai_sdk.agent.gemini.effort import Effort
from objectiveai_sdk.agent.gemini.output_mode import OutputMode
...
class AgentBase(BaseModel):
    ...
    model_config = ConfigDict(title='agent.gemini.AgentBase')
    ...
    web_search_enabled: Optional[bool] = Field(None, description='Whether this agent may use the web-search tool.', json_schema_extra={'omitempty': True})
