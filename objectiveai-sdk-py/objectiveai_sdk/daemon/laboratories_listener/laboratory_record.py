...
from objectiveai_sdk.daemon.laboratories_listener.laboratory_attachment import LaboratoryAttachment
...
split — machine identity is the only provenance."""
    model_config = ConfigDict(title='daemon.laboratories_listener.LaboratoryRecord')
