...
from objectiveai_sdk.daemon.agents_instances_listener.attached_laboratory import AttachedLaboratory
...
strings and carries no records."""
    model_config = ConfigDict(title='daemon.agents_instances_listener.AgentRecord')
