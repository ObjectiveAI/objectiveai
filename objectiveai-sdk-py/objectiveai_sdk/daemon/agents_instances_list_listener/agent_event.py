...
from objectiveai_sdk.daemon.agents_instances_list_listener.agent_status import AgentStatus
...
introduces it)."""
    model_config = ConfigDict(title='daemon.agents_instances_list_listener.AgentEvent')
