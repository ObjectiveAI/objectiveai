...
def pyo3_function_profile_computation_chunk_merged(a, b):
    ...
    return objectiveai_sdk_pyo3.function_profile_computation_chunk_merged(a, b)
...
def pyo3_function_profile_computation_chunk_normalized(a):
    ...
    return objectiveai_sdk_pyo3.function_profile_computation_chunk_normalized(a)
...
def pyo3_function_profile_computation_chunk_to_unary(a):
    ...
    return objectiveai_sdk_pyo3.function_profile_computation_chunk_to_unary(a)
...
def pyo3_normalize_function_profile_computation_for_tests(a):
    ...
    return objectiveai_sdk_pyo3.normalize_function_profile_computation_for_tests(a)


def pyo3_generate_function_profile_computation_chunk(seed=None):
    """Generate a random FunctionProfileComputationChunk."""
    return objectiveai_sdk_pyo3.generate_function_profile_computation_chunk(seed)
