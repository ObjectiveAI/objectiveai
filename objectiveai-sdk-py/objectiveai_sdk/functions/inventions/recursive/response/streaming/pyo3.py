...
def pyo3_function_invention_recursive_chunk_merged(a, b):
    ...
    return objectiveai_sdk_pyo3.function_invention_recursive_chunk_merged(a, b)
...
def pyo3_function_invention_recursive_chunk_normalized(a):
    ...
    return objectiveai_sdk_pyo3.function_invention_recursive_chunk_normalized(a)
...
def pyo3_function_invention_recursive_chunk_to_unary(a):
    ...
    return objectiveai_sdk_pyo3.function_invention_recursive_chunk_to_unary(a)
...
def pyo3_normalize_function_invention_recursive_for_tests(a):
    ...
    return objectiveai_sdk_pyo3.normalize_function_invention_recursive_for_tests(a)


def pyo3_generate_function_invention_recursive_chunk(seed=None):
    """Generate a random FunctionInventionRecursiveChunk."""
    return objectiveai_sdk_pyo3.generate_function_invention_recursive_chunk(seed)
