...
from objectiveai_sdk.cli.command.development.plugins.mcp.list.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.plugins.mcp.list.Request')
