...
from objectiveai_sdk.cli.command.development.plugins.mcp.delete.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.plugins.mcp.delete.Request')
