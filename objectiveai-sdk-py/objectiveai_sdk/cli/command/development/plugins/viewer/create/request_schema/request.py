...
from objectiveai_sdk.cli.command.development.plugins.viewer.create.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.plugins.viewer.create.request_schema.Request')
