...
from objectiveai_sdk.cli.command.development.plugins.viewer.delete.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.plugins.viewer.delete.Request')
    ...
    version: str = Field(..., description='Plugin version, matched byte-for-byte.')
