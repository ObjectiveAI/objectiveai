...
from objectiveai_sdk.cli.command.development.plugins.viewer.list.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.plugins.viewer.list.request_schema.Request')
