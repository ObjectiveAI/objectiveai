...
from objectiveai_sdk.cli.command.development.plugins.viewer.list.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.plugins.viewer.list.response_schema.Request')
