...
from objectiveai_sdk.cli.command.development.viewer.delete.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.viewer.delete.response_schema.Request')
