...
from objectiveai_sdk.cli.command.development.viewer.delete.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.viewer.delete.request_schema.Request')
