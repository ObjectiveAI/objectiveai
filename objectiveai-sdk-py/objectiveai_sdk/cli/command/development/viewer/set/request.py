...
from objectiveai_sdk.cli.command.development.viewer.set.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.viewer.set.Request')
    ...
    path: str = Field(..., description='ABSOLUTE path to the `objectiveai-viewer` directory of a source\ncheckout (the one holding `tauri.conf.json`; pnpm resolves the\nworkspace upward from it).')
    path_type: Path
