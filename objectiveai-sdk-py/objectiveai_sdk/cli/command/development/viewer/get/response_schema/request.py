...
from objectiveai_sdk.cli.command.development.viewer.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.development.viewer.get.response_schema.Request')
