...
from objectiveai_sdk.cli.command.mcp.config.address.set.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.mcp.config.address.set.response_schema.Request')
