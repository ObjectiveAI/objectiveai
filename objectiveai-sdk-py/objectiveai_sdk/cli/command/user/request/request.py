...
from objectiveai_sdk.cli.command.user.request.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.user.request.Request')
    ...
    validate_python: Optional[str] = Field(None, description='Optional reply validator: python whose `input` is the full\nreply and whose trailing expression must evaluate `True` to\naccept it.', json_schema_extra={'omitempty': True})
