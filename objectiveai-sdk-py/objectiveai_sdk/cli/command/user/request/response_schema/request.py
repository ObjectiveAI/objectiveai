...
from objectiveai_sdk.cli.command.user.request.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.user.request.response_schema.Request')
