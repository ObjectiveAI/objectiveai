...
from objectiveai_sdk.cli.command.tools.run.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tools.run.response_schema.Request')
