...
from objectiveai_sdk.cli.command.tools.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tools.get.response_schema.Request')
