...
from objectiveai_sdk.cli.command.tools.install.github.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tools.install.github.response_schema.Request')
