...
from objectiveai_sdk.cli.command.plugins.install.github.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.plugins.install.github.response_schema.Request')
