...
from objectiveai_sdk.cli.command.plugins.daemon.notify.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.plugins.daemon.notify.response_schema.Request')
