...
from objectiveai_sdk.cli.command.plugins.logs.list.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.plugins.logs.list.response_schema.Request')
