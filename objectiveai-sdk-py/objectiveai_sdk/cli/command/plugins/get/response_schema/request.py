...
from objectiveai_sdk.cli.command.plugins.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.plugins.get.response_schema.Request')
