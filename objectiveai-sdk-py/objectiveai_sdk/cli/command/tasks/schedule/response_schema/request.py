...
from objectiveai_sdk.cli.command.tasks.schedule.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tasks.schedule.response_schema.Request')
