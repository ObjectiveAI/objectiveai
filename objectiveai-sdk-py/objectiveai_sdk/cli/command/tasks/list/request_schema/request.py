...
from objectiveai_sdk.cli.command.tasks.list.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tasks.list.request_schema.Request')
