...
from objectiveai_sdk.cli.command.tasks.create.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tasks.create.response_schema.Request')
