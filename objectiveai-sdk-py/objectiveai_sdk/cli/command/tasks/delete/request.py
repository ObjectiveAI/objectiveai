...
from objectiveai_sdk.cli.command.tasks.delete.delete_namespace import DeleteNamespace
from objectiveai_sdk.cli.command.tasks.delete.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.tasks.delete.Request')
    ...
    namespace: DeleteNamespace = Field({'namespace': 'caller'}, description="The namespace the id resolves within — defaults to the\ncaller's own plugin identity.")
    path_type: Path
