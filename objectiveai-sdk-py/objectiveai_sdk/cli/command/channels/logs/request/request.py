...
from objectiveai_sdk.cli.command.channels.logs.request.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.logs.request.Request')

    channel_id: str
    content: JsonValue = Field(..., description='Arbitrary message payload, opaque to the daemon.')
    ...
    secret: str = Field(..., description='The publisher secret (`S_pub`).')
