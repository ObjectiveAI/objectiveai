...
from objectiveai_sdk.cli.command.channels.logs.subscribe.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.logs.subscribe.request_schema.Request')
