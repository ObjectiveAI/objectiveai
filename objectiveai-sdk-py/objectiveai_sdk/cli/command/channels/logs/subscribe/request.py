...
from objectiveai_sdk.cli.command.channels.logs.subscribe.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.logs.subscribe.Request')
    ...
    limit: Optional[Annotated[int, Field(ge=-9223372036854775808, le=9223372036854775807)]] = Field(None, description='Cap on entries returned per wake.', json_schema_extra={'omitempty': True})
