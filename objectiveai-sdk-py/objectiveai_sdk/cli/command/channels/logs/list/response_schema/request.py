...
from objectiveai_sdk.cli.command.channels.logs.list.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.logs.list.response_schema.Request')
