...
from objectiveai_sdk.cli.command.channels.logs.open.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.logs.open.Request')

    channel_id: str
    entry_id: int = Field(..., description='The `channel_messages.id` to open.', ge=-9223372036854775808, le=9223372036854775807)
