...
from objectiveai_sdk.cli.command.channels.logs.reply.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.logs.reply.Request')
    ...
    secret: str = Field(..., description='The owner secret (`S_owner`).')
