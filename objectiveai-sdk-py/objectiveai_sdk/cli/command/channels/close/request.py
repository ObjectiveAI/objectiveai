...
from objectiveai_sdk.cli.command.channels.close.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.close.Request')

    channel_id: str = Field(..., description='The channel to close.')
    ...
    secret: str = Field(..., description='A channel secret — `S_pub` or `S_owner`; either authorizes.')
