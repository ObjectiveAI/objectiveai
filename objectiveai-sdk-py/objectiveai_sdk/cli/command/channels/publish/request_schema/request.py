...
from objectiveai_sdk.cli.command.channels.publish.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.channels.publish.request_schema.Request')
