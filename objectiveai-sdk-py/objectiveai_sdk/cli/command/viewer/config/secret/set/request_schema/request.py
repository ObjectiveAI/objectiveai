...
from objectiveai_sdk.cli.command.viewer.config.secret.set.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.viewer.config.secret.set.request_schema.Request')
