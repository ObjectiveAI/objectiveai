...
from objectiveai_sdk.cli.command.viewer.config.secret.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.viewer.config.secret.get.response_schema.Request')
