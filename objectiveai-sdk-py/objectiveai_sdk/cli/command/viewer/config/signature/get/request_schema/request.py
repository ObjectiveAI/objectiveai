...
from objectiveai_sdk.cli.command.viewer.config.signature.get.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.viewer.config.signature.get.request_schema.Request')
