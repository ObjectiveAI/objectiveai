...
from objectiveai_sdk.cli.command.viewer.generate_secret_signature_pair.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.viewer.generate_secret_signature_pair.response_schema.Request')
