...
from objectiveai_sdk.cli.command.swarms.publish.path import Path
from objectiveai_sdk.cli.command.swarms.publish.request_body import RequestBody
from objectiveai_sdk.cli.command.swarms.publish.request_publish_message import RequestPublishMessage


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.swarms.publish.Request')
