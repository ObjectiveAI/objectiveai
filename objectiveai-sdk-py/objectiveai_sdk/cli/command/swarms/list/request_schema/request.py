...
from objectiveai_sdk.cli.command.swarms.list.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.swarms.list.request_schema.Request')
