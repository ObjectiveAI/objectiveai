...
from objectiveai_sdk.cli.command.agents.tools.call.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.tools.call.response_schema.Request')
