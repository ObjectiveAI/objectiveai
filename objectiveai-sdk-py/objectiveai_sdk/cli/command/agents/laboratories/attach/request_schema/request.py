...
from objectiveai_sdk.cli.command.agents.laboratories.attach.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.laboratories.attach.request_schema.Request')
