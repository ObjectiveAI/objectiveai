...
from objectiveai_sdk.cli.command.agents.laboratories.detach.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.laboratories.detach.request_schema.Request')
