...
from objectiveai_sdk.cli.command.agents.laboratories.detach.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.laboratories.detach.response_schema.Request')
