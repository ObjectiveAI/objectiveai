...
from objectiveai_sdk.cli.command.agents.logs.token_usage.subscribe.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.logs.token_usage.subscribe.request_schema.Request')
