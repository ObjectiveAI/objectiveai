...
class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.logs.token_usage.get.Request')

    agent_instance_hierarchy: str = Field(..., description='The full agent instance hierarchy to read.')
