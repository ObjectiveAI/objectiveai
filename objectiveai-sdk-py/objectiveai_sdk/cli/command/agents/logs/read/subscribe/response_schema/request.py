...
from objectiveai_sdk.cli.command.agents.logs.read.subscribe.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.logs.read.subscribe.response_schema.Request')
