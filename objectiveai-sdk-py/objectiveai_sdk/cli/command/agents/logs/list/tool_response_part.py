...
from objectiveai_sdk.cli.command.agents.logs.list.tool_response_part_type import ToolResponsePartType


class ToolResponsePart(BaseModel):
    """One row inside a `ToolResponse` block."""
    model_config = ConfigDict(title='cli.command.agents.logs.list.ToolResponsePart')
