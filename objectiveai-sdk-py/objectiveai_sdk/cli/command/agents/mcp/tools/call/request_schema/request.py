...
from objectiveai_sdk.cli.command.agents.mcp.tools.call.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.mcp.tools.call.request_schema.Request')
