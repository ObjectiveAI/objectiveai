...
from objectiveai_sdk.cli.command.agents.mcp.resources.list.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.mcp.resources.list.response_schema.Request')
