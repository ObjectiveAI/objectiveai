...
from objectiveai_sdk.cli.command.agents.mcp.resources.read.path import Path
from objectiveai_sdk.mcp.resource.read_resource_request_params import ReadResourceRequestParams


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.mcp.resources.read.Request')
