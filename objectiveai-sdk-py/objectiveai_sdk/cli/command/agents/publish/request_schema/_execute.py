...
from objectiveai_sdk.cli.command.agents.publish.request_schema.request import Request
...
async def execute(executor: CommandExecutor, request: Request) -> Union[CliError, JsonValue]:
    ...
    if first is None:
        raise RuntimeError("agents publish request_schema: cli produced no output before the end marker")
    return first
