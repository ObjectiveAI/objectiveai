...
from objectiveai_sdk.cli.command.agents.enqueue.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.enqueue.request_schema.Request')
