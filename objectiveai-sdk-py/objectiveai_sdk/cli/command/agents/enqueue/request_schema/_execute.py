...
from objectiveai_sdk.cli.command.agents.enqueue.request_schema.request import Request
...
async def execute(executor: CommandExecutor, request: Request) -> Union[CliError, JsonValue]:
    ...
    if first is None:
        raise RuntimeError("agents enqueue request_schema: cli produced no output before the end marker")
    return first
