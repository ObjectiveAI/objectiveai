...
from objectiveai_sdk.cli.command.agents.queue.open.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.queue.open.request_schema.Request')
