...
from objectiveai_sdk.cli.command.agents.queue.deliver.request_dangerous_advanced import RequestDangerousAdvanced


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.queue.deliver.Request')
