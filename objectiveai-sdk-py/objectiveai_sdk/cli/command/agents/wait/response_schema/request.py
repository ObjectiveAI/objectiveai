...
from objectiveai_sdk.cli.command.agents.wait.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.wait.response_schema.Request')
