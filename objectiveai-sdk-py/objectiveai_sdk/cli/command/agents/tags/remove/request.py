...
from objectiveai_sdk.cli.command.agents.tags.remove.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.tags.remove.Request')
    ...
    tag: str = Field(..., description='Tag name to remove (the global registry key).')
