...
from objectiveai_sdk.cli.command.agents.tags.remove.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.tags.remove.response_schema.Request')
