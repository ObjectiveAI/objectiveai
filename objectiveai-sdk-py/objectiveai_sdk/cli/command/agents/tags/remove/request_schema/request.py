...
from objectiveai_sdk.cli.command.agents.tags.remove.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.tags.remove.request_schema.Request')
