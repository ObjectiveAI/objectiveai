...
from objectiveai_sdk.cli.command.agents.tags.lookup.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.agents.tags.lookup.request_schema.Request')
