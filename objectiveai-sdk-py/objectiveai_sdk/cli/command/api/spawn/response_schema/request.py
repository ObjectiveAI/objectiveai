...
from objectiveai_sdk.cli.command.api.spawn.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.spawn.response_schema.Request')
