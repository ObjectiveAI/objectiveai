...
from objectiveai_sdk.cli.command.api.config.objectiveai_authorization.get.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.objectiveai_authorization.get.request_schema.Request')
