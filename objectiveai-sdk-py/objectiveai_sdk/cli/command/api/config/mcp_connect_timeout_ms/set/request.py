...
from objectiveai_sdk.cli.command.api.config.mcp_connect_timeout_ms.set.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.mcp_connect_timeout_ms.set.Request')
