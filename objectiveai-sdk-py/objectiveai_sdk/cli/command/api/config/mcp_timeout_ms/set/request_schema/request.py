...
from objectiveai_sdk.cli.command.api.config.mcp_timeout_ms.set.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.mcp_timeout_ms.set.request_schema.Request')
