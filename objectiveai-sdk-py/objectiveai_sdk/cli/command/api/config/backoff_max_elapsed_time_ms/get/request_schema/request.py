...
from objectiveai_sdk.cli.command.api.config.backoff_max_elapsed_time_ms.get.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.backoff_max_elapsed_time_ms.get.request_schema.Request')
