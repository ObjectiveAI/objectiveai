...
from objectiveai_sdk.cli.command.api.config.x_title.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.x_title.get.response_schema.Request')
