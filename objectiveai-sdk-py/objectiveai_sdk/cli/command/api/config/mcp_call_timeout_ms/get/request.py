...
from objectiveai_sdk.cli.command.api.config.mcp_call_timeout_ms.get.path import Path
from objectiveai_sdk.cli.command.get_scope import GetScope


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.mcp_call_timeout_ms.get.Request')
