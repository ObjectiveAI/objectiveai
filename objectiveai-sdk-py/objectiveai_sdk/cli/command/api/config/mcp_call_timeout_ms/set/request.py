...
from objectiveai_sdk.cli.command.api.config.mcp_call_timeout_ms.set.path import Path
from objectiveai_sdk.cli.command.set_scope import SetScope


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.mcp_call_timeout_ms.set.Request')
