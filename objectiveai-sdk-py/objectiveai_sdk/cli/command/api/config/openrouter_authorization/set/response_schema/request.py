...
from objectiveai_sdk.cli.command.api.config.openrouter_authorization.set.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.openrouter_authorization.set.response_schema.Request')
