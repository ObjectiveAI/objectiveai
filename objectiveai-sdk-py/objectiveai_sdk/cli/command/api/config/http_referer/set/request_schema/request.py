...
from objectiveai_sdk.cli.command.api.config.http_referer.set.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.http_referer.set.request_schema.Request')
