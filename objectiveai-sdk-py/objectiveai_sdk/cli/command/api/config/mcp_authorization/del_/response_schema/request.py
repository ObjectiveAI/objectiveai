...
from objectiveai_sdk.cli.command.api.config.mcp_authorization.del_.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.mcp_authorization.del.response_schema.Request')
