...
from objectiveai_sdk.cli.command.api.config.mcp_backoff.set.path import Path
from objectiveai_sdk.cli.command.set_scope import SetScope


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.mcp_backoff.set.Request')
    ...
    value: str = Field(..., description='The new backoff, as a single JSON blob (an `mcp.Backoff` object).\nCarried verbatim as a string here; the cli handler parses it.')
