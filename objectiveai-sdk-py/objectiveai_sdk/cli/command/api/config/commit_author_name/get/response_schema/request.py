...
from objectiveai_sdk.cli.command.api.config.commit_author_name.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.api.config.commit_author_name.get.response_schema.Request')
