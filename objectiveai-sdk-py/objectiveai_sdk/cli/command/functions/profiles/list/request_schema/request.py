...
from objectiveai_sdk.cli.command.functions.profiles.list.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.functions.profiles.list.request_schema.Request')
