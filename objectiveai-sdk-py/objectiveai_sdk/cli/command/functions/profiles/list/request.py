...
from objectiveai_sdk.cli.command.functions.profiles.list.path import Path
from objectiveai_sdk.cli.command.functions.profiles.list.request_source import RequestSource


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.functions.profiles.list.Request')
