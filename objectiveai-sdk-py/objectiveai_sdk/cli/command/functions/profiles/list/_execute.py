...
from objectiveai_sdk.cli.command.functions.profiles.list.request import Request
...
_execute_adapter = TypeAdapter(
    Annotated[Union[CliError, RemotePath], Field(union_mode="left_to_right")]
)


def execute(executor: CommandExecutor, request: Request) -> CliStream[Union[CliError, RemotePath]]:
