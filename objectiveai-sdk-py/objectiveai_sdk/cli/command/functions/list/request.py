...
from objectiveai_sdk.cli.command.functions.list.path import Path
from objectiveai_sdk.cli.command.functions.list.request_source import RequestSource


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.functions.list.Request')
