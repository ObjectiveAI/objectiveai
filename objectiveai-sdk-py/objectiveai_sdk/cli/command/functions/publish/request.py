...
from objectiveai_sdk.cli.command.functions.publish.path import Path
from objectiveai_sdk.cli.command.functions.publish.request_body import RequestBody
from objectiveai_sdk.cli.command.functions.publish.request_publish_message import RequestPublishMessage


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.functions.publish.Request')
