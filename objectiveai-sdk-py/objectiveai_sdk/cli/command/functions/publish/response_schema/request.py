...
from objectiveai_sdk.cli.command.functions.publish.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.functions.publish.response_schema.Request')
