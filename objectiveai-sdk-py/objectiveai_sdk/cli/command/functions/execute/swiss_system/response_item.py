...
from objectiveai_sdk.cli.command.functions.execute.swiss_system.agent_instance_hierarchy import AgentInstanceHierarchy
...
class ResponseItem(RootModel):
    model_config = ConfigDict(title='cli.command.functions.execute.swiss_system.ResponseItem')
