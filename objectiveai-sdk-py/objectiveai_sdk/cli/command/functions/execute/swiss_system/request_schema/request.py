...
from objectiveai_sdk.cli.command.functions.execute.swiss_system.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.functions.execute.swiss_system.request_schema.Request')
