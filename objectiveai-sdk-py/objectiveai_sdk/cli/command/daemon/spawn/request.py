...
from objectiveai_sdk.cli.command.daemon.spawn.request_dangerous_advanced import RequestDangerousAdvanced


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.spawn.Request')
