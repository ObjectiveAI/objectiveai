...
from objectiveai_sdk.cli.command.daemon.spawn.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.spawn.response_schema.Request')
