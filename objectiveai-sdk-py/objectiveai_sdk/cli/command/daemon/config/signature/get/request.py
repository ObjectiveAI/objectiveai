...
from objectiveai_sdk.cli.command.daemon.config.signature.get.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.config.signature.get.Request')
