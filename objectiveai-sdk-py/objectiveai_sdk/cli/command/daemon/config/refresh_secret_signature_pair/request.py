...
from objectiveai_sdk.cli.command.daemon.config.refresh_secret_signature_pair.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.config.refresh_secret_signature_pair.Request')
