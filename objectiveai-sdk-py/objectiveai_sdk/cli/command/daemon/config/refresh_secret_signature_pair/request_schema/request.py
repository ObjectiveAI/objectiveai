...
from objectiveai_sdk.cli.command.daemon.config.refresh_secret_signature_pair.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.config.refresh_secret_signature_pair.request_schema.Request')
