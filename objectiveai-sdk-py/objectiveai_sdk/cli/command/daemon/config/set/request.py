...
from objectiveai_sdk.cli.command.daemon.config.set.path import Path
from objectiveai_sdk.cli.command.daemon.config.set.value import Value


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.config.set.Request')
