...
from objectiveai_sdk.cli.command.daemon.config.address.get.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.daemon.config.address.get.request_schema.Request')
