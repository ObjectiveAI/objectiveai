...
from objectiveai_sdk.cli.command.laboratories.detach.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.detach.response_schema.Request')
