...
from objectiveai_sdk.cli.command.laboratories.kill.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.kill.request_schema.Request')
