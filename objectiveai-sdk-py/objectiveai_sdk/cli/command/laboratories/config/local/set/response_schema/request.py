...
from objectiveai_sdk.cli.command.laboratories.config.local.set.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.config.local.set.response_schema.Request')
