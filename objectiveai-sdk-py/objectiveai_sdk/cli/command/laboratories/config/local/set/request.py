...
from objectiveai_sdk.cli.command.laboratories.config.local.set.path import Path
from objectiveai_sdk.cli.command.set_scope import SetScope


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.config.local.set.Request')
