...
from objectiveai_sdk.cli.command.laboratories.config.local.get.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.config.local.get.Request')
