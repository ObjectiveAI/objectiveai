...
from objectiveai_sdk.cli.command.laboratories.config.addresses.get.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.config.addresses.get.Request')
