...
from objectiveai_sdk.cli.command.laboratories.config.addresses.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.config.addresses.get.response_schema.Request')
