...
from objectiveai_sdk.cli.command.laboratories.config.addresses.del_.request_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.laboratories.config.addresses.del.request_schema.Request')
