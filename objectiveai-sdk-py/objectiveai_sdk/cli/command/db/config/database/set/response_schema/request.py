...
from objectiveai_sdk.cli.command.db.config.database.set.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.db.config.database.set.response_schema.Request')
