...
from objectiveai_sdk.cli.command.db.config.set.path import Path
from objectiveai_sdk.cli.command.db.config.set.value import Value


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.db.config.set.Request')
