...
from objectiveai_sdk.cli.command.db.config.password.get.response_schema.path import Path


class Request(BaseModel):
    model_config = ConfigDict(title='cli.command.db.config.password.get.response_schema.Request')
