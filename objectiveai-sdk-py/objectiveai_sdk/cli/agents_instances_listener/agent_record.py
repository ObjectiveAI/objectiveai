...
from objectiveai_sdk.cli.agents_instances_listener.attached_laboratory import AttachedLaboratory
...
strings and carries no records."""
    model_config = ConfigDict(title='cli.agents_instances_listener.AgentRecord')
