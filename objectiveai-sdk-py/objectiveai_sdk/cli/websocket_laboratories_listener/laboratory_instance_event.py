...
from objectiveai_sdk.cli.websocket_laboratories_listener.laboratory_record import LaboratoryRecord
...
only when a second variant joins."""
    model_config = ConfigDict(title='cli.websocket_laboratories_listener.LaboratoryInstanceEvent')
