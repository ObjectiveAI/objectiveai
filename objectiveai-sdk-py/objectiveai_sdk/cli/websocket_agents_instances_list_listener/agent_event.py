...
from objectiveai_sdk.cli.websocket_agents_instances_list_listener.agent_status import AgentStatus
...
introduces it)."""
    model_config = ConfigDict(title='cli.websocket_agents_instances_list_listener.AgentEvent')
