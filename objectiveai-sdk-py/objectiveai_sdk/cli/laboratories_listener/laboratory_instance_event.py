...
from objectiveai_sdk.cli.laboratories_listener.laboratory_record import LaboratoryRecord
...
only when a second variant joins."""
    model_config = ConfigDict(title='cli.laboratories_listener.LaboratoryInstanceEvent')
