...
from objectiveai_sdk.cli.laboratories_listener.laboratory_attachment import LaboratoryAttachment
...
split — machine identity is the only provenance."""
    model_config = ConfigDict(title='cli.laboratories_listener.LaboratoryRecord')
