...
use crate::wire::frame::auth::Auth;
...
pub struct Session {
    ...
    /// [`connection`](crate::wire::connection) for why a
    ...
    /// [`client::router::Router`](crate::wire::client::router::Router)'s
...
impl Session {
    ...
    /// read will say.
    pub async fn send_auth(&self, auth: Auth<'_>) {
    ...
    ///
    /// A [`Channel`](super::channel::Channel) being dropped is not
    ...
    /// [`Channel`](super::channel::Channel) dropped sends a notice
