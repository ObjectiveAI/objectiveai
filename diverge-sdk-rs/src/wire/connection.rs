...
///
/// The one place it shows is [`auth`](crate::wire::frame::auth): the end
...
/// [`ClientFrame`](crate::wire::frame::client::ClientFrame)'s and
/// [`ServerFrame`](crate::wire::frame::server::ServerFrame)'s, and which of
