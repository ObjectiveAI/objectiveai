...
//! the sixteen in [`ClientRequest`](crate::provider::endpoints::ClientRequest), and a
...
//! name becomes
//! [`Invalid`](crate::provider::endpoints::ClientRequest::Invalid) rather than a
...
//! [`endpoints`](crate::provider::endpoints) rather than here: it takes the next
