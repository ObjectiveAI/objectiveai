//! Asking for a resource to be read.
...
///
/// The URI is the server's to interpret. A relay that resolved one
/// would be deciding what a resource is.
///
