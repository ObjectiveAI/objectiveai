//! What a client's response frame carries on a fuse mkdir channel.

/// Ok, or an error. See [`fuse::mkdir::response::Frame`](crate::shared::containers::fuse::mkdir::response::Frame).
///
