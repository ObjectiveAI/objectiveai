...
use crate::provider::endpoints::volumes::serve::client::{channel_request, request};
use crate::wire::frame::client::ClientFrame;
use crate::wire::server::scope_handle::ScopeHandle;
use crate::provider::server::served::Served;
...
/// [`mounted`](crate::provider::server::volume::Volume::mount) — the shared
