...
use super::volume;
use crate::provider::endpoints::volumes::create::server::response::Creation;
use crate::provider::endpoints::volumes::Mode;
use crate::provider::endpoints::volumes::list::server::response::Volume;

/// A namespace of named directories, one per caller.
///
/// The eleven [`volumes`](crate::provider::endpoints::volumes) endpoints are
...
pub trait VolumeManager: Send + Sync {
    ...
    /// `'static`, since a run keeps a handle for its life and a
    /// watch of it beside the tasks that serve the run.
    ...
    /// a [`name`](crate::provider::endpoints::volumes::list::server::response::Volume::name)
    ...
    /// [`Created`](crate::provider::endpoints::volumes::create::server::response::Frame::Created)
    ...
    /// [`bytes`](crate::provider::endpoints::volumes::list::server::response::Volume::bytes)
    /// without being answered
    /// [`Edit::InsufficientCapacity`](crate::provider::endpoints::volumes::edit::server::response::Edit::InsufficientCapacity),
    ...
    /// and answers
    /// [`Mounted`](crate::provider::endpoints::volumes::delete::server::response::Frame::Mounted)
