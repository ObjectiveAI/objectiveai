...
use crate::provider::endpoints::images::check::server::response::Response;

/// Answers one question: would you supply this image, to this caller.
///
/// [`images::check`](crate::provider::endpoints::images::check) is the whole of
...
/// [`request::Frame`](crate::provider::endpoints::images::check::client::request::Frame),
