...
///   [`serve`](crate::provider::endpoints::volumes::serve) takes the same
...
///   the file, a [`write`](crate::provider::endpoints::volumes::write) until
///   the file has landed, a
///   [`filetree`](crate::provider::endpoints::volumes::filetree) for the length
///   of the walk, an [`edit`](crate::provider::endpoints::volumes::edit) for
///   the length of the change, and a
///   [`delete`](crate::provider::endpoints::volumes::delete) takes it and never
...
pub trait Volume: Send + Sync {
    ...
    ///
    /// Because [`name`](crate::provider::endpoints::volumes::list::server::response::Volume::name)
