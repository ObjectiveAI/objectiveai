...
/// every [`containers`](crate::provider::endpoints::containers) scope needs. An
...
/// beside [`Session`](crate::wire::server::session::Session) and for the same reason:
...
/// [`container_proxy_endpoints`](crate::container_proxy::outside) into the container and
...
/// [`OUTSIDE_PORT`](crate::container_proxy::outside::OUTSIDE_PORT). A
...
pub trait ContainerDeployer: Send + Sync {
    ...
    /// [`images::check`](crate::provider::endpoints::images::check) asks about,
