...
/// for as long as a [`serve`](crate::provider::endpoints::volumes::serve) scope
/// lives.
///
/// The caller's [`FuseServer`](crate::provider::client::FuseServer) with the
...
/// [`Mode`](crate::provider::endpoints::volumes::Mode); what this returns does.
