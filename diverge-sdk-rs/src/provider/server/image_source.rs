...
/// [`OciManifest`](crate::provider::endpoints::containers::agents::run::server::channel_request::Frame::OciManifest)
/// answered by one frame, [`OciBlob`](crate::provider::endpoints::containers::agents::run::server::channel_request::Frame::OciBlob)
