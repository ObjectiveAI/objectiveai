...
use crate::container_proxy::inside::{Client, Error};
...
/// place the address is spelled: built from [`INSIDE_PORT`](super::INSIDE_PORT)
...
pub fn mcp_url() -> String {
    crate::container_proxy::inside::url(MCP)
}
