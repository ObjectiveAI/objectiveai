//! What a client's response frame carries on a notifications channel.

/// A notification, as they come. See [`mcp::notifications::response::Frame`](crate::shared::mcp::notifications::response::Frame).
///
