//! What a server's response frame carries for a write.
...
/// has: the proxy answers when it knows.
///
...
/// [`Error`](Self::Error) beside it is the exchange's own: a missing
/// parent, a destination that cannot be replaced, content that ended
/// in an error.
