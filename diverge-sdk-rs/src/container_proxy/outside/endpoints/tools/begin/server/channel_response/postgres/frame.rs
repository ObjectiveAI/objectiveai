...
/// pgwire as the container's driver wrote it, on its way to the caller's database. See [`postgres::response::Frame`](crate::shared::containers::postgres::response::Frame).
///
