...
export const FunctionsUsageFunctionProfilePairResponseSchema = z.object({
  ...
  requests: z.number().int().min(0).max(18446744073709552000).describe("Total number of requests made with this function-profile pair."),
...
export type FunctionsUsageFunctionProfilePairResponse = z.infer<typeof FunctionsUsageFunctionProfilePairResponseSchema>;
