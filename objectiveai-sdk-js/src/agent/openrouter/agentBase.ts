...
export const AgentOpenrouterAgentBaseSchema = z.object({
  ...
  repetition_penalty: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Repetition penalty (0.0 to 2.0). Values > 1.0 penalize repetition.").meta({ omitempty: true }).optional(),
  ...
  top_p: z.number().min(-3.4028234663852886e+38).max(3.4028234663852886e+38).nullable().describe("Nucleus sampling probability (0.0 to 1.0).").meta({ omitempty: true }).optional(),
