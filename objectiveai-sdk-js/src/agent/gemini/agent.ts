...
export const AgentGeminiAgentSchema = z.object({
...
}).describe("A validated Gemini Agent with its computed content-addressed ID.").meta({ title: "agent.gemini.Agent" });
export type AgentGeminiAgent = z.infer<typeof AgentGeminiAgentSchema>;
