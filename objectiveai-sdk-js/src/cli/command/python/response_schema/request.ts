...
import { z } from "zod";
import { CliCommandPythonResponseSchemaPathSchema } from "./path";

export const CliCommandPythonResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandPythonResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.python.response_schema.Request" });
export type CliCommandPythonResponseSchemaRequest = z.infer<typeof CliCommandPythonResponseSchemaRequestSchema>;
