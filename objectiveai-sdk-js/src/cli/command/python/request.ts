...
export const CliCommandPythonRequestSchema = z.object({
  ...
  no_objectiveai: z.boolean().nullable().describe("When set, `objectiveai.execute(...)` inside the embedded python\nraises instead of dispatching a CLI command.").meta({ omitempty: true }).optional(),
...
export type CliCommandPythonRequest = z.infer<typeof CliCommandPythonRequestSchema>;
