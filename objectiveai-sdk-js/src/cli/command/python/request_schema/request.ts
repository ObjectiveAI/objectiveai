...
import { z } from "zod";
import { CliCommandPythonRequestSchemaPathSchema } from "./path";

export const CliCommandPythonRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandPythonRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.python.request_schema.Request" });
export type CliCommandPythonRequestSchemaRequest = z.infer<typeof CliCommandPythonRequestSchemaRequestSchema>;
