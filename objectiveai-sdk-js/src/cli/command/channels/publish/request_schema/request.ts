...
import { z } from "zod";
import { CliCommandChannelsPublishRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsPublishRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsPublishRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.publish.request_schema.Request" });
export type CliCommandChannelsPublishRequestSchemaRequest = z.infer<typeof CliCommandChannelsPublishRequestSchemaRequestSchema>;
