...
import { z } from "zod";
import { CliCommandChannelsPublishResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsPublishResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsPublishResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.publish.response_schema.Request" });
export type CliCommandChannelsPublishResponseSchemaRequest = z.infer<typeof CliCommandChannelsPublishResponseSchemaRequestSchema>;
