...
import { z } from "zod";
import { CliCommandChannelsCloseResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsCloseResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsCloseResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.close.response_schema.Request" });
export type CliCommandChannelsCloseResponseSchemaRequest = z.infer<typeof CliCommandChannelsCloseResponseSchemaRequestSchema>;
