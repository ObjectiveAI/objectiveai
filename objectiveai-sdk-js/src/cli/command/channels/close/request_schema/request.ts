...
import { z } from "zod";
import { CliCommandChannelsCloseRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsCloseRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsCloseRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.close.request_schema.Request" });
export type CliCommandChannelsCloseRequestSchemaRequest = z.infer<typeof CliCommandChannelsCloseRequestSchemaRequestSchema>;
