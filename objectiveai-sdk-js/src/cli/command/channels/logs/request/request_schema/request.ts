...
import { z } from "zod";
import { CliCommandChannelsLogsRequestRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsRequestRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsRequestRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.request.request_schema.Request" });
export type CliCommandChannelsLogsRequestRequestSchemaRequest = z.infer<typeof CliCommandChannelsLogsRequestRequestSchemaRequestSchema>;
