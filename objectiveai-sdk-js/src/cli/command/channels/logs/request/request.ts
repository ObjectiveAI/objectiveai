...
import { CliCommandChannelsLogsRequestPathSchema } from "./path";

export const CliCommandChannelsLogsRequestRequestSchema = z.object({
  channel_id: z.string(),
  content: JsonValueSchema.describe("Arbitrary message payload, opaque to the daemon."),
  ...
  path_type: CliCommandChannelsLogsRequestPathSchema,
  ...
  secret: z.string().describe("The publisher secret (`S_pub`)."),
...
}).meta({ title: "cli.command.channels.logs.request.Request" });
export type CliCommandChannelsLogsRequestRequest = z.infer<typeof CliCommandChannelsLogsRequestRequestSchema>;
