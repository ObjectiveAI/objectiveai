...
import { z } from "zod";
import { CliCommandChannelsLogsRequestResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsRequestResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsRequestResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.request.response_schema.Request" });
export type CliCommandChannelsLogsRequestResponseSchemaRequest = z.infer<typeof CliCommandChannelsLogsRequestResponseSchemaRequestSchema>;
