...
import { z } from "zod";
import { CliCommandChannelsLogsOpenRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsOpenRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsOpenRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.open.request_schema.Request" });
export type CliCommandChannelsLogsOpenRequestSchemaRequest = z.infer<typeof CliCommandChannelsLogsOpenRequestSchemaRequestSchema>;
