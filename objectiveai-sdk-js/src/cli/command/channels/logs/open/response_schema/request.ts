...
import { z } from "zod";
import { CliCommandChannelsLogsOpenResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsOpenResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsOpenResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.open.response_schema.Request" });
export type CliCommandChannelsLogsOpenResponseSchemaRequest = z.infer<typeof CliCommandChannelsLogsOpenResponseSchemaRequestSchema>;
