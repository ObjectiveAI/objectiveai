...
import { z } from "zod";
import { CliCommandChannelsLogsSubscribeResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsSubscribeResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsSubscribeResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.subscribe.response_schema.Request" });
export type CliCommandChannelsLogsSubscribeResponseSchemaRequest = z.infer<typeof CliCommandChannelsLogsSubscribeResponseSchemaRequestSchema>;
