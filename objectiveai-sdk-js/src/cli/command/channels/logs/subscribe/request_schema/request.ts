...
import { z } from "zod";
import { CliCommandChannelsLogsSubscribeRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsSubscribeRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsSubscribeRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.subscribe.request_schema.Request" });
export type CliCommandChannelsLogsSubscribeRequestSchemaRequest = z.infer<typeof CliCommandChannelsLogsSubscribeRequestSchemaRequestSchema>;
