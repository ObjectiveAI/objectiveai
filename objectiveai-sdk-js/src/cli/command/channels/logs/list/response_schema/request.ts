...
import { z } from "zod";
import { CliCommandChannelsLogsListResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.list.response_schema.Request" });
export type CliCommandChannelsLogsListResponseSchemaRequest = z.infer<typeof CliCommandChannelsLogsListResponseSchemaRequestSchema>;
