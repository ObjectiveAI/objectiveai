...
import { z } from "zod";
import { CliCommandChannelsLogsListRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.list.request_schema.Request" });
export type CliCommandChannelsLogsListRequestSchemaRequest = z.infer<typeof CliCommandChannelsLogsListRequestSchemaRequestSchema>;
