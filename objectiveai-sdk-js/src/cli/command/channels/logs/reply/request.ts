...
import { CliCommandChannelsLogsReplyPathSchema } from "./path";

export const CliCommandChannelsLogsReplyRequestSchema = z.object({
  channel_id: z.string(),
  ...
  path_type: CliCommandChannelsLogsReplyPathSchema,
  ...
  secret: z.string().describe("The owner secret (`S_owner`)."),
...
}).meta({ title: "cli.command.channels.logs.reply.Request" });
export type CliCommandChannelsLogsReplyRequest = z.infer<typeof CliCommandChannelsLogsReplyRequestSchema>;
