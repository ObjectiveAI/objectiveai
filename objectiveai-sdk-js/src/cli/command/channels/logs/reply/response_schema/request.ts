...
import { z } from "zod";
import { CliCommandChannelsLogsReplyResponseSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsReplyResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsReplyResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.reply.response_schema.Request" });
export type CliCommandChannelsLogsReplyResponseSchemaRequest = z.infer<typeof CliCommandChannelsLogsReplyResponseSchemaRequestSchema>;
