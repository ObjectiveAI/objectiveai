...
import { z } from "zod";
import { CliCommandChannelsLogsReplyRequestSchemaPathSchema } from "./path";

export const CliCommandChannelsLogsReplyRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandChannelsLogsReplyRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.channels.logs.reply.request_schema.Request" });
export type CliCommandChannelsLogsReplyRequestSchemaRequest = z.infer<typeof CliCommandChannelsLogsReplyRequestSchemaRequestSchema>;
