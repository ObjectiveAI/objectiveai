...
export const CliCommandRequestBaseSchema = z.object({
...
}).meta({ title: "cli.command.RequestBase" });
export type CliCommandRequestBase = z.infer<typeof CliCommandRequestBaseSchema>;
