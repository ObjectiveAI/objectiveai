...
import { z } from "zod";
import { CliCommandAgentsTagsRemovePathSchema } from "./path";

export const CliCommandAgentsTagsRemoveRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsTagsRemovePathSchema,
  ...
  tag: z.string().describe("Tag name to remove (the global registry key)."),
...
}).meta({ title: "cli.command.agents.tags.remove.Request" });
export type CliCommandAgentsTagsRemoveRequest = z.infer<typeof CliCommandAgentsTagsRemoveRequestSchema>;
