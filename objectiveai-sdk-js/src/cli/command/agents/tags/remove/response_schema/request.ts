...
import { z } from "zod";
import { CliCommandAgentsTagsRemoveResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsTagsRemoveResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsTagsRemoveResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.tags.remove.response_schema.Request" });
export type CliCommandAgentsTagsRemoveResponseSchemaRequest = z.infer<typeof CliCommandAgentsTagsRemoveResponseSchemaRequestSchema>;
