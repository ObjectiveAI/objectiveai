...
import { z } from "zod";
import { CliCommandAgentsTagsRemoveRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsTagsRemoveRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsTagsRemoveRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.tags.remove.request_schema.Request" });
export type CliCommandAgentsTagsRemoveRequestSchemaRequest = z.infer<typeof CliCommandAgentsTagsRemoveRequestSchemaRequestSchema>;
