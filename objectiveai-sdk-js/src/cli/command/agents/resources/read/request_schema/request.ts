...
import { z } from "zod";
import { CliCommandAgentsResourcesReadRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsResourcesReadRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsResourcesReadRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.resources.read.request_schema.Request" });
export type CliCommandAgentsResourcesReadRequestSchemaRequest = z.infer<typeof CliCommandAgentsResourcesReadRequestSchemaRequestSchema>;
