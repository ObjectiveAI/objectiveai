...
import { z } from "zod";
import { CliCommandAgentsResourcesReadResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsResourcesReadResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsResourcesReadResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.resources.read.response_schema.Request" });
export type CliCommandAgentsResourcesReadResponseSchemaRequest = z.infer<typeof CliCommandAgentsResourcesReadResponseSchemaRequestSchema>;
