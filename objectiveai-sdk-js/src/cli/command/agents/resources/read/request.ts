...
import { z } from "zod";
import { CliCommandAgentsResourcesReadPathSchema } from "./path";
import { McpResourceReadResourceRequestParamsSchema } from "../../../../../mcp/resource/readResourceRequestParams";

export const CliCommandAgentsResourcesReadRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsResourcesReadPathSchema,
...
}).meta({ title: "cli.command.agents.resources.read.Request" });
export type CliCommandAgentsResourcesReadRequest = z.infer<typeof CliCommandAgentsResourcesReadRequestSchema>;
