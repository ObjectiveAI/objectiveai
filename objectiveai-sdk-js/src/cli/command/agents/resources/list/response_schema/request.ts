...
import { z } from "zod";
import { CliCommandAgentsResourcesListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsResourcesListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsResourcesListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.resources.list.response_schema.Request" });
export type CliCommandAgentsResourcesListResponseSchemaRequest = z.infer<typeof CliCommandAgentsResourcesListResponseSchemaRequestSchema>;
