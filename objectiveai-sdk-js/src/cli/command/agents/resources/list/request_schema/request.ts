...
import { z } from "zod";
import { CliCommandAgentsResourcesListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsResourcesListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsResourcesListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.resources.list.request_schema.Request" });
export type CliCommandAgentsResourcesListRequestSchemaRequest = z.infer<typeof CliCommandAgentsResourcesListRequestSchemaRequestSchema>;
