...
import { z } from "zod";
import { CliCommandAgentsWaitResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsWaitResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsWaitResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.wait.response_schema.Request" });
export type CliCommandAgentsWaitResponseSchemaRequest = z.infer<typeof CliCommandAgentsWaitResponseSchemaRequestSchema>;
