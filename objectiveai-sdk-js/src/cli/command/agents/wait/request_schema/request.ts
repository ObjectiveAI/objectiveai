...
import { z } from "zod";
import { CliCommandAgentsWaitRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsWaitRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsWaitRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.wait.request_schema.Request" });
export type CliCommandAgentsWaitRequestSchemaRequest = z.infer<typeof CliCommandAgentsWaitRequestSchemaRequestSchema>;
