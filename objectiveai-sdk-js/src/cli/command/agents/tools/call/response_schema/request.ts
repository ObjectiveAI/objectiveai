...
import { z } from "zod";
import { CliCommandAgentsToolsCallResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsToolsCallResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsToolsCallResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.tools.call.response_schema.Request" });
export type CliCommandAgentsToolsCallResponseSchemaRequest = z.infer<typeof CliCommandAgentsToolsCallResponseSchemaRequestSchema>;
