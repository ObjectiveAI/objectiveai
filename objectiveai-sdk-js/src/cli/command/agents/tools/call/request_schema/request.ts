...
import { z } from "zod";
import { CliCommandAgentsToolsCallRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsToolsCallRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsToolsCallRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.tools.call.request_schema.Request" });
export type CliCommandAgentsToolsCallRequestSchemaRequest = z.infer<typeof CliCommandAgentsToolsCallRequestSchemaRequestSchema>;
