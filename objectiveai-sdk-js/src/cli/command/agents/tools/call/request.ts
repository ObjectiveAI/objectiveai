...
import { z } from "zod";
import { CliCommandAgentsToolsCallPathSchema } from "./path";
import { McpToolCallToolRequestParamsSchema } from "../../../../../mcp/tool/callToolRequestParams";

export const CliCommandAgentsToolsCallRequestSchema = z.object({
  ...
  params: McpToolCallToolRequestParamsSchema,
  path_type: CliCommandAgentsToolsCallPathSchema,
...
}).meta({ title: "cli.command.agents.tools.call.Request" });
export type CliCommandAgentsToolsCallRequest = z.infer<typeof CliCommandAgentsToolsCallRequestSchema>;
