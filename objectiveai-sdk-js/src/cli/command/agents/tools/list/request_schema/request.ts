...
import { z } from "zod";
import { CliCommandAgentsToolsListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsToolsListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsToolsListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.tools.list.request_schema.Request" });
export type CliCommandAgentsToolsListRequestSchemaRequest = z.infer<typeof CliCommandAgentsToolsListRequestSchemaRequestSchema>;
