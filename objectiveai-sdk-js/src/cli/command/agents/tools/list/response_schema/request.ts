...
import { z } from "zod";
import { CliCommandAgentsToolsListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsToolsListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsToolsListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.tools.list.response_schema.Request" });
export type CliCommandAgentsToolsListResponseSchemaRequest = z.infer<typeof CliCommandAgentsToolsListResponseSchemaRequestSchema>;
