...
import { z } from "zod";
import { CliCommandAgentsQueueOpenRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsQueueOpenRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsQueueOpenRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.queue.open.request_schema.Request" });
export type CliCommandAgentsQueueOpenRequestSchemaRequest = z.infer<typeof CliCommandAgentsQueueOpenRequestSchemaRequestSchema>;
