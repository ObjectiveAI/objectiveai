...
export const CliCommandAgentsQueueOpenRequestSchema = z.object({
...
export type CliCommandAgentsQueueOpenRequest = z.infer<typeof CliCommandAgentsQueueOpenRequestSchema>;
