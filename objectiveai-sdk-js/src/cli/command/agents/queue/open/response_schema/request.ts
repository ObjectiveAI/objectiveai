...
import { z } from "zod";
import { CliCommandAgentsQueueOpenResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsQueueOpenResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsQueueOpenResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.queue.open.response_schema.Request" });
export type CliCommandAgentsQueueOpenResponseSchemaRequest = z.infer<typeof CliCommandAgentsQueueOpenResponseSchemaRequestSchema>;
