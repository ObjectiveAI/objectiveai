...
import { z } from "zod";
import { CliCommandAgentsQueueListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsQueueListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsQueueListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.queue.list.request_schema.Request" });
export type CliCommandAgentsQueueListRequestSchemaRequest = z.infer<typeof CliCommandAgentsQueueListRequestSchemaRequestSchema>;
