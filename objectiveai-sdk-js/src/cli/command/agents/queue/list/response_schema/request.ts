...
import { z } from "zod";
import { CliCommandAgentsQueueListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsQueueListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsQueueListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.queue.list.response_schema.Request" });
export type CliCommandAgentsQueueListResponseSchemaRequest = z.infer<typeof CliCommandAgentsQueueListResponseSchemaRequestSchema>;
