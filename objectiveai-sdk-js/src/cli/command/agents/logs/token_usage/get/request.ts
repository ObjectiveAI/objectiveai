...
export const CliCommandAgentsLogsTokenUsageGetRequestSchema = z.object({
  agent_instance_hierarchy: z.string().describe("The full agent instance hierarchy to read."),
...
}).meta({ title: "cli.command.agents.logs.token_usage.get.Request" });
export type CliCommandAgentsLogsTokenUsageGetRequest = z.infer<typeof CliCommandAgentsLogsTokenUsageGetRequestSchema>;
