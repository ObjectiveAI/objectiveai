...
import { z } from "zod";
import { CliCommandAgentsLogsTokenUsageGetRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsTokenUsageGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsTokenUsageGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.token_usage.get.request_schema.Request" });
export type CliCommandAgentsLogsTokenUsageGetRequestSchemaRequest = z.infer<typeof CliCommandAgentsLogsTokenUsageGetRequestSchemaRequestSchema>;
