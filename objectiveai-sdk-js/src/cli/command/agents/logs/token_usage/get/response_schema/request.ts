...
import { z } from "zod";
import { CliCommandAgentsLogsTokenUsageGetResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsTokenUsageGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsTokenUsageGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.token_usage.get.response_schema.Request" });
export type CliCommandAgentsLogsTokenUsageGetResponseSchemaRequest = z.infer<typeof CliCommandAgentsLogsTokenUsageGetResponseSchemaRequestSchema>;
