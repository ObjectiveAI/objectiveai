...
import { z } from "zod";
import { CliCommandAgentsLogsTokenUsageSubscribeRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsTokenUsageSubscribeRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsTokenUsageSubscribeRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.token_usage.subscribe.request_schema.Request" });
export type CliCommandAgentsLogsTokenUsageSubscribeRequestSchemaRequest = z.infer<typeof CliCommandAgentsLogsTokenUsageSubscribeRequestSchemaRequestSchema>;
