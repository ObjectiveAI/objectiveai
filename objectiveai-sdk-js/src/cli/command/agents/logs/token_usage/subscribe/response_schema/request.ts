...
import { z } from "zod";
import { CliCommandAgentsLogsTokenUsageSubscribeResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsTokenUsageSubscribeResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsTokenUsageSubscribeResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.token_usage.subscribe.response_schema.Request" });
export type CliCommandAgentsLogsTokenUsageSubscribeResponseSchemaRequest = z.infer<typeof CliCommandAgentsLogsTokenUsageSubscribeResponseSchemaRequestSchema>;
