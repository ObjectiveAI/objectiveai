...
import { z } from "zod";
import { CliCommandAgentsLogsListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.list.request_schema.Request" });
export type CliCommandAgentsLogsListRequestSchemaRequest = z.infer<typeof CliCommandAgentsLogsListRequestSchemaRequestSchema>;
