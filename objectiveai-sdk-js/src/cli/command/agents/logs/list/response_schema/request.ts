...
import { z } from "zod";
import { CliCommandAgentsLogsListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.list.response_schema.Request" });
export type CliCommandAgentsLogsListResponseSchemaRequest = z.infer<typeof CliCommandAgentsLogsListResponseSchemaRequestSchema>;
