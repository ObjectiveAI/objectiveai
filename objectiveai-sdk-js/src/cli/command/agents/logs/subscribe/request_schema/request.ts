...
import { z } from "zod";
import { CliCommandAgentsLogsSubscribeRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsSubscribeRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsSubscribeRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.subscribe.request_schema.Request" });
export type CliCommandAgentsLogsSubscribeRequestSchemaRequest = z.infer<typeof CliCommandAgentsLogsSubscribeRequestSchemaRequestSchema>;
