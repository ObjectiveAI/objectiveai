...
import { z } from "zod";
import { CliCommandAgentsLogsSubscribeResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsSubscribeResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsSubscribeResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.subscribe.response_schema.Request" });
export type CliCommandAgentsLogsSubscribeResponseSchemaRequest = z.infer<typeof CliCommandAgentsLogsSubscribeResponseSchemaRequestSchema>;
