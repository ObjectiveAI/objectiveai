...
export const CliCommandAgentsLogsOpenRequestSchema = z.object({
...
}).meta({ title: "cli.command.agents.logs.open.Request" });
export type CliCommandAgentsLogsOpenRequest = z.infer<typeof CliCommandAgentsLogsOpenRequestSchema>;
