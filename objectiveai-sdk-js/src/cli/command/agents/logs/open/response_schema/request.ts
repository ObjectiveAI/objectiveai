...
import { z } from "zod";
import { CliCommandAgentsLogsOpenResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsOpenResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsOpenResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.open.response_schema.Request" });
export type CliCommandAgentsLogsOpenResponseSchemaRequest = z.infer<typeof CliCommandAgentsLogsOpenResponseSchemaRequestSchema>;
