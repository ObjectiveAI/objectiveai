...
import { z } from "zod";
import { CliCommandAgentsLogsOpenRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLogsOpenRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLogsOpenRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.logs.open.request_schema.Request" });
export type CliCommandAgentsLogsOpenRequestSchemaRequest = z.infer<typeof CliCommandAgentsLogsOpenRequestSchemaRequestSchema>;
