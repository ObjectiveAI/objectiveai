...
import { z } from "zod";
import { CliCommandAgentsLaboratoriesListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLaboratoriesListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLaboratoriesListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.laboratories.list.response_schema.Request" });
export type CliCommandAgentsLaboratoriesListResponseSchemaRequest = z.infer<typeof CliCommandAgentsLaboratoriesListResponseSchemaRequestSchema>;
