...
import { z } from "zod";
import { CliCommandAgentsLaboratoriesListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLaboratoriesListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLaboratoriesListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.laboratories.list.request_schema.Request" });
export type CliCommandAgentsLaboratoriesListRequestSchemaRequest = z.infer<typeof CliCommandAgentsLaboratoriesListRequestSchemaRequestSchema>;
