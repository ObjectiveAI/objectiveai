...
export const CliCommandAgentsLaboratoriesDetachRequestSchema = z.object({
...
}).meta({ title: "cli.command.agents.laboratories.detach.Request" });
export type CliCommandAgentsLaboratoriesDetachRequest = z.infer<typeof CliCommandAgentsLaboratoriesDetachRequestSchema>;
