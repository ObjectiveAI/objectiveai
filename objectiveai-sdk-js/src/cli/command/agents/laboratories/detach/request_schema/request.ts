...
import { z } from "zod";
import { CliCommandAgentsLaboratoriesDetachRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLaboratoriesDetachRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLaboratoriesDetachRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.laboratories.detach.request_schema.Request" });
export type CliCommandAgentsLaboratoriesDetachRequestSchemaRequest = z.infer<typeof CliCommandAgentsLaboratoriesDetachRequestSchemaRequestSchema>;
