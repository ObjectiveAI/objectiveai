...
import { z } from "zod";
import { CliCommandAgentsLaboratoriesDetachResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLaboratoriesDetachResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLaboratoriesDetachResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.laboratories.detach.response_schema.Request" });
export type CliCommandAgentsLaboratoriesDetachResponseSchemaRequest = z.infer<typeof CliCommandAgentsLaboratoriesDetachResponseSchemaRequestSchema>;
