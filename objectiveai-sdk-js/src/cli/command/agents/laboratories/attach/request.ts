...
export const CliCommandAgentsLaboratoriesAttachRequestSchema = z.object({
...
}).meta({ title: "cli.command.agents.laboratories.attach.Request" });
export type CliCommandAgentsLaboratoriesAttachRequest = z.infer<typeof CliCommandAgentsLaboratoriesAttachRequestSchema>;
