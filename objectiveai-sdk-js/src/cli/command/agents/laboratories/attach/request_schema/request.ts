...
import { z } from "zod";
import { CliCommandAgentsLaboratoriesAttachRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsLaboratoriesAttachRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLaboratoriesAttachRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.laboratories.attach.request_schema.Request" });
export type CliCommandAgentsLaboratoriesAttachRequestSchemaRequest = z.infer<typeof CliCommandAgentsLaboratoriesAttachRequestSchemaRequestSchema>;
