...
import { z } from "zod";
import { CliCommandAgentsLaboratoriesAttachResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsLaboratoriesAttachResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsLaboratoriesAttachResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.laboratories.attach.response_schema.Request" });
export type CliCommandAgentsLaboratoriesAttachResponseSchemaRequest = z.infer<typeof CliCommandAgentsLaboratoriesAttachResponseSchemaRequestSchema>;
