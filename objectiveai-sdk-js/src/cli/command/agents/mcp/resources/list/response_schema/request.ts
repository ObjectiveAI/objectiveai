...
import { z } from "zod";
import { CliCommandAgentsMcpResourcesListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpResourcesListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpResourcesListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.resources.list.response_schema.Request" });
export type CliCommandAgentsMcpResourcesListResponseSchemaRequest = z.infer<typeof CliCommandAgentsMcpResourcesListResponseSchemaRequestSchema>;
