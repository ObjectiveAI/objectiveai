...
import { z } from "zod";
import { CliCommandAgentsMcpResourcesListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpResourcesListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpResourcesListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.resources.list.request_schema.Request" });
export type CliCommandAgentsMcpResourcesListRequestSchemaRequest = z.infer<typeof CliCommandAgentsMcpResourcesListRequestSchemaRequestSchema>;
