...
import { z } from "zod";
import { CliCommandAgentsMcpResourcesReadResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpResourcesReadResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpResourcesReadResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.resources.read.response_schema.Request" });
export type CliCommandAgentsMcpResourcesReadResponseSchemaRequest = z.infer<typeof CliCommandAgentsMcpResourcesReadResponseSchemaRequestSchema>;
