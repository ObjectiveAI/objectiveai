...
import { z } from "zod";
import { CliCommandAgentsMcpResourcesReadRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpResourcesReadRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpResourcesReadRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.resources.read.request_schema.Request" });
export type CliCommandAgentsMcpResourcesReadRequestSchemaRequest = z.infer<typeof CliCommandAgentsMcpResourcesReadRequestSchemaRequestSchema>;
