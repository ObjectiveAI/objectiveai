...
import { z } from "zod";
import { CliCommandAgentsMcpServersListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpServersListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpServersListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.servers.list.response_schema.Request" });
export type CliCommandAgentsMcpServersListResponseSchemaRequest = z.infer<typeof CliCommandAgentsMcpServersListResponseSchemaRequestSchema>;
