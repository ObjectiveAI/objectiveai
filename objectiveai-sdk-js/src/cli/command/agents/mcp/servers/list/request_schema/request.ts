...
import { z } from "zod";
import { CliCommandAgentsMcpServersListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpServersListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpServersListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.servers.list.request_schema.Request" });
export type CliCommandAgentsMcpServersListRequestSchemaRequest = z.infer<typeof CliCommandAgentsMcpServersListRequestSchemaRequestSchema>;
