...
import { z } from "zod";
import { CliCommandAgentsMcpToolsListRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpToolsListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpToolsListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.tools.list.request_schema.Request" });
export type CliCommandAgentsMcpToolsListRequestSchemaRequest = z.infer<typeof CliCommandAgentsMcpToolsListRequestSchemaRequestSchema>;
