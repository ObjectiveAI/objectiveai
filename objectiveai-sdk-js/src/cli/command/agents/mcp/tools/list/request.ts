...
import { z } from "zod";
import { CliCommandAgentsMcpToolsListPathSchema } from "./path";
import { McpToolListToolsRequestSchema } from "../../../../../../mcp/tool/listToolsRequest";

export const CliCommandAgentsMcpToolsListRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpToolsListPathSchema,
...
export type CliCommandAgentsMcpToolsListRequest = z.infer<typeof CliCommandAgentsMcpToolsListRequestSchema>;
