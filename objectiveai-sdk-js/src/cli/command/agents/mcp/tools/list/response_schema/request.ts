...
import { z } from "zod";
import { CliCommandAgentsMcpToolsListResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpToolsListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpToolsListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.tools.list.response_schema.Request" });
export type CliCommandAgentsMcpToolsListResponseSchemaRequest = z.infer<typeof CliCommandAgentsMcpToolsListResponseSchemaRequestSchema>;
