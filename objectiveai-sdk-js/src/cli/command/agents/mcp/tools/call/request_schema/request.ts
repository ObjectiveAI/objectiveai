...
import { z } from "zod";
import { CliCommandAgentsMcpToolsCallRequestSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpToolsCallRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpToolsCallRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.tools.call.request_schema.Request" });
export type CliCommandAgentsMcpToolsCallRequestSchemaRequest = z.infer<typeof CliCommandAgentsMcpToolsCallRequestSchemaRequestSchema>;
