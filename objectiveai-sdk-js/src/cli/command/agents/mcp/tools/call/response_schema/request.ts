...
import { z } from "zod";
import { CliCommandAgentsMcpToolsCallResponseSchemaPathSchema } from "./path";

export const CliCommandAgentsMcpToolsCallResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandAgentsMcpToolsCallResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.agents.mcp.tools.call.response_schema.Request" });
export type CliCommandAgentsMcpToolsCallResponseSchemaRequest = z.infer<typeof CliCommandAgentsMcpToolsCallResponseSchemaRequestSchema>;
