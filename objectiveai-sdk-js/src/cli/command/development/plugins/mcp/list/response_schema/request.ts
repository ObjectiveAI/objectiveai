...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpListResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.list.response_schema.Request" });
export type CliCommandDevelopmentPluginsMcpListResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpListResponseSchemaRequestSchema>;
