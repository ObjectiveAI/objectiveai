...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpListRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.list.request_schema.Request" });
export type CliCommandDevelopmentPluginsMcpListRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpListRequestSchemaRequestSchema>;
