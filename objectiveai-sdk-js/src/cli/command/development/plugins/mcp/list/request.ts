...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpListPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpListRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpListPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.list.Request" });
export type CliCommandDevelopmentPluginsMcpListRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpListRequestSchema>;
