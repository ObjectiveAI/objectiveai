...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpDeleteResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpDeleteResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpDeleteResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.delete.response_schema.Request" });
export type CliCommandDevelopmentPluginsMcpDeleteResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpDeleteResponseSchemaRequestSchema>;
