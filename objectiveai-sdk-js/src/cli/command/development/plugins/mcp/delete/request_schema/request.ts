...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpDeleteRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpDeleteRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpDeleteRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.delete.request_schema.Request" });
export type CliCommandDevelopmentPluginsMcpDeleteRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpDeleteRequestSchemaRequestSchema>;
