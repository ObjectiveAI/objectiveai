...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpDeletePathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpDeleteRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpDeletePathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.delete.Request" });
export type CliCommandDevelopmentPluginsMcpDeleteRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpDeleteRequestSchema>;
