...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpResetRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpResetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpResetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.reset.request_schema.Request" });
export type CliCommandDevelopmentPluginsMcpResetRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpResetRequestSchemaRequestSchema>;
