...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpResetResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpResetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpResetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.reset.response_schema.Request" });
export type CliCommandDevelopmentPluginsMcpResetResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpResetResponseSchemaRequestSchema>;
