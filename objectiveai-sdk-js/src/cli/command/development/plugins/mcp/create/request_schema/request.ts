...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpCreateRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpCreateRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpCreateRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.create.request_schema.Request" });
export type CliCommandDevelopmentPluginsMcpCreateRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpCreateRequestSchemaRequestSchema>;
