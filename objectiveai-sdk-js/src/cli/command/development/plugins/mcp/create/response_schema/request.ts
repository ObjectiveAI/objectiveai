...
import { z } from "zod";
import { CliCommandDevelopmentPluginsMcpCreateResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsMcpCreateResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsMcpCreateResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.mcp.create.response_schema.Request" });
export type CliCommandDevelopmentPluginsMcpCreateResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsMcpCreateResponseSchemaRequestSchema>;
