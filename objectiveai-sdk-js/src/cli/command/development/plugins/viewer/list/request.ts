...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerListPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerListRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerListPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.list.Request" });
export type CliCommandDevelopmentPluginsViewerListRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerListRequestSchema>;
