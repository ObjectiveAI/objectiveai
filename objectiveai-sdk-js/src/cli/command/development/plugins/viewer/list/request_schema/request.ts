...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerListRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.list.request_schema.Request" });
export type CliCommandDevelopmentPluginsViewerListRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerListRequestSchemaRequestSchema>;
