...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerListResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.list.response_schema.Request" });
export type CliCommandDevelopmentPluginsViewerListResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerListResponseSchemaRequestSchema>;
