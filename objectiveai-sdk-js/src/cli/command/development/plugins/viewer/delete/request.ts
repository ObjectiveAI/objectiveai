...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerDeletePathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerDeleteRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerDeletePathSchema,
  ...
  version: z.string().describe("Plugin version, matched byte-for-byte."),
}).meta({ title: "cli.command.development.plugins.viewer.delete.Request" });
export type CliCommandDevelopmentPluginsViewerDeleteRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerDeleteRequestSchema>;
