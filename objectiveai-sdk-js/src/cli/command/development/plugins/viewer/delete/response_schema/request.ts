...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerDeleteResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerDeleteResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerDeleteResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.delete.response_schema.Request" });
export type CliCommandDevelopmentPluginsViewerDeleteResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerDeleteResponseSchemaRequestSchema>;
