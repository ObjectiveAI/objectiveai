...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerDeleteRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerDeleteRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerDeleteRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.delete.request_schema.Request" });
export type CliCommandDevelopmentPluginsViewerDeleteRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerDeleteRequestSchemaRequestSchema>;
