...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerCreateResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerCreateResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerCreateResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.create.response_schema.Request" });
export type CliCommandDevelopmentPluginsViewerCreateResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerCreateResponseSchemaRequestSchema>;
