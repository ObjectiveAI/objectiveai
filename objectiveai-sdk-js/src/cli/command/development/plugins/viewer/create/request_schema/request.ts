...
import { z } from "zod";
import { CliCommandDevelopmentPluginsViewerCreateRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentPluginsViewerCreateRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentPluginsViewerCreateRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.plugins.viewer.create.request_schema.Request" });
export type CliCommandDevelopmentPluginsViewerCreateRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentPluginsViewerCreateRequestSchemaRequestSchema>;
