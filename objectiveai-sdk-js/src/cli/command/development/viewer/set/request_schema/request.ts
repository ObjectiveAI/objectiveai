...
import { z } from "zod";
import { CliCommandDevelopmentViewerSetRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentViewerSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.viewer.set.request_schema.Request" });
export type CliCommandDevelopmentViewerSetRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentViewerSetRequestSchemaRequestSchema>;
