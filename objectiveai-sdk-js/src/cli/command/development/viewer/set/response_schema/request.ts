...
import { z } from "zod";
import { CliCommandDevelopmentViewerSetResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentViewerSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.viewer.set.response_schema.Request" });
export type CliCommandDevelopmentViewerSetResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentViewerSetResponseSchemaRequestSchema>;
