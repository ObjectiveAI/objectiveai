...
import { z } from "zod";
import { CliCommandDevelopmentViewerDeletePathSchema } from "./path";

export const CliCommandDevelopmentViewerDeleteRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerDeletePathSchema,
...
}).meta({ title: "cli.command.development.viewer.delete.Request" });
export type CliCommandDevelopmentViewerDeleteRequest = z.infer<typeof CliCommandDevelopmentViewerDeleteRequestSchema>;
