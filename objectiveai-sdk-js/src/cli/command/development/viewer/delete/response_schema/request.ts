...
import { z } from "zod";
import { CliCommandDevelopmentViewerDeleteResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentViewerDeleteResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerDeleteResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.viewer.delete.response_schema.Request" });
export type CliCommandDevelopmentViewerDeleteResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentViewerDeleteResponseSchemaRequestSchema>;
