...
import { z } from "zod";
import { CliCommandDevelopmentViewerDeleteRequestSchemaPathSchema } from "./path";

export const CliCommandDevelopmentViewerDeleteRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerDeleteRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.development.viewer.delete.request_schema.Request" });
export type CliCommandDevelopmentViewerDeleteRequestSchemaRequest = z.infer<typeof CliCommandDevelopmentViewerDeleteRequestSchemaRequestSchema>;
