...
import { z } from "zod";
import { CliCommandDevelopmentViewerGetResponseSchemaPathSchema } from "./path";

export const CliCommandDevelopmentViewerGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.development.viewer.get.response_schema.Request" });
export type CliCommandDevelopmentViewerGetResponseSchemaRequest = z.infer<typeof CliCommandDevelopmentViewerGetResponseSchemaRequestSchema>;
