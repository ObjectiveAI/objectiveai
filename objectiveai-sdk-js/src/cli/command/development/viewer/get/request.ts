...
import { z } from "zod";
import { CliCommandDevelopmentViewerGetPathSchema } from "./path";

export const CliCommandDevelopmentViewerGetRequestSchema = z.object({
  ...
  path_type: CliCommandDevelopmentViewerGetPathSchema,
...
}).meta({ title: "cli.command.development.viewer.get.Request" });
export type CliCommandDevelopmentViewerGetRequest = z.infer<typeof CliCommandDevelopmentViewerGetRequestSchema>;
