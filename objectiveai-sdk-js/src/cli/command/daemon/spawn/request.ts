...
import { CliCommandDaemonSpawnRequestDangerousAdvancedSchema } from "./requestDangerousAdvanced";

export const CliCommandDaemonSpawnRequestSchema = z.object({
  dangerous_advanced: CliCommandDaemonSpawnRequestDangerousAdvancedSchema.nullable().meta({ omitempty: true }).optional(),
...
}).meta({ title: "cli.command.daemon.spawn.Request" });
export type CliCommandDaemonSpawnRequest = z.infer<typeof CliCommandDaemonSpawnRequestSchema>;
