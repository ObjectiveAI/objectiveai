...
import { z } from "zod";
import { CliCommandDaemonSpawnResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonSpawnResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonSpawnResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.spawn.response_schema.Request" });
export type CliCommandDaemonSpawnResponseSchemaRequest = z.infer<typeof CliCommandDaemonSpawnResponseSchemaRequestSchema>;
