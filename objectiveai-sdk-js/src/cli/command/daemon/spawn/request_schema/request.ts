...
import { z } from "zod";
import { CliCommandDaemonSpawnRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonSpawnRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonSpawnRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.spawn.request_schema.Request" });
export type CliCommandDaemonSpawnRequestSchemaRequest = z.infer<typeof CliCommandDaemonSpawnRequestSchemaRequestSchema>;
