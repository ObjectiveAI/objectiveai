...
import { z } from "zod";
import { CliCommandDaemonConfigSetPathSchema } from "./path";
import { CliCommandDaemonConfigSetValueSchema } from "./value";

export const CliCommandDaemonConfigSetRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSetPathSchema,
  ...
  value: CliCommandDaemonConfigSetValueSchema,
}).meta({ title: "cli.command.daemon.config.set.Request" });
export type CliCommandDaemonConfigSetRequest = z.infer<typeof CliCommandDaemonConfigSetRequestSchema>;
