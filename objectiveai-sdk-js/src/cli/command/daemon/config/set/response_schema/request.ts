...
import { z } from "zod";
import { CliCommandDaemonConfigSetResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.set.response_schema.Request" });
export type CliCommandDaemonConfigSetResponseSchemaRequest = z.infer<typeof CliCommandDaemonConfigSetResponseSchemaRequestSchema>;
