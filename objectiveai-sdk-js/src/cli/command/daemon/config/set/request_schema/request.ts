...
import { z } from "zod";
import { CliCommandDaemonConfigSetRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.set.request_schema.Request" });
export type CliCommandDaemonConfigSetRequestSchemaRequest = z.infer<typeof CliCommandDaemonConfigSetRequestSchemaRequestSchema>;
