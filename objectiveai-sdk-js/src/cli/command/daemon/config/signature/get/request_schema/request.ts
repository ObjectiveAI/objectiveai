...
import { z } from "zod";
import { CliCommandDaemonConfigSignatureGetRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigSignatureGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSignatureGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.signature.get.request_schema.Request" });
export type CliCommandDaemonConfigSignatureGetRequestSchemaRequest = z.infer<typeof CliCommandDaemonConfigSignatureGetRequestSchemaRequestSchema>;
