...
import { z } from "zod";
import { CliCommandDaemonConfigSignatureGetResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigSignatureGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSignatureGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.signature.get.response_schema.Request" });
export type CliCommandDaemonConfigSignatureGetResponseSchemaRequest = z.infer<typeof CliCommandDaemonConfigSignatureGetResponseSchemaRequestSchema>;
