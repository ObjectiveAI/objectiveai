...
import { z } from "zod";
import { CliCommandDaemonConfigSignatureGetPathSchema } from "./path";

export const CliCommandDaemonConfigSignatureGetRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSignatureGetPathSchema,
...
}).meta({ title: "cli.command.daemon.config.signature.get.Request" });
export type CliCommandDaemonConfigSignatureGetRequest = z.infer<typeof CliCommandDaemonConfigSignatureGetRequestSchema>;
