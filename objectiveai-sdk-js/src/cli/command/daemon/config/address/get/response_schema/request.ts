...
import { z } from "zod";
import { CliCommandDaemonConfigAddressGetResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigAddressGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigAddressGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.address.get.response_schema.Request" });
export type CliCommandDaemonConfigAddressGetResponseSchemaRequest = z.infer<typeof CliCommandDaemonConfigAddressGetResponseSchemaRequestSchema>;
