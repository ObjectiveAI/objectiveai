...
import { z } from "zod";
import { CliCommandDaemonConfigAddressGetPathSchema } from "./path";

export const CliCommandDaemonConfigAddressGetRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigAddressGetPathSchema,
...
}).meta({ title: "cli.command.daemon.config.address.get.Request" });
export type CliCommandDaemonConfigAddressGetRequest = z.infer<typeof CliCommandDaemonConfigAddressGetRequestSchema>;
