...
import { z } from "zod";
import { CliCommandDaemonConfigAddressGetRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigAddressGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigAddressGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.address.get.request_schema.Request" });
export type CliCommandDaemonConfigAddressGetRequestSchemaRequest = z.infer<typeof CliCommandDaemonConfigAddressGetRequestSchemaRequestSchema>;
