...
import { z } from "zod";
import { CliCommandDaemonConfigRefreshSecretSignaturePairPathSchema } from "./path";

export const CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigRefreshSecretSignaturePairPathSchema,
...
}).meta({ title: "cli.command.daemon.config.refresh_secret_signature_pair.Request" });
export type CliCommandDaemonConfigRefreshSecretSignaturePairRequest = z.infer<typeof CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchema>;
