...
import { z } from "zod";
import { CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.refresh_secret_signature_pair.request_schema.Request" });
export type CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchemaRequest = z.infer<typeof CliCommandDaemonConfigRefreshSecretSignaturePairRequestSchemaRequestSchema>;
