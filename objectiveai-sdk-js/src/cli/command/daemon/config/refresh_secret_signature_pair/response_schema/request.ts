...
import { z } from "zod";
import { CliCommandDaemonConfigRefreshSecretSignaturePairResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigRefreshSecretSignaturePairResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigRefreshSecretSignaturePairResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.refresh_secret_signature_pair.response_schema.Request" });
export type CliCommandDaemonConfigRefreshSecretSignaturePairResponseSchemaRequest = z.infer<typeof CliCommandDaemonConfigRefreshSecretSignaturePairResponseSchemaRequestSchema>;
