...
import { z } from "zod";
import { CliCommandDaemonConfigGetRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.get.request_schema.Request" });
export type CliCommandDaemonConfigGetRequestSchemaRequest = z.infer<typeof CliCommandDaemonConfigGetRequestSchemaRequestSchema>;
