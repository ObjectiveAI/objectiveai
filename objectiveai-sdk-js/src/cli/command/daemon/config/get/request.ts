...
import { z } from "zod";
import { CliCommandDaemonConfigGetPathSchema } from "./path";

export const CliCommandDaemonConfigGetRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigGetPathSchema,
...
}).meta({ title: "cli.command.daemon.config.get.Request" });
export type CliCommandDaemonConfigGetRequest = z.infer<typeof CliCommandDaemonConfigGetRequestSchema>;
