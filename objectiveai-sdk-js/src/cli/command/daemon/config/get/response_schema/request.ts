...
import { z } from "zod";
import { CliCommandDaemonConfigGetResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.get.response_schema.Request" });
export type CliCommandDaemonConfigGetResponseSchemaRequest = z.infer<typeof CliCommandDaemonConfigGetResponseSchemaRequestSchema>;
