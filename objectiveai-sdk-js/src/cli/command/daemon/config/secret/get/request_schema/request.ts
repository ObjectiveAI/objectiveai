...
import { z } from "zod";
import { CliCommandDaemonConfigSecretGetRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigSecretGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSecretGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.secret.get.request_schema.Request" });
export type CliCommandDaemonConfigSecretGetRequestSchemaRequest = z.infer<typeof CliCommandDaemonConfigSecretGetRequestSchemaRequestSchema>;
