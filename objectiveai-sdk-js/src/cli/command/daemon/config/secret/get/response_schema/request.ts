...
import { z } from "zod";
import { CliCommandDaemonConfigSecretGetResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonConfigSecretGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSecretGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.config.secret.get.response_schema.Request" });
export type CliCommandDaemonConfigSecretGetResponseSchemaRequest = z.infer<typeof CliCommandDaemonConfigSecretGetResponseSchemaRequestSchema>;
