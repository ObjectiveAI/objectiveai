...
import { z } from "zod";
import { CliCommandDaemonConfigSecretGetPathSchema } from "./path";

export const CliCommandDaemonConfigSecretGetRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonConfigSecretGetPathSchema,
...
}).meta({ title: "cli.command.daemon.config.secret.get.Request" });
export type CliCommandDaemonConfigSecretGetRequest = z.infer<typeof CliCommandDaemonConfigSecretGetRequestSchema>;
