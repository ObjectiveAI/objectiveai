...
import { z } from "zod";
import { CliCommandDaemonKillRequestSchemaPathSchema } from "./path";

export const CliCommandDaemonKillRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonKillRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.kill.request_schema.Request" });
export type CliCommandDaemonKillRequestSchemaRequest = z.infer<typeof CliCommandDaemonKillRequestSchemaRequestSchema>;
