...
import { z } from "zod";
import { CliCommandDaemonKillResponseSchemaPathSchema } from "./path";

export const CliCommandDaemonKillResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDaemonKillResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.daemon.kill.response_schema.Request" });
export type CliCommandDaemonKillResponseSchemaRequest = z.infer<typeof CliCommandDaemonKillResponseSchemaRequestSchema>;
