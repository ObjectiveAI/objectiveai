...
export const CliCommandDaemonKillRequestSchema = z.object({
...
}).meta({ title: "cli.command.daemon.kill.Request" });
export type CliCommandDaemonKillRequest = z.infer<typeof CliCommandDaemonKillRequestSchema>;
