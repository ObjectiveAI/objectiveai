...
import { z } from "zod";
import { CliCommandFunctionsListRequestSchema } from "./request";

export const CliCommandFunctionsListViewerRequestSchema = z.object({
...
export type CliCommandFunctionsListViewerRequest = z.infer<typeof CliCommandFunctionsListViewerRequestSchema>;
