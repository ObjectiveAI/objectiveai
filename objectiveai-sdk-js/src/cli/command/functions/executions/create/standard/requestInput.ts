...
export const CliCommandFunctionsExecutionsCreateStandardRequestInputSchema = z.union([z.object({
  ...
  PythonFile: z.string(),
}).strict().meta({"variantTitle":"PythonFile"})]).meta({ title: "cli.command.functions.executions.create.standard.RequestInput" });
export type CliCommandFunctionsExecutionsCreateStandardRequestInput = z.infer<typeof CliCommandFunctionsExecutionsCreateStandardRequestInputSchema>;
