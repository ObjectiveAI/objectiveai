...
import { z } from "zod";
import { CliCommandKillAllRequestSchemaPathSchema } from "./path";

export const CliCommandKillAllRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandKillAllRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.kill_all.request_schema.Request" });
export type CliCommandKillAllRequestSchemaRequest = z.infer<typeof CliCommandKillAllRequestSchemaRequestSchema>;
