...
export const CliCommandKillAllRequestSchema = z.object({
...
}).meta({ title: "cli.command.kill_all.Request" });
export type CliCommandKillAllRequest = z.infer<typeof CliCommandKillAllRequestSchema>;
