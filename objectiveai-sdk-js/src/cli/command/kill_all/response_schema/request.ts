...
import { z } from "zod";
import { CliCommandKillAllResponseSchemaPathSchema } from "./path";

export const CliCommandKillAllResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandKillAllResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.kill_all.response_schema.Request" });
export type CliCommandKillAllResponseSchemaRequest = z.infer<typeof CliCommandKillAllResponseSchemaRequestSchema>;
