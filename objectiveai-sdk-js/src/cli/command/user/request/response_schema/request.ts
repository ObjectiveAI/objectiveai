...
import { z } from "zod";
import { CliCommandUserRequestResponseSchemaPathSchema } from "./path";

export const CliCommandUserRequestResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandUserRequestResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.user.request.response_schema.Request" });
export type CliCommandUserRequestResponseSchemaRequest = z.infer<typeof CliCommandUserRequestResponseSchemaRequestSchema>;
