...
import { z } from "zod";
import { CliCommandUserRequestRequestSchemaPathSchema } from "./path";

export const CliCommandUserRequestRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandUserRequestRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.user.request.request_schema.Request" });
export type CliCommandUserRequestRequestSchemaRequest = z.infer<typeof CliCommandUserRequestRequestSchemaRequestSchema>;
