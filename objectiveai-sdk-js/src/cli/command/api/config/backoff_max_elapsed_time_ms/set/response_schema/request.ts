...
import { z } from "zod";
import { CliCommandApiConfigBackoffMaxElapsedTimeMsSetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigBackoffMaxElapsedTimeMsSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigBackoffMaxElapsedTimeMsSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.backoff_max_elapsed_time_ms.set.response_schema.Request" });
export type CliCommandApiConfigBackoffMaxElapsedTimeMsSetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigBackoffMaxElapsedTimeMsSetResponseSchemaRequestSchema>;
