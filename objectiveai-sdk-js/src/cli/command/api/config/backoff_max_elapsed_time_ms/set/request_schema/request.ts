...
import { z } from "zod";
import { CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.backoff_max_elapsed_time_ms.set.request_schema.Request" });
export type CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequestSchemaRequestSchema>;
