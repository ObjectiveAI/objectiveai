...
export const CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchema = z.object({
...
}).meta({ title: "cli.command.api.config.backoff_max_elapsed_time_ms.get.Request" });
export type CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequest = z.infer<typeof CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchema>;
