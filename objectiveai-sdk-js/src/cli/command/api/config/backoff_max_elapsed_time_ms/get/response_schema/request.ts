...
import { z } from "zod";
import { CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.backoff_max_elapsed_time_ms.get.response_schema.Request" });
export type CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchemaRequestSchema>;
