...
import { z } from "zod";
import { CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.backoff_max_elapsed_time_ms.get.request_schema.Request" });
export type CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigBackoffMaxElapsedTimeMsGetRequestSchemaRequestSchema>;
