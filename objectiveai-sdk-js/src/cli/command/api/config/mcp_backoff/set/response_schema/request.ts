...
import { z } from "zod";
import { CliCommandApiConfigMcpBackoffSetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpBackoffSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpBackoffSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_backoff.set.response_schema.Request" });
export type CliCommandApiConfigMcpBackoffSetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpBackoffSetResponseSchemaRequestSchema>;
