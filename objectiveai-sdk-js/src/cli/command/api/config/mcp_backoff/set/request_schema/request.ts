...
import { z } from "zod";
import { CliCommandApiConfigMcpBackoffSetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpBackoffSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpBackoffSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_backoff.set.request_schema.Request" });
export type CliCommandApiConfigMcpBackoffSetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpBackoffSetRequestSchemaRequestSchema>;
