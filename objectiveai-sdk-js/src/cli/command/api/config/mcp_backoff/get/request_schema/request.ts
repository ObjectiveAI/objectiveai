...
import { z } from "zod";
import { CliCommandApiConfigMcpBackoffGetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpBackoffGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpBackoffGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_backoff.get.request_schema.Request" });
export type CliCommandApiConfigMcpBackoffGetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpBackoffGetRequestSchemaRequestSchema>;
