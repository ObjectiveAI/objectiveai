...
import { z } from "zod";
import { CliCommandApiConfigMcpBackoffGetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpBackoffGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpBackoffGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_backoff.get.response_schema.Request" });
export type CliCommandApiConfigMcpBackoffGetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpBackoffGetResponseSchemaRequestSchema>;
