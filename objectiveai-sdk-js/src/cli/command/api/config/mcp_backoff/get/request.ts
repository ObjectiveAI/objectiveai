...
import { z } from "zod";
import { CliCommandApiConfigMcpBackoffGetPathSchema } from "./path";
import { CliCommandGetScopeSchema } from "../../../../getScope";

export const CliCommandApiConfigMcpBackoffGetRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpBackoffGetPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_backoff.get.Request" });
export type CliCommandApiConfigMcpBackoffGetRequest = z.infer<typeof CliCommandApiConfigMcpBackoffGetRequestSchema>;
