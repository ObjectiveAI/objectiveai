...
import { z } from "zod";
import { CliCommandApiConfigMcpConnectTimeoutMsSetPathSchema } from "./path";
import { CliCommandSetScopeSchema } from "../../../../setScope";

export const CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpConnectTimeoutMsSetPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_connect_timeout_ms.set.Request" });
export type CliCommandApiConfigMcpConnectTimeoutMsSetRequest = z.infer<typeof CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchema>;
