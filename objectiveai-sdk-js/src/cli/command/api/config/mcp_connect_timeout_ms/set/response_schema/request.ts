...
import { z } from "zod";
import { CliCommandApiConfigMcpConnectTimeoutMsSetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpConnectTimeoutMsSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpConnectTimeoutMsSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_connect_timeout_ms.set.response_schema.Request" });
export type CliCommandApiConfigMcpConnectTimeoutMsSetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpConnectTimeoutMsSetResponseSchemaRequestSchema>;
