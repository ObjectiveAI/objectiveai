...
import { z } from "zod";
import { CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_connect_timeout_ms.set.request_schema.Request" });
export type CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpConnectTimeoutMsSetRequestSchemaRequestSchema>;
