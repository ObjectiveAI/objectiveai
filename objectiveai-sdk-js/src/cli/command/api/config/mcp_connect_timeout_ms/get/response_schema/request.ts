...
import { z } from "zod";
import { CliCommandApiConfigMcpConnectTimeoutMsGetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpConnectTimeoutMsGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpConnectTimeoutMsGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_connect_timeout_ms.get.response_schema.Request" });
export type CliCommandApiConfigMcpConnectTimeoutMsGetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpConnectTimeoutMsGetResponseSchemaRequestSchema>;
