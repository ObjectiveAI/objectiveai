...
import { z } from "zod";
import { CliCommandApiConfigMcpConnectTimeoutMsGetPathSchema } from "./path";
import { CliCommandGetScopeSchema } from "../../../../getScope";

export const CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpConnectTimeoutMsGetPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_connect_timeout_ms.get.Request" });
export type CliCommandApiConfigMcpConnectTimeoutMsGetRequest = z.infer<typeof CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchema>;
