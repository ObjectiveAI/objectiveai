...
import { z } from "zod";
import { CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_connect_timeout_ms.get.request_schema.Request" });
export type CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpConnectTimeoutMsGetRequestSchemaRequestSchema>;
