...
import { z } from "zod";
import { CliCommandApiConfigMcpTimeoutMsSetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpTimeoutMsSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpTimeoutMsSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_timeout_ms.set.request_schema.Request" });
export type CliCommandApiConfigMcpTimeoutMsSetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpTimeoutMsSetRequestSchemaRequestSchema>;
