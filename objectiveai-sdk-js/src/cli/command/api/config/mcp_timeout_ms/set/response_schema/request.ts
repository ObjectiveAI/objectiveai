...
import { z } from "zod";
import { CliCommandApiConfigMcpTimeoutMsSetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpTimeoutMsSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpTimeoutMsSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_timeout_ms.set.response_schema.Request" });
export type CliCommandApiConfigMcpTimeoutMsSetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpTimeoutMsSetResponseSchemaRequestSchema>;
