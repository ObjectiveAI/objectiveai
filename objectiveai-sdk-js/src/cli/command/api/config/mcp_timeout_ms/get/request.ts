...
export const CliCommandApiConfigMcpTimeoutMsGetRequestSchema = z.object({
...
}).meta({ title: "cli.command.api.config.mcp_timeout_ms.get.Request" });
export type CliCommandApiConfigMcpTimeoutMsGetRequest = z.infer<typeof CliCommandApiConfigMcpTimeoutMsGetRequestSchema>;
