...
import { z } from "zod";
import { CliCommandApiConfigMcpTimeoutMsGetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpTimeoutMsGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpTimeoutMsGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_timeout_ms.get.response_schema.Request" });
export type CliCommandApiConfigMcpTimeoutMsGetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpTimeoutMsGetResponseSchemaRequestSchema>;
