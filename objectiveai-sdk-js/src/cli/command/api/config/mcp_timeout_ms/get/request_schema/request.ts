...
import { z } from "zod";
import { CliCommandApiConfigMcpTimeoutMsGetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpTimeoutMsGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpTimeoutMsGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_timeout_ms.get.request_schema.Request" });
export type CliCommandApiConfigMcpTimeoutMsGetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpTimeoutMsGetRequestSchemaRequestSchema>;
