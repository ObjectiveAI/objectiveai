...
import { z } from "zod";
import { CliCommandApiConfigMcpCallTimeoutMsSetPathSchema } from "./path";
import { CliCommandSetScopeSchema } from "../../../../setScope";

export const CliCommandApiConfigMcpCallTimeoutMsSetRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpCallTimeoutMsSetPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_call_timeout_ms.set.Request" });
export type CliCommandApiConfigMcpCallTimeoutMsSetRequest = z.infer<typeof CliCommandApiConfigMcpCallTimeoutMsSetRequestSchema>;
