...
import { z } from "zod";
import { CliCommandApiConfigMcpCallTimeoutMsSetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpCallTimeoutMsSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpCallTimeoutMsSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_call_timeout_ms.set.response_schema.Request" });
export type CliCommandApiConfigMcpCallTimeoutMsSetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpCallTimeoutMsSetResponseSchemaRequestSchema>;
