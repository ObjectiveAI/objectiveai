...
import { z } from "zod";
import { CliCommandApiConfigMcpCallTimeoutMsSetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpCallTimeoutMsSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpCallTimeoutMsSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_call_timeout_ms.set.request_schema.Request" });
export type CliCommandApiConfigMcpCallTimeoutMsSetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpCallTimeoutMsSetRequestSchemaRequestSchema>;
