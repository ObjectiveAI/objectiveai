...
import { z } from "zod";
import { CliCommandApiConfigMcpCallTimeoutMsGetResponseSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpCallTimeoutMsGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpCallTimeoutMsGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_call_timeout_ms.get.response_schema.Request" });
export type CliCommandApiConfigMcpCallTimeoutMsGetResponseSchemaRequest = z.infer<typeof CliCommandApiConfigMcpCallTimeoutMsGetResponseSchemaRequestSchema>;
