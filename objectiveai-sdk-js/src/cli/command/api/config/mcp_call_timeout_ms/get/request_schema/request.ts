...
import { z } from "zod";
import { CliCommandApiConfigMcpCallTimeoutMsGetRequestSchemaPathSchema } from "./path";

export const CliCommandApiConfigMcpCallTimeoutMsGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpCallTimeoutMsGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_call_timeout_ms.get.request_schema.Request" });
export type CliCommandApiConfigMcpCallTimeoutMsGetRequestSchemaRequest = z.infer<typeof CliCommandApiConfigMcpCallTimeoutMsGetRequestSchemaRequestSchema>;
