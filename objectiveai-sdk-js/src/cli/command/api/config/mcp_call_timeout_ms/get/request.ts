...
import { z } from "zod";
import { CliCommandApiConfigMcpCallTimeoutMsGetPathSchema } from "./path";
import { CliCommandGetScopeSchema } from "../../../../getScope";

export const CliCommandApiConfigMcpCallTimeoutMsGetRequestSchema = z.object({
  ...
  path_type: CliCommandApiConfigMcpCallTimeoutMsGetPathSchema,
...
}).meta({ title: "cli.command.api.config.mcp_call_timeout_ms.get.Request" });
export type CliCommandApiConfigMcpCallTimeoutMsGetRequest = z.infer<typeof CliCommandApiConfigMcpCallTimeoutMsGetRequestSchema>;
