...
import { z } from "zod";
import { CliCommandDbConfigSetResponseSchemaPathSchema } from "./path";

export const CliCommandDbConfigSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDbConfigSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.db.config.set.response_schema.Request" });
export type CliCommandDbConfigSetResponseSchemaRequest = z.infer<typeof CliCommandDbConfigSetResponseSchemaRequestSchema>;
