...
import { z } from "zod";
import { CliCommandDbConfigSetRequestSchemaPathSchema } from "./path";

export const CliCommandDbConfigSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandDbConfigSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.db.config.set.request_schema.Request" });
export type CliCommandDbConfigSetRequestSchemaRequest = z.infer<typeof CliCommandDbConfigSetRequestSchemaRequestSchema>;
