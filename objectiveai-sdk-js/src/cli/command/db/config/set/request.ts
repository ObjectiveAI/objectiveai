...
import { z } from "zod";
import { CliCommandDbConfigSetPathSchema } from "./path";
import { CliCommandDbConfigSetValueSchema } from "./value";

export const CliCommandDbConfigSetRequestSchema = z.object({
  ...
  path_type: CliCommandDbConfigSetPathSchema,
  ...
  value: CliCommandDbConfigSetValueSchema,
}).meta({ title: "cli.command.db.config.set.Request" });
export type CliCommandDbConfigSetRequest = z.infer<typeof CliCommandDbConfigSetRequestSchema>;
