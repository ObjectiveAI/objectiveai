...
import { z } from "zod";
import { CliCommandDbKillRequestSchema } from "./request";

export const CliCommandDbKillViewerRequestSchema = z.object({
...
export type CliCommandDbKillViewerRequest = z.infer<typeof CliCommandDbKillViewerRequestSchema>;
