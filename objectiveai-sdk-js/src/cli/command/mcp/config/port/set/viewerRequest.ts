...
import { z } from "zod";
import { CliCommandMcpConfigPortSetRequestSchema } from "./request";

export const CliCommandMcpConfigPortSetViewerRequestSchema = z.object({
...
export type CliCommandMcpConfigPortSetViewerRequest = z.infer<typeof CliCommandMcpConfigPortSetViewerRequestSchema>;
