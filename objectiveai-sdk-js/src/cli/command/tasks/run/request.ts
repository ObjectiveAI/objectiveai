...
import { CliCommandTasksRunRequestDangerousAdvancedSchema } from "./requestDangerousAdvanced";

export const CliCommandTasksRunRequestSchema = z.object({
  dangerous_advanced: CliCommandTasksRunRequestDangerousAdvancedSchema.nullable().optional(),
