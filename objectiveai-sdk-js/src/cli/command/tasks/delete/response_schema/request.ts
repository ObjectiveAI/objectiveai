...
import { z } from "zod";
import { CliCommandTasksDeleteResponseSchemaPathSchema } from "./path";

export const CliCommandTasksDeleteResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandTasksDeleteResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.tasks.delete.response_schema.Request" });
export type CliCommandTasksDeleteResponseSchemaRequest = z.infer<typeof CliCommandTasksDeleteResponseSchemaRequestSchema>;
