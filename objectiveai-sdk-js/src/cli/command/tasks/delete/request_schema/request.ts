...
import { z } from "zod";
import { CliCommandTasksDeleteRequestSchemaPathSchema } from "./path";

export const CliCommandTasksDeleteRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandTasksDeleteRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.tasks.delete.request_schema.Request" });
export type CliCommandTasksDeleteRequestSchemaRequest = z.infer<typeof CliCommandTasksDeleteRequestSchemaRequestSchema>;
