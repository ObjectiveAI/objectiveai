...
import { z } from "zod";
import { CliCommandTasksDeleteDeleteNamespaceSchema } from "./deleteNamespace";
import { CliCommandTasksDeletePathSchema } from "./path";

export const CliCommandTasksDeleteRequestSchema = z.object({
  ...
  namespace: CliCommandTasksDeleteDeleteNamespaceSchema.default({"namespace":"caller"}).describe("The namespace the id resolves within — defaults to the\ncaller's own plugin identity."),
  path_type: CliCommandTasksDeletePathSchema,
...
}).meta({ title: "cli.command.tasks.delete.Request" });
export type CliCommandTasksDeleteRequest = z.infer<typeof CliCommandTasksDeleteRequestSchema>;
