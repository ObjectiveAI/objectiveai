...
import { z } from "zod";
import { CliCommandTasksCreateResponseSchemaPathSchema } from "./path";

export const CliCommandTasksCreateResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandTasksCreateResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.tasks.create.response_schema.Request" });
export type CliCommandTasksCreateResponseSchemaRequest = z.infer<typeof CliCommandTasksCreateResponseSchemaRequestSchema>;
