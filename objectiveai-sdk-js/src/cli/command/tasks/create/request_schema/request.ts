...
import { z } from "zod";
import { CliCommandTasksCreateRequestSchemaPathSchema } from "./path";

export const CliCommandTasksCreateRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandTasksCreateRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.tasks.create.request_schema.Request" });
export type CliCommandTasksCreateRequestSchemaRequest = z.infer<typeof CliCommandTasksCreateRequestSchemaRequestSchema>;
