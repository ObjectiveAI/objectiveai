...
import { z } from "zod";
import { CliCommandLaboratoriesKillResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesKillResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesKillResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.kill.response_schema.Request" });
export type CliCommandLaboratoriesKillResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesKillResponseSchemaRequestSchema>;
