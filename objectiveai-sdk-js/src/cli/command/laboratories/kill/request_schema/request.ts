...
import { z } from "zod";
import { CliCommandLaboratoriesKillRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesKillRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesKillRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.kill.request_schema.Request" });
export type CliCommandLaboratoriesKillRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesKillRequestSchemaRequestSchema>;
