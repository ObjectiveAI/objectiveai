...
import { z } from "zod";
import { CliCommandLaboratoriesKillPathSchema } from "./path";
import { CliCommandSetScopeSchema } from "../../setScope";

export const CliCommandLaboratoriesKillRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesKillPathSchema,
...
}).meta({ title: "cli.command.laboratories.kill.Request" });
export type CliCommandLaboratoriesKillRequest = z.infer<typeof CliCommandLaboratoriesKillRequestSchema>;
