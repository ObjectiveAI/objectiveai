...
import { z } from "zod";
import { CliCommandLaboratoriesConnectResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConnectResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConnectResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.connect.response_schema.Request" });
export type CliCommandLaboratoriesConnectResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesConnectResponseSchemaRequestSchema>;
