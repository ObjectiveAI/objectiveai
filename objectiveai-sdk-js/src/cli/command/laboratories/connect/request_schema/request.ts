...
import { z } from "zod";
import { CliCommandLaboratoriesConnectRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConnectRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConnectRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.connect.request_schema.Request" });
export type CliCommandLaboratoriesConnectRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesConnectRequestSchemaRequestSchema>;
