...
import { CliCommandLaboratoriesAttachPathSchema } from "./path";
...
}).meta({ title: "cli.command.laboratories.attach.Request" });
export type CliCommandLaboratoriesAttachRequest = z.infer<typeof CliCommandLaboratoriesAttachRequestSchema>;
