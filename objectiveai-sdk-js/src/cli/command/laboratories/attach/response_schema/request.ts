...
import { z } from "zod";
import { CliCommandLaboratoriesAttachResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesAttachResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesAttachResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.attach.response_schema.Request" });
export type CliCommandLaboratoriesAttachResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesAttachResponseSchemaRequestSchema>;
