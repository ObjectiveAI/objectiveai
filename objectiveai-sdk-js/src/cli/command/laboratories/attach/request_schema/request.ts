...
import { z } from "zod";
import { CliCommandLaboratoriesAttachRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesAttachRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesAttachRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.attach.request_schema.Request" });
export type CliCommandLaboratoriesAttachRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesAttachRequestSchemaRequestSchema>;
