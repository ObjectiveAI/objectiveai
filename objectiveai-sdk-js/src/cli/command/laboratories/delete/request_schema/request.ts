...
import { z } from "zod";
import { CliCommandLaboratoriesDeleteRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesDeleteRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesDeleteRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.delete.request_schema.Request" });
export type CliCommandLaboratoriesDeleteRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesDeleteRequestSchemaRequestSchema>;
