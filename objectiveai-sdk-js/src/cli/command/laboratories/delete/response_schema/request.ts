...
import { z } from "zod";
import { CliCommandLaboratoriesDeleteResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesDeleteResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesDeleteResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.delete.response_schema.Request" });
export type CliCommandLaboratoriesDeleteResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesDeleteResponseSchemaRequestSchema>;
