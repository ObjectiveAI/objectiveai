...
import { z } from "zod";
import { CliCommandLaboratoriesDetachResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesDetachResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesDetachResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.detach.response_schema.Request" });
export type CliCommandLaboratoriesDetachResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesDetachResponseSchemaRequestSchema>;
