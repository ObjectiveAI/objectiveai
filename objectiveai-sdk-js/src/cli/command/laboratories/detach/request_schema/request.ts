...
import { z } from "zod";
import { CliCommandLaboratoriesDetachRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesDetachRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesDetachRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.detach.request_schema.Request" });
export type CliCommandLaboratoriesDetachRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesDetachRequestSchemaRequestSchema>;
