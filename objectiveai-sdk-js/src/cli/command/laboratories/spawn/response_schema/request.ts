...
import { z } from "zod";
import { CliCommandLaboratoriesSpawnResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesSpawnResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesSpawnResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.spawn.response_schema.Request" });
export type CliCommandLaboratoriesSpawnResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesSpawnResponseSchemaRequestSchema>;
