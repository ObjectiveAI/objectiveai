...
import { z } from "zod";
import { CliCommandLaboratoriesSpawnPathSchema } from "./path";

export const CliCommandLaboratoriesSpawnRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesSpawnPathSchema,
...
}).meta({ title: "cli.command.laboratories.spawn.Request" });
export type CliCommandLaboratoriesSpawnRequest = z.infer<typeof CliCommandLaboratoriesSpawnRequestSchema>;
