...
import { z } from "zod";
import { CliCommandLaboratoriesSpawnRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesSpawnRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesSpawnRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.spawn.request_schema.Request" });
export type CliCommandLaboratoriesSpawnRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesSpawnRequestSchemaRequestSchema>;
