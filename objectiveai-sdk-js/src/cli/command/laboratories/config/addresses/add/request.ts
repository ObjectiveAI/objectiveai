...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesAddPathSchema } from "./path";
import { CliCommandSetScopeSchema } from "../../../../setScope";

export const CliCommandLaboratoriesConfigAddressesAddRequestSchema = z.object({
  ...
  key: z.string().describe("The daemon `http://` address the laboratory host should connect to."),
  ...
  path_type: CliCommandLaboratoriesConfigAddressesAddPathSchema,
...
export type CliCommandLaboratoriesConfigAddressesAddRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesAddRequestSchema>;
