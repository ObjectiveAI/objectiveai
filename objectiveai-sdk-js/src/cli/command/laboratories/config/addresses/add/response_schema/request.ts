...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesAddResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesAddResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesAddResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.add.response_schema.Request" });
export type CliCommandLaboratoriesConfigAddressesAddResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesAddResponseSchemaRequestSchema>;
