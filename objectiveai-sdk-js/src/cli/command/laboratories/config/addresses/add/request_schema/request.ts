...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesAddRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesAddRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesAddRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.add.request_schema.Request" });
export type CliCommandLaboratoriesConfigAddressesAddRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesAddRequestSchemaRequestSchema>;
