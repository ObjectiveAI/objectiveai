...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesGetRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.get.request_schema.Request" });
export type CliCommandLaboratoriesConfigAddressesGetRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesGetRequestSchemaRequestSchema>;
