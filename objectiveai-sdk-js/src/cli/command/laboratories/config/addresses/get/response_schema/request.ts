...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesGetResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.get.response_schema.Request" });
export type CliCommandLaboratoriesConfigAddressesGetResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesGetResponseSchemaRequestSchema>;
