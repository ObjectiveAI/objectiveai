...
import { CliCommandLaboratoriesConfigAddressesGetPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesGetRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesGetPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.get.Request" });
export type CliCommandLaboratoriesConfigAddressesGetRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesGetRequestSchema>;
