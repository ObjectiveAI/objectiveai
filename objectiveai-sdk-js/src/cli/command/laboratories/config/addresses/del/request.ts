...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesDelPathSchema } from "./path";
import { CliCommandSetScopeSchema } from "../../../../setScope";

export const CliCommandLaboratoriesConfigAddressesDelRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesDelPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.del.Request" });
export type CliCommandLaboratoriesConfigAddressesDelRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesDelRequestSchema>;
