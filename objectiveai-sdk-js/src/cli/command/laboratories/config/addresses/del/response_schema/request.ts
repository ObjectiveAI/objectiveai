...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesDelResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesDelResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesDelResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.del.response_schema.Request" });
export type CliCommandLaboratoriesConfigAddressesDelResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesDelResponseSchemaRequestSchema>;
