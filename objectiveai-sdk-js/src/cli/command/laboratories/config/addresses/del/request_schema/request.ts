...
import { z } from "zod";
import { CliCommandLaboratoriesConfigAddressesDelRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigAddressesDelRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigAddressesDelRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.addresses.del.request_schema.Request" });
export type CliCommandLaboratoriesConfigAddressesDelRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigAddressesDelRequestSchemaRequestSchema>;
