...
import { z } from "zod";
import { CliCommandLaboratoriesConfigLocalGetResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigLocalGetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigLocalGetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.local.get.response_schema.Request" });
export type CliCommandLaboratoriesConfigLocalGetResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigLocalGetResponseSchemaRequestSchema>;
