...
import { z } from "zod";
import { CliCommandLaboratoriesConfigLocalGetRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigLocalGetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigLocalGetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.local.get.request_schema.Request" });
export type CliCommandLaboratoriesConfigLocalGetRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigLocalGetRequestSchemaRequestSchema>;
