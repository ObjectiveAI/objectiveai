...
import { CliCommandLaboratoriesConfigLocalGetPathSchema } from "./path";

export const CliCommandLaboratoriesConfigLocalGetRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigLocalGetPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.local.get.Request" });
export type CliCommandLaboratoriesConfigLocalGetRequest = z.infer<typeof CliCommandLaboratoriesConfigLocalGetRequestSchema>;
