...
import { z } from "zod";
import { CliCommandLaboratoriesConfigLocalSetRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigLocalSetRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigLocalSetRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.local.set.request_schema.Request" });
export type CliCommandLaboratoriesConfigLocalSetRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigLocalSetRequestSchemaRequestSchema>;
