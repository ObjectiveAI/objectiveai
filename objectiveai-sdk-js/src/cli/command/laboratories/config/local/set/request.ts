...
import { z } from "zod";
import { CliCommandLaboratoriesConfigLocalSetPathSchema } from "./path";
import { CliCommandSetScopeSchema } from "../../../../setScope";

export const CliCommandLaboratoriesConfigLocalSetRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigLocalSetPathSchema,
  ...
  value: z.boolean(),
}).meta({ title: "cli.command.laboratories.config.local.set.Request" });
export type CliCommandLaboratoriesConfigLocalSetRequest = z.infer<typeof CliCommandLaboratoriesConfigLocalSetRequestSchema>;
