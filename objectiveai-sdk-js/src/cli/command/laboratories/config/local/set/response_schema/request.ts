...
import { z } from "zod";
import { CliCommandLaboratoriesConfigLocalSetResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesConfigLocalSetResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesConfigLocalSetResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.config.local.set.response_schema.Request" });
export type CliCommandLaboratoriesConfigLocalSetResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesConfigLocalSetResponseSchemaRequestSchema>;
