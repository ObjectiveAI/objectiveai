...
import { z } from "zod";
import { CliCommandLaboratoriesCreateResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesCreateResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesCreateResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.create.response_schema.Request" });
export type CliCommandLaboratoriesCreateResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesCreateResponseSchemaRequestSchema>;
