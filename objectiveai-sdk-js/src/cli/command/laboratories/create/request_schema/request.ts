...
import { z } from "zod";
import { CliCommandLaboratoriesCreateRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesCreateRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesCreateRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.create.request_schema.Request" });
export type CliCommandLaboratoriesCreateRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesCreateRequestSchemaRequestSchema>;
