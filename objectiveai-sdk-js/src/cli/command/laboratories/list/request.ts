...
import { z } from "zod";
import { CliCommandLaboratoriesCreateKindSchema } from "../create/kind";
import { CliCommandLaboratoriesListPathSchema } from "./path";

export const CliCommandLaboratoriesListRequestSchema = z.object({
...
export type CliCommandLaboratoriesListRequest = z.infer<typeof CliCommandLaboratoriesListRequestSchema>;
