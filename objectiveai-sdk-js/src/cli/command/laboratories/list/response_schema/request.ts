...
import { z } from "zod";
import { CliCommandLaboratoriesListResponseSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.list.response_schema.Request" });
export type CliCommandLaboratoriesListResponseSchemaRequest = z.infer<typeof CliCommandLaboratoriesListResponseSchemaRequestSchema>;
