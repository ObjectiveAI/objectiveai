...
import { z } from "zod";
import { CliCommandLaboratoriesListRequestSchemaPathSchema } from "./path";

export const CliCommandLaboratoriesListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandLaboratoriesListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.laboratories.list.request_schema.Request" });
export type CliCommandLaboratoriesListRequestSchemaRequest = z.infer<typeof CliCommandLaboratoriesListRequestSchemaRequestSchema>;
