...
export const CliCommandToolsInstallGithubRequestSchema = z.object({
...
}).meta({ title: "cli.command.tools.install.github.Request" });
export type CliCommandToolsInstallGithubRequest = z.infer<typeof CliCommandToolsInstallGithubRequestSchema>;
