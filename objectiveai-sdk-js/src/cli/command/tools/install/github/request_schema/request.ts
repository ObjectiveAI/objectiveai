...
import { z } from "zod";
import { CliCommandToolsInstallGithubRequestSchemaPathSchema } from "./path";

export const CliCommandToolsInstallGithubRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandToolsInstallGithubRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.tools.install.github.request_schema.Request" });
export type CliCommandToolsInstallGithubRequestSchemaRequest = z.infer<typeof CliCommandToolsInstallGithubRequestSchemaRequestSchema>;
