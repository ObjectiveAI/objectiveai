...
import { z } from "zod";
import { CliCommandToolsInstallGithubResponseSchemaPathSchema } from "./path";

export const CliCommandToolsInstallGithubResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandToolsInstallGithubResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.tools.install.github.response_schema.Request" });
export type CliCommandToolsInstallGithubResponseSchemaRequest = z.infer<typeof CliCommandToolsInstallGithubResponseSchemaRequestSchema>;
