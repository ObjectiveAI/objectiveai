...
export const CliCommandToolsInstallFilesystemRequestSchema = z.object({
...
}).meta({ title: "cli.command.tools.install.filesystem.Request" });
export type CliCommandToolsInstallFilesystemRequest = z.infer<typeof CliCommandToolsInstallFilesystemRequestSchema>;
