...
import { z } from "zod";
import { CliCommandToolsInstallFilesystemResponseSchemaPathSchema } from "./path";

export const CliCommandToolsInstallFilesystemResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandToolsInstallFilesystemResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.tools.install.filesystem.response_schema.Request" });
export type CliCommandToolsInstallFilesystemResponseSchemaRequest = z.infer<typeof CliCommandToolsInstallFilesystemResponseSchemaRequestSchema>;
