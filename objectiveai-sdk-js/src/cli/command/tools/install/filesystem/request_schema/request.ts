...
import { z } from "zod";
import { CliCommandToolsInstallFilesystemRequestSchemaPathSchema } from "./path";

export const CliCommandToolsInstallFilesystemRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandToolsInstallFilesystemRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.tools.install.filesystem.request_schema.Request" });
export type CliCommandToolsInstallFilesystemRequestSchemaRequest = z.infer<typeof CliCommandToolsInstallFilesystemRequestSchemaRequestSchema>;
