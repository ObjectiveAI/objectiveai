...
import { z } from "zod";
import { CliCommandPluginsDaemonNotifyRequestSchemaPathSchema } from "./path";

export const CliCommandPluginsDaemonNotifyRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandPluginsDaemonNotifyRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.plugins.daemon.notify.request_schema.Request" });
export type CliCommandPluginsDaemonNotifyRequestSchemaRequest = z.infer<typeof CliCommandPluginsDaemonNotifyRequestSchemaRequestSchema>;
