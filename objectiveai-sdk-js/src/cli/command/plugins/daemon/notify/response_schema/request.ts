...
import { z } from "zod";
import { CliCommandPluginsDaemonNotifyResponseSchemaPathSchema } from "./path";

export const CliCommandPluginsDaemonNotifyResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandPluginsDaemonNotifyResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.plugins.daemon.notify.response_schema.Request" });
export type CliCommandPluginsDaemonNotifyResponseSchemaRequest = z.infer<typeof CliCommandPluginsDaemonNotifyResponseSchemaRequestSchema>;
