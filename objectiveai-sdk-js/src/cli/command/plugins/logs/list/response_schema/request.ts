...
import { z } from "zod";
import { CliCommandPluginsLogsListResponseSchemaPathSchema } from "./path";

export const CliCommandPluginsLogsListResponseSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandPluginsLogsListResponseSchemaPathSchema,
...
}).meta({ title: "cli.command.plugins.logs.list.response_schema.Request" });
export type CliCommandPluginsLogsListResponseSchemaRequest = z.infer<typeof CliCommandPluginsLogsListResponseSchemaRequestSchema>;
