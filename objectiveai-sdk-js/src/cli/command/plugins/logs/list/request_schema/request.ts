...
import { z } from "zod";
import { CliCommandPluginsLogsListRequestSchemaPathSchema } from "./path";

export const CliCommandPluginsLogsListRequestSchemaRequestSchema = z.object({
  ...
  path_type: CliCommandPluginsLogsListRequestSchemaPathSchema,
...
}).meta({ title: "cli.command.plugins.logs.list.request_schema.Request" });
export type CliCommandPluginsLogsListRequestSchemaRequest = z.infer<typeof CliCommandPluginsLogsListRequestSchemaRequestSchema>;
