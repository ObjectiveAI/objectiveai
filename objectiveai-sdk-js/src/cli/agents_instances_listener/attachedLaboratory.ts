...
export const CliAgentsInstancesListenerAttachedLaboratorySchema = z.object({
...
}).describe("One laboratory attachment on the agent, as carried by\n[`AgentRecord::attached_laboratories`]. Mirrors `agents instances\nget`'s attachment shape (listener-local — this wire is a mirror,\nnot a re-export).").meta({ title: "cli.agents_instances_listener.AttachedLaboratory" });
export type CliAgentsInstancesListenerAttachedLaboratory = z.infer<typeof CliAgentsInstancesListenerAttachedLaboratorySchema>;
