...
// materialized `/agents/instances/list` view), and
// `websocketAgentsInstancesListener` (the materialized
// `/agents/instances/{*aih}` conversation + agent-status view). Kept
// header-free so install-zod preserves it instead of overwriting it
// with a stub.
