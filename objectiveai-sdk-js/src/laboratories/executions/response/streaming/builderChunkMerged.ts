import type { LaboratoriesExecutionsResponseStreamingBuilderChunk } from "./builderChunk";
...
export function laboratoriesExecutionsResponseStreamingBuilderChunkMerged(
  a: LaboratoriesExecutionsResponseStreamingBuilderChunk,
  b: LaboratoriesExecutionsResponseStreamingBuilderChunk,
): [LaboratoriesExecutionsResponseStreamingBuilderChunk, boolean] {
  let changed = false;
...
export function laboratoriesExecutionsResponseStreamingBuilderChunkMergedList(
  a: LaboratoriesExecutionsResponseStreamingBuilderChunk[],
  b: LaboratoriesExecutionsResponseStreamingBuilderChunk[],
): [LaboratoriesExecutionsResponseStreamingBuilderChunk[], boolean] {
  let changed = false;
  ...
  for (const bItem of b) {
    ...
    if (existingIdx !== -1) {
      const [merged, c] = laboratoriesExecutionsResponseStreamingBuilderChunkMerged(result[existingIdx], bItem);
      if (c) {
