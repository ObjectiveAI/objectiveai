...
/** `api config commit_author_email set execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigCommitAuthorEmailSetExecuteJq(request: Omit<CliCommandApiConfigCommitAuthorEmailSetRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function apiConfigCommitAuthorEmailSetRequestSchemaExecute(request: Omit<CliCommandApiConfigCommitAuthorEmailSetRequestSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "api/config/commit_author_email/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `api config commit_author_email set request_schema execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigCommitAuthorEmailSetRequestSchemaExecuteJq(request: Omit<CliCommandApiConfigCommitAuthorEmailSetRequestSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function apiConfigCommitAuthorEmailSetResponseSchemaExecute(request: Omit<CliCommandApiConfigCommitAuthorEmailSetResponseSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "api/config/commit_author_email/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `api config commit_author_email set response_schema execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigCommitAuthorEmailSetResponseSchemaExecuteJq(request: Omit<CliCommandApiConfigCommitAuthorEmailSetResponseSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
