...
/** `api config mcp_authorization add execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigMcpAuthorizationAddExecuteJq(request: Omit<CliCommandApiConfigMcpAuthorizationAddRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function apiConfigMcpAuthorizationAddRequestSchemaExecute(request: Omit<CliCommandApiConfigMcpAuthorizationAddRequestSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "api/config/mcp_authorization/add/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `api config mcp_authorization add request_schema execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigMcpAuthorizationAddRequestSchemaExecuteJq(request: Omit<CliCommandApiConfigMcpAuthorizationAddRequestSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function apiConfigMcpAuthorizationAddResponseSchemaExecute(request: Omit<CliCommandApiConfigMcpAuthorizationAddResponseSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "api/config/mcp_authorization/add/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `api config mcp_authorization add response_schema execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigMcpAuthorizationAddResponseSchemaExecuteJq(request: Omit<CliCommandApiConfigMcpAuthorizationAddResponseSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
