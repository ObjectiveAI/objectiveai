...
/** `api config mcp_authorization del execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigMcpAuthorizationDelExecuteJq(request: Omit<CliCommandApiConfigMcpAuthorizationDelRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function apiConfigMcpAuthorizationDelRequestSchemaExecute(request: Omit<CliCommandApiConfigMcpAuthorizationDelRequestSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "api/config/mcp_authorization/del/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `api config mcp_authorization del request_schema execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigMcpAuthorizationDelRequestSchemaExecuteJq(request: Omit<CliCommandApiConfigMcpAuthorizationDelRequestSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function apiConfigMcpAuthorizationDelResponseSchemaExecute(request: Omit<CliCommandApiConfigMcpAuthorizationDelResponseSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "api/config/mcp_authorization/del/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `api config mcp_authorization del response_schema execute_jq` — unary; first stream item, rest discarded. */
export async function apiConfigMcpAuthorizationDelResponseSchemaExecuteJq(request: Omit<CliCommandApiConfigMcpAuthorizationDelResponseSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
