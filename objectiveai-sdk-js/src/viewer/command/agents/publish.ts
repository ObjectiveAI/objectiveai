...
export async function agentsPublishExecute(request: Omit<CliCommandAgentsPublishRequest, "path_type">): Promise<CliError | CliCommandAgentsPublishResponse> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "agents/publish" }), z.union([CliErrorSchema, CliCommandAgentsPublishResponseSchema]));
...
/** `agents publish execute_jq` — unary; first stream item, rest discarded. */
export async function agentsPublishExecuteJq(request: Omit<CliCommandAgentsPublishRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function agentsPublishRequestSchemaExecute(request: Omit<CliCommandAgentsPublishRequestSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "agents/publish/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `agents publish request_schema execute_jq` — unary; first stream item, rest discarded. */
export async function agentsPublishRequestSchemaExecuteJq(request: Omit<CliCommandAgentsPublishRequestSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function agentsPublishResponseSchemaExecute(request: Omit<CliCommandAgentsPublishResponseSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "agents/publish/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `agents publish response_schema execute_jq` — unary; first stream item, rest discarded. */
export async function agentsPublishResponseSchemaExecuteJq(request: Omit<CliCommandAgentsPublishResponseSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
