...
export async function agentsGetExecute(request: Omit<CliCommandAgentsGetRequest, "path_type">): Promise<CliError | AgentGetAgentResponse> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "agents/get" }), z.union([CliErrorSchema, AgentGetAgentResponseSchema]));
...
/** `agents get execute_jq` — unary; first stream item, rest discarded. */
export async function agentsGetExecuteJq(request: Omit<CliCommandAgentsGetRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function agentsGetRequestSchemaExecute(request: Omit<CliCommandAgentsGetRequestSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "agents/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `agents get request_schema execute_jq` — unary; first stream item, rest discarded. */
export async function agentsGetRequestSchemaExecuteJq(request: Omit<CliCommandAgentsGetRequestSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
...
export async function agentsGetResponseSchemaExecute(request: Omit<CliCommandAgentsGetResponseSchemaRequest, "path_type">): Promise<CliError | JsonValue> {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: undefined, path_type: "agents/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === undefined) {
...
/** `agents get response_schema execute_jq` — unary; first stream item, rest discarded. */
export async function agentsGetResponseSchemaExecuteJq(request: Omit<CliCommandAgentsGetResponseSchemaRequest, "path_type">, jq: string): Promise<CliError | JsonValue> {
