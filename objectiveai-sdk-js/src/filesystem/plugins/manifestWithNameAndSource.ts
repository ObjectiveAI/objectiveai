...
import { z } from "zod";
import { FilesystemPluginsBinariesSchema } from "./binaries";
import { FilesystemPluginsViewerRouteSchema } from "./viewerRoute";

export const FilesystemPluginsManifestWithNameAndSourceSchema = z.object({
  author: z.string().nullable().describe("Author or authors of the plugin. Free-form string.").meta({ omitempty: true }).optional(),
...
export type FilesystemPluginsManifestWithNameAndSource = z.infer<typeof FilesystemPluginsManifestWithNameAndSourceSchema>;
