...
async function agentsGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "agents/get" }), z.union([CliErrorSchema, AgentGetAgentResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function functionsGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "functions/get" }), z.union([CliErrorSchema, FunctionsGetFunctionResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function functionsProfilesGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "functions/profiles/get" }), z.union([CliErrorSchema, FunctionsProfilesGetProfileResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function swarmsGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "swarms/get" }), z.union([CliErrorSchema, SwarmGetSwarmResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function toolsInstallExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "tools/install" }), z.union([CliErrorSchema, CliCommandToolsInstallResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function toolsInstallExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "tools/install" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("tools install: cli produced no output before the end marker");
  }
...
async function toolsInstallRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "tools/install/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function toolsInstallRequestSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "tools/install/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("tools install request_schema: cli produced no output before the end marker");
  }
...
async function toolsInstallResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "tools/install/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function toolsInstallResponseSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "tools/install/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("tools install response_schema: cli produced no output before the end marker");
  }
