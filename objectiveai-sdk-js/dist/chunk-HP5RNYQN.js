...
var ViewerApiCallEnvelopeSchema = z.union([z.object({
...
var ViewerHttpMethodSchema = z.enum(["GET", "POST", "DELETE"]).describe("HTTP method an [`ApiCallSubType`] maps to. Mirrors the methods\n`objectiveai-api`'s router uses (`POST`, `GET`, `DELETE`).").meta({ title: "viewer.HttpMethod" });
...
export { JsonValueSchema, ObjectiveAIFetchError, Stream, ViewerApiCallEnvelopeSchema, ViewerApiCallSubTypeSchema, ViewerEventSchema, ViewerHttpMethodSchema, __resetForTests, invokeCli, isResponseError, listen, viewerApiCallChunks, viewerApiCallStream, viewerApiCallUnary, viewerApiCallUnaryNoResponse };
