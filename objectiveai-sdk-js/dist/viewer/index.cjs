...
var ViewerDestinationSchema = zod.z.union([zod.z.literal("objectiveai").describe("The main viewer UI.").meta({ "variantTitle": "Objectiveai" }), zod.z.object({
  plugin: zod.z.object({
    name: zod.z.string(),
    owner: zod.z.string(),
...
exports.ViewerDestinationSchema = ViewerDestinationSchema;
