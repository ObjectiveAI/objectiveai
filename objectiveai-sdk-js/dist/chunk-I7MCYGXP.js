...
var CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchema = z.object({
...
async function apiConfigBackoffMaxElapsedTimeMsGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/backoff_max_elapsed_time_ms/get" }), z.union([CliErrorSchema, CliCommandApiConfigBackoffMaxElapsedTimeMsGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigBackoffMaxElapsedTimeMsGetExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/backoff_max_elapsed_time_ms/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config backoff_max_elapsed_time_ms get: cli produced no output before the end marker");
  }
...
async function apiConfigBackoffMaxElapsedTimeMsGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/backoff_max_elapsed_time_ms/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigBackoffMaxElapsedTimeMsGetRequestSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/backoff_max_elapsed_time_ms/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config backoff_max_elapsed_time_ms get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigBackoffMaxElapsedTimeMsGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/backoff_max_elapsed_time_ms/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigBackoffMaxElapsedTimeMsGetResponseSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/backoff_max_elapsed_time_ms/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config backoff_max_elapsed_time_ms get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigBackoffMaxElapsedTimeMsSetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, path_type: "api/config/backoff_max_elapsed_time_ms/set" }), z.union([CliErrorSchema, CliCommandOkSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigBackoffMaxElapsedTimeMsSetExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, path_type: "api/config/backoff_max_elapsed_time_ms/set" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config backoff_max_elapsed_time_ms set: cli produced no output before the end marker");
  }
...
async function apiConfigBackoffMaxElapsedTimeMsSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/backoff_max_elapsed_time_ms/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigBackoffMaxElapsedTimeMsSetRequestSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/backoff_max_elapsed_time_ms/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config backoff_max_elapsed_time_ms set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigBackoffMaxElapsedTimeMsSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/backoff_max_elapsed_time_ms/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigBackoffMaxElapsedTimeMsSetResponseSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/backoff_max_elapsed_time_ms/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config backoff_max_elapsed_time_ms set response_schema: cli produced no output before the end marker");
  }
...
var CliCommandApiConfigMcpTimeoutMsGetResponseSchema = z.object({
...
async function apiConfigMcpTimeoutMsGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/mcp_timeout_ms/get" }), z.union([CliErrorSchema, CliCommandApiConfigMcpTimeoutMsGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpTimeoutMsGetExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/mcp_timeout_ms/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_timeout_ms get: cli produced no output before the end marker");
  }
...
async function apiConfigMcpTimeoutMsGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/mcp_timeout_ms/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpTimeoutMsGetRequestSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/mcp_timeout_ms/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_timeout_ms get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpTimeoutMsGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/mcp_timeout_ms/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpTimeoutMsGetResponseSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/mcp_timeout_ms/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_timeout_ms get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpTimeoutMsSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/mcp_timeout_ms/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpTimeoutMsSetRequestSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/mcp_timeout_ms/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_timeout_ms set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpTimeoutMsSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "api/config/mcp_timeout_ms/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpTimeoutMsSetResponseSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "api/config/mcp_timeout_ms/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_timeout_ms set response_schema: cli produced no output before the end marker");
  }
...
var CliCommandKillAllResponseSchema = z.object({
  killed: z.number().int().min(0).max(4294967295)
}).meta({ title: "cli.command.kill_all.Response" });

// src/viewer/command/kill_all.ts
async function killAllExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "kill-all" }), z.union([CliErrorSchema, CliCommandKillAllResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function killAllExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "kill-all" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("kill_all: cli produced no output before the end marker");
  }
...
async function killAllRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "kill-all/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function killAllRequestSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "kill-all/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("kill_all request_schema: cli produced no output before the end marker");
  }
...
async function killAllResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, path_type: "kill-all/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function killAllResponseSchemaExecuteTransform(request, transform) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, python: void 0, ...transform, path_type: "kill-all/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("kill_all response_schema: cli produced no output before the end marker");
  }
