...
async function agentsEnqueueExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "agents/enqueue" }), z.union([CliErrorSchema, CliCommandAgentsEnqueueResponseSchema]));
...
async function agentsEnqueueRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "agents/enqueue/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function agentsEnqueueResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "agents/enqueue/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function agentsMessageExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "agents/message" }), z.union([CliErrorSchema, CliCommandAgentsMessageResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigAddressGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/address/get" }), z.union([CliErrorSchema, CliCommandApiConfigAddressGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigAddressGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/address/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config address get: cli produced no output before the end marker");
  }
...
async function apiConfigAddressGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigAddressGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config address get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigAddressGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigAddressGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config address get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigAddressSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigAddressSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config address set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigAddressSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigAddressSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config address set response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigCommitAuthorEmailGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_email/get" }), z.union([CliErrorSchema, CliCommandApiConfigCommitAuthorEmailGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorEmailGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_email/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorEmailGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_email/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorEmailSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_email/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorEmailSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/commit_author_email/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config commit_author_email set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigCommitAuthorEmailSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_email/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorEmailSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/commit_author_email/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config commit_author_email set response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigCommitAuthorNameGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_name/get" }), z.union([CliErrorSchema, CliCommandApiConfigCommitAuthorNameGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorNameGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_name/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorNameGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_name/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorNameSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_name/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigCommitAuthorNameSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/commit_author_name/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/get" }), z.union([CliErrorSchema, CliCommandApiConfigGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config get: cli produced no output before the end marker");
  }
...
async function apiConfigGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigGithubAuthorizationGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/github_authorization/get" }), z.union([CliErrorSchema, CliCommandApiConfigGithubAuthorizationGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGithubAuthorizationGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/github_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGithubAuthorizationGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/github_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGithubAuthorizationSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/github_authorization/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGithubAuthorizationSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/github_authorization/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config github_authorization set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigGithubAuthorizationSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/github_authorization/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigGithubAuthorizationSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/github_authorization/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config github_authorization set response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigHttpRefererGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/http_referer/get" }), z.union([CliErrorSchema, CliCommandApiConfigHttpRefererGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigHttpRefererGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/http_referer/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config http_referer get: cli produced no output before the end marker");
  }
...
async function apiConfigHttpRefererGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/http_referer/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigHttpRefererGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/http_referer/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config http_referer get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigHttpRefererGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/http_referer/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigHttpRefererGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/http_referer/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config http_referer get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigHttpRefererSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/http_referer/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigHttpRefererSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/http_referer/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationAddRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/add/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationAddRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/add/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization add request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpAuthorizationAddResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/add/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationAddResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/add/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization add response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpAuthorizationDelRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/del/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationDelRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/del/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization del request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpAuthorizationDelResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/del/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationDelResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/del/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization del response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpAuthorizationGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/get" }), z.union([CliErrorSchema, CliCommandApiConfigMcpAuthorizationGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization get: cli produced no output before the end marker");
  }
...
async function apiConfigMcpAuthorizationGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigMcpAuthorizationGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/mcp_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigMcpAuthorizationGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/mcp_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config mcp_authorization get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigObjectiveaiAuthorizationGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/objectiveai_authorization/get" }), z.union([CliErrorSchema, CliCommandApiConfigObjectiveaiAuthorizationGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigObjectiveaiAuthorizationGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/objectiveai_authorization/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config objectiveai_authorization get: cli produced no output before the end marker");
  }
...
async function apiConfigObjectiveaiAuthorizationGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/objectiveai_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigObjectiveaiAuthorizationGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/objectiveai_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config objectiveai_authorization get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigObjectiveaiAuthorizationGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/objectiveai_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigObjectiveaiAuthorizationGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/objectiveai_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config objectiveai_authorization get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigObjectiveaiAuthorizationSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/objectiveai_authorization/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigObjectiveaiAuthorizationSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/objectiveai_authorization/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config objectiveai_authorization set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigObjectiveaiAuthorizationSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/objectiveai_authorization/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigObjectiveaiAuthorizationSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/objectiveai_authorization/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config objectiveai_authorization set response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigOpenrouterAuthorizationGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/openrouter_authorization/get" }), z.union([CliErrorSchema, CliCommandApiConfigOpenrouterAuthorizationGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigOpenrouterAuthorizationGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/openrouter_authorization/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config openrouter_authorization get: cli produced no output before the end marker");
  }
...
async function apiConfigOpenrouterAuthorizationGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/openrouter_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigOpenrouterAuthorizationGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/openrouter_authorization/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config openrouter_authorization get request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigOpenrouterAuthorizationGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/openrouter_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigOpenrouterAuthorizationGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/openrouter_authorization/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config openrouter_authorization get response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigOpenrouterAuthorizationSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/openrouter_authorization/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigOpenrouterAuthorizationSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/openrouter_authorization/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config openrouter_authorization set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigOpenrouterAuthorizationSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/openrouter_authorization/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigOpenrouterAuthorizationSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/openrouter_authorization/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config openrouter_authorization set response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigUserAgentGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/user_agent/get" }), z.union([CliErrorSchema, CliCommandApiConfigUserAgentGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigUserAgentGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/user_agent/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigUserAgentGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/user_agent/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigUserAgentSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/user_agent/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigUserAgentSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/user_agent/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config user_agent set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigUserAgentSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/user_agent/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigUserAgentSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/user_agent/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config user_agent set response_schema: cli produced no output before the end marker");
  }
...
async function apiConfigXTitleGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/x_title/get" }), z.union([CliErrorSchema, CliCommandApiConfigXTitleGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigXTitleGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/x_title/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigXTitleGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/x_title/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigXTitleSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/x_title/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigXTitleSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/x_title/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config x_title set request_schema: cli produced no output before the end marker");
  }
...
async function apiConfigXTitleSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "api/config/x_title/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function apiConfigXTitleSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "api/config/x_title/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("api config x_title set response_schema: cli produced no output before the end marker");
  }
...
async function dbConfigAddressGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/address/get" }), z.union([CliErrorSchema, CliCommandDbConfigAddressGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigAddressGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/address/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config address get: cli produced no output before the end marker");
  }
...
async function dbConfigAddressGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigAddressGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config address get request_schema: cli produced no output before the end marker");
  }
...
async function dbConfigAddressGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigAddressGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config address get response_schema: cli produced no output before the end marker");
  }
...
async function dbConfigAddressSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigAddressSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config address set request_schema: cli produced no output before the end marker");
  }
...
async function dbConfigAddressSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigAddressSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config address set response_schema: cli produced no output before the end marker");
  }
...
async function dbConfigDatabaseGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/database/get" }), z.union([CliErrorSchema, CliCommandDbConfigDatabaseGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigDatabaseGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/database/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config database get: cli produced no output before the end marker");
  }
...
async function dbConfigDatabaseGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/database/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigDatabaseGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/database/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config database get request_schema: cli produced no output before the end marker");
  }
...
async function dbConfigDatabaseGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/database/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigDatabaseGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/database/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config database get response_schema: cli produced no output before the end marker");
  }
...
async function dbConfigDatabaseSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/database/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigDatabaseSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/database/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config database set request_schema: cli produced no output before the end marker");
  }
...
async function dbConfigDatabaseSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/database/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigDatabaseSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/database/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config database set response_schema: cli produced no output before the end marker");
  }
...
async function dbConfigGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/get" }), z.union([CliErrorSchema, CliCommandDbConfigGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigPasswordGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/password/get" }), z.union([CliErrorSchema, CliCommandDbConfigPasswordGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigPasswordGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/password/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigPasswordGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/password/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigPasswordSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/password/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigPasswordSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/password/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigUserGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/user/get" }), z.union([CliErrorSchema, CliCommandDbConfigUserGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigUserGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/user/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config user get: cli produced no output before the end marker");
  }
...
async function dbConfigUserGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/user/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigUserGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/user/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config user get request_schema: cli produced no output before the end marker");
  }
...
async function dbConfigUserGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/user/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigUserGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/user/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config user get response_schema: cli produced no output before the end marker");
  }
...
async function dbConfigUserSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/user/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigUserSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/user/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config user set request_schema: cli produced no output before the end marker");
  }
...
async function dbConfigUserSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/config/user/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbConfigUserSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/config/user/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db config user set response_schema: cli produced no output before the end marker");
  }
...
async function dbKillExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/kill" }), z.union([CliErrorSchema, CliCommandDbKillResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbKillExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/kill" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db kill: cli produced no output before the end marker");
  }
...
async function dbKillRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/kill/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbKillRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/kill/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db kill request_schema: cli produced no output before the end marker");
  }
...
async function dbKillResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/kill/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbKillResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "db/kill/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("db kill response_schema: cli produced no output before the end marker");
  }
...
async function dbSpawnExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/spawn" }), z.union([CliErrorSchema, CliCommandDbSpawnResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbSpawnRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/spawn/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function dbSpawnResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "db/spawn/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigAddressGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/address/get" }), z.union([CliErrorSchema, CliCommandMcpConfigAddressGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigAddressGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigAddressGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigAddressSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigAddressSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "mcp/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("mcp config address set request_schema: cli produced no output before the end marker");
  }
...
async function mcpConfigAddressSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigAddressSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "mcp/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("mcp config address set response_schema: cli produced no output before the end marker");
  }
...
async function mcpConfigGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/get" }), z.union([CliErrorSchema, CliCommandMcpConfigGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigPortGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/port/get" }), z.union([CliErrorSchema, CliCommandMcpConfigPortGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigPortGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "mcp/config/port/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("mcp config port get: cli produced no output before the end marker");
  }
...
async function mcpConfigPortGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/port/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigPortGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "mcp/config/port/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("mcp config port get request_schema: cli produced no output before the end marker");
  }
...
async function mcpConfigPortGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/port/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigPortGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "mcp/config/port/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("mcp config port get response_schema: cli produced no output before the end marker");
  }
...
async function mcpConfigPortSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/port/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function mcpConfigPortSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "mcp/config/port/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigAddressGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/address/get" }), z.union([CliErrorSchema, CliCommandViewerConfigAddressGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigAddressGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/address/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config address get: cli produced no output before the end marker");
  }
...
async function viewerConfigAddressGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigAddressGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/address/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config address get request_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigAddressGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigAddressGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/address/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config address get response_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigAddressSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigAddressSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/address/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config address set request_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigAddressSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigAddressSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/address/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config address set response_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/get" }), z.union([CliErrorSchema, CliCommandViewerConfigGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSecretGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/secret/get" }), z.union([CliErrorSchema, CliCommandViewerConfigSecretGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSecretGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/secret/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config secret get: cli produced no output before the end marker");
  }
...
async function viewerConfigSecretGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/secret/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSecretGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/secret/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config secret get request_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigSecretGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/secret/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSecretGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/secret/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config secret get response_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigSecretSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/secret/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSecretSetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/secret/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config secret set request_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigSecretSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/secret/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSecretSetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/secret/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config secret set response_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigSignatureGetExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/signature/get" }), z.union([CliErrorSchema, CliCommandViewerConfigSignatureGetResponseSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSignatureGetExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/signature/get" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config signature get: cli produced no output before the end marker");
  }
...
async function viewerConfigSignatureGetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/signature/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSignatureGetRequestSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/signature/get/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config signature get request_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigSignatureGetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/signature/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSignatureGetResponseSchemaExecuteJq(request, jq) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq, path_type: "viewer/config/signature/get/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
    throw new Error("viewer config signature get response_schema: cli produced no output before the end marker");
  }
...
async function viewerConfigSignatureSetRequestSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/signature/set/request_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
...
async function viewerConfigSignatureSetResponseSchemaExecute(request) {
  const stream = new CliStream(invokeCliRequest({ ...request, jq: void 0, path_type: "viewer/config/signature/set/response_schema" }), z.union([CliErrorSchema, JsonValueSchema]));
  const first = await stream.first();
  if (first === void 0) {
