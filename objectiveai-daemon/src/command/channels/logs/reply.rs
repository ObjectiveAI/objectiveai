//! `channels logs reply` — the owner→publisher write. Authenticate the
//! owner secret, require an OPEN channel, append a `reply` entry.

use objectiveai_sdk::cli::command::channels::logs::reply::{Request, Response};
...
pub async fn execute(
    ...
    if role != Role::Owner {
        return Err(Error::Instance(
            "channels logs reply requires the owner secret".to_string(),
        ));
    }
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::channels::logs::reply as sdk;
    use objectiveai_sdk::cli::command::channels::logs::reply::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::channels::logs::reply as sdk;
    use objectiveai_sdk::cli::command::channels::logs::reply::response_schema::{Request, Response};
