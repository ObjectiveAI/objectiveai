...
use objectiveai_sdk::cli::command::api::config::mcp_timeout_ms::set::{Request, Response};
...
pub async fn execute(ctx: &Context, request: Request) -> Result<Response, Error> {
    ...
    config.api().set_mcp_timeout_ms(timeout_ms);
    ctx.filesystem.write_config_at(request.scope, &config).await?;
    Ok(Response::Ok)
}

pub mod request_schema {
    use objectiveai_sdk::cli::command::api::config::mcp_timeout_ms::set as sdk;
    use objectiveai_sdk::cli::command::api::config::mcp_timeout_ms::set::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::api::config::mcp_timeout_ms::set as sdk;
    use objectiveai_sdk::cli::command::api::config::mcp_timeout_ms::set::response_schema::{Request, Response};
