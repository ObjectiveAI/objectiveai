//! `config api objectiveai-authorization set` — write `api.objectiveai_authorization` to on-disk config.

use objectiveai_sdk::cli::command::api::config::objectiveai_authorization::set::{Request, Response};
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::api::config::objectiveai_authorization::set as sdk;
    use objectiveai_sdk::cli::command::api::config::objectiveai_authorization::set::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::api::config::objectiveai_authorization::set as sdk;
    use objectiveai_sdk::cli::command::api::config::objectiveai_authorization::set::response_schema::{Request, Response};
