...
/// own response, [`Cancelled`](crate::endpoints::agents::message::server::response::Frame::Cancelled)
/// when the cancel was in time and [`Delivered`](crate::endpoints::agents::message::server::response::Frame::Delivered)
