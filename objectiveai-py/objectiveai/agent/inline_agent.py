...
This is an untagged enum that dispatches to the per-upstream Agent."""
    ...
    root: Union[InlineAgentOpenrouter, InlineAgentClaudeAgentSdk, InlineAgentClaudeCode, InlineAgentMock]
