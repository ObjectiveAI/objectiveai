#!/usr/bin/env bash
# Builds objectiveai-codex-sdk-runner and places the binary in embed/<target>/<profile>/.
# Skips the build if the source fingerprint hasn't changed.
# Output is captured to .logs/build/objectiveai-codex-sdk-runner.txt.
#
# Usage:
#   bash objectiveai-codex-sdk-runner/build.sh [--release] [--target <triple>]

set -euo pipefail

MODULE="objectiveai-codex-sdk-runner"
