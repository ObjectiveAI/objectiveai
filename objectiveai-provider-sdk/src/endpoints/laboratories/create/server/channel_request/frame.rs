...
pub enum Frame<'a> {
    ...
    ///
    /// Opened only for an
    /// [`ImageType::Client`](crate::endpoints::laboratories::create::client::request::ImageType::Client)
    ...
    /// [`Write`](crate::endpoints::laboratories::create::client::channel_request::Frame::Write)
