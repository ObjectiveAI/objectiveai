...
///
/// [`name`](Self::name) is what to call it and
/// [`created`](Self::created) is how old it is. That is the whole of
...
pub struct Volume {
    ...
    ///
    /// A label, and nothing derives it from anything: a provider
    /// chooses it, and it need not resemble whatever the directory is
    /// called wherever it lives.
    ///
    /// It is also the HANDLE, and now the only one. A
