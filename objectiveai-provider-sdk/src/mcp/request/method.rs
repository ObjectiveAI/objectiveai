...
/// [`path`](super::Request::path) — is what distinguishes them. Each
/// has its own shape of answer, which is why a response cannot be
/// assumed to be anything until its status and headers arrive.
