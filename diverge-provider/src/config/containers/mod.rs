...
//! running set may reach together — and [`ServerImage`], one image
//! the provider offers as its own, which is what `images::check`
//! answers from. [`Containers`] holds them, and is the one section
