...
The ask is defined by `diverge-provider-sdk-rs/src/shared/containers/command/request/request.rs`:

```rust include=diverge-provider-sdk-rs/src/shared/containers/command/request/request.rs
```

The messages are defined by `diverge-provider-sdk-rs/src/shared/containers/command/response/frame.rs`:
...
`diverge-provider-sdk-rs/src/shared/containers/command/response/error.rs`:

```rust include=diverge-provider-sdk-rs/src/shared/containers/command/response/error.rs
```
