...
`diverge-provider-sdk-rs/src/container_proxy/filesystem/write/request/request.rs`:

```rust include=diverge-provider-sdk-rs/src/container_proxy/filesystem/write/request/request.rs
```

A piece is defined by
`diverge-provider-sdk-rs/src/container_proxy/filesystem/write/request/frame.rs`:

```rust include=diverge-provider-sdk-rs/src/container_proxy/filesystem/write/request/frame.rs
```

The answer is defined by
`diverge-provider-sdk-rs/src/container_proxy/filesystem/write/response/frame.rs`:

```rust include=diverge-provider-sdk-rs/src/container_proxy/filesystem/write/response/frame.rs
```

The ways in which the answer fails to decode are defined by
`diverge-provider-sdk-rs/src/container_proxy/filesystem/write/response/error.rs`:

```rust include=diverge-provider-sdk-rs/src/container_proxy/filesystem/write/response/error.rs
```
