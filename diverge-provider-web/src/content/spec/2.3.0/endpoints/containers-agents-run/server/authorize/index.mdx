---
title: 'Authorize'
summary: 'Tag 2: the server asks the runner whether a connector may attach, carrying the connector’s peer address as the server observed it and the connector’s authorization verbatim; the runner answers with exactly one byte.'
order: 2
draft: false
---
