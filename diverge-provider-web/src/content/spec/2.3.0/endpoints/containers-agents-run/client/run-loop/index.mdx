...
- **The request.** The tag byte `5` followed by the prompt as JSON.
  [Request](/endpoints/containers-agents-run/client/run-loop/request/) states its form.
- **The response.** One channel response per chunk, an error last
  ...
  proxy closes. [Response](/endpoints/containers-agents-run/client/run-loop/response/)
  states the sequence.
