---
title: 'Endpoints'
summary: 'A request’s payload begins with one tag byte designating the endpoint; sixteen endpoints are defined, and a request the server cannot read is answered by a bare response finish.'
order: 6
draft: false
---
...
| `8` | [volumes::serve](/endpoints/volumes-serve/) |
| `9` | [volumes::create_capacity](/endpoints/volumes-create-capacity/) |
| `10` | [volumes::create](/endpoints/volumes-create/) |
| `11` | [volumes::edit_capacity](/endpoints/volumes-edit-capacity/) |
| `12` | [volumes::edit](/endpoints/volumes-edit/) |
| `13` | [volumes::delete](/endpoints/volumes-delete/) |
| `14` | [images::check](/endpoints/images-check/) |
| `15` | [version](/endpoints/version/) |
