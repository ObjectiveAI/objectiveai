---
title: 'Endpoints'
summary: 'A request’s payload begins with one tag byte designating the endpoint; twelve endpoints are defined, and a request the server cannot read is answered by a bare response finish.'
order: 6
draft: false
---
...
| `5` | [volumes::create_capacity](/endpoints/volumes-create-capacity/) |
| `6` | [volumes::create](/endpoints/volumes-create/) |
| `7` | [volumes::edit_capacity](/endpoints/volumes-edit-capacity/) |
| `8` | [volumes::edit](/endpoints/volumes-edit/) |
| `9` | [volumes::delete](/endpoints/volumes-delete/) |
| `10` | [images::check](/endpoints/images-check/) |
| `11` | [version](/endpoints/version/) |
