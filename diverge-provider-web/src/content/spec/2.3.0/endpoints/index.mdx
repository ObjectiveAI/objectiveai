---
title: 'Endpoints'
summary: 'A request’s payload begins with one tag byte designating the endpoint; ten endpoints are defined, and a request the server cannot read is answered by a bare response finish.'
order: 5
draft: false
---
...
| `4` | volumes::watch |
| `5` | [volumes::create](/endpoints/volumes-create/) |
| `6` | volumes::edit |
| `7` | volumes::delete |
| `8` | [images::check](/endpoints/images-check/) |
| `9` | [version](/endpoints/version/) |
