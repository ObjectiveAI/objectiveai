---
title: 'Endpoints'
summary: 'A request’s payload begins with one tag byte designating the endpoint; thirteen endpoints are defined, and a request the server cannot read is answered by a bare response finish.'
order: 5
draft: false
---
...
| `5` | [volumes::watch](/endpoints/volumes-watch/) |
| `6` | [volumes::create_capacity](/endpoints/volumes-create-capacity/) |
| `7` | [volumes::create](/endpoints/volumes-create/) |
| `8` | [volumes::edit_capacity](/endpoints/volumes-edit-capacity/) |
| `9` | [volumes::edit](/endpoints/volumes-edit/) |
| `10` | [volumes::delete](/endpoints/volumes-delete/) |
| `11` | [images::check](/endpoints/images-check/) |
| `12` | [version](/endpoints/version/) |

The tag values are normative as tabulated. Each endpoint's section
follows; a section not yet present is defined, for this revision, by
the crate.
