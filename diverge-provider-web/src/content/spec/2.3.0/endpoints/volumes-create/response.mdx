---
title: 'Response'
summary: 'The server sends exactly one response, whose payload is exactly the byte 0 when the volume exists or the byte 1 followed by an error as one JSON value, and the response finish follows it.'
order: 2
draft: false
---
