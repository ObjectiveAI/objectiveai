...
The response is defined by `diverge-provider-sdk-rs/src/endpoints/volumes/create/server/response/frame.rs`:

```rust include=diverge-provider-sdk-rs/src/endpoints/volumes/create/server/response/frame.rs
```
