...
`diverge-sdk-rs/src/provider/endpoints/version/server/response/frame.rs`:

```rust include=diverge-sdk-rs/src/provider/endpoints/version/server/response/frame.rs
```
