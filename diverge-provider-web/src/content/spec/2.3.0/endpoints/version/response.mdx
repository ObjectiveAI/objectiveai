...
`diverge-provider-sdk-rs/src/endpoints/version/server/response/frame.rs`:

```rust include=diverge-provider-sdk-rs/src/endpoints/version/server/response/frame.rs
```
