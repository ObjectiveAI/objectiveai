---
title: 'volumes::list'
summary: 'Tag 3: a client asks which volumes are available to it; the server sends exactly one response carrying every such volume by name, size and age, or an error, and the scope finishes.'
order: 3
draft: false
---
...
- **Mounting.** Every volume in the listing may be mounted in any
  number of the client's running containers at once, whatever the
  `persist` of each mount. A [volumes::stat](/endpoints/volumes-stat/),
