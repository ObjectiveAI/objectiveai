---
title: 'volumes::list'
summary: 'Tag 3: a client asks which volumes are available to it; the server sends exactly one response carrying every such volume by name, size, age and whether a filetree covers it, or an error, and the scope finishes.'
order: 3
draft: false
---
