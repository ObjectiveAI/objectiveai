...
- **The request.** The tag byte `4` followed by the identity as JSON.
  [Request](/endpoints/containers-tools-run/server/fetch-file/request/) states its form.
- **The response.** The bytes of the file in zero or more channel
  responses and the channel response finish.
  [Response](/endpoints/containers-tools-run/server/fetch-file/response/) states the
  sequence.
