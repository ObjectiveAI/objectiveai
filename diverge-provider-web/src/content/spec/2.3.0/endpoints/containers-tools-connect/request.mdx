...
```rust include=diverge-provider-sdk/src/endpoints/containers/tools/connect/client/request/frame.rs
```

and by `diverge-provider-sdk/src/shared/containers/request/connect.rs`:

```rust include=diverge-provider-sdk/src/shared/containers/request/connect.rs
```
