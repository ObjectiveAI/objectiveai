...
|------|-----------------|-----------------|
| `0` | [authorization](/frames/authorization/) | [authorization](/frames/authorization/) |
...
The requirements governing their use are
[Authorization](/frames/authorization/), [Scopes](/frames/scopes/),
and [Channels](/frames/channels/).
