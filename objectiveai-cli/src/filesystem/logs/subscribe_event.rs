//! `SubscribeEvent` â€” NDJSON line type written by cli-stream's
...
//! handshake â€” not a stable wire type. It lives in the SDK so both
...
///   `messages` for that agent. `message_kind` is informational â€”
