...
pub struct Favorite {
    ...
    #[serde(flatten)]
    #[schemars(
        schema_with = "objectiveai_sdk::flatten_schema::<objectiveai_sdk::RemotePathCommitOptional>"
    )]
    pub path: objectiveai_sdk::RemotePathCommitOptional,
    note: String,
}
...
impl Favorite {
    ...
    pub fn path(&self) -> &objectiveai_sdk::RemotePathCommitOptional {
        &self.path
    }
}
...
pub struct PairFavorite {
    name: String,
    pub function: objectiveai_sdk::RemotePathCommitOptional,
    pub profile: objectiveai_sdk::RemotePathCommitOptional,
    note: String,
}
...
impl PairFavorite {
    pub fn new(
        name: String,
        function: objectiveai_sdk::RemotePathCommitOptional,
        profile: objectiveai_sdk::RemotePathCommitOptional,
        note: String,
    ) -> Result<Self, super::super::Error> {
        validate_favorite_name(&name)?;
        validate_favorite_note(&note)?;
