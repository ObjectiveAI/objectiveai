    ...
    pub fn handle(self) -> Result<crate::Output, crate::error::Error> {
        match self {
            ...
            Commands::Agent { .. } => Ok(crate::Output::Schema(
                include_str!("../../../../../objectiveai-json-schema/agent.claude_code.Agent.json"),
            )),
            Commands::AgentBase { .. } => Ok(crate::Output::Schema(
                include_str!("../../../../../objectiveai-json-schema/agent.claude_code.AgentBase.json"),
            )),
            Commands::Continuation { .. } => Ok(crate::Output::Schema(
                include_str!("../../../../../objectiveai-json-schema/agent.claude_code.Continuation.json"),
            )),
            Commands::Effort { .. } => Ok(crate::Output::Schema(
                include_str!("../../../../../objectiveai-json-schema/agent.claude_code.Effort.json"),
            )),
            Commands::OutputMode { .. } => Ok(crate::Output::Schema(
                include_str!("../../../../../objectiveai-json-schema/agent.claude_code.OutputMode.json"),
            )),
            Commands::Upstream { .. } => Ok(crate::Output::Schema(
                include_str!("../../../../../objectiveai-json-schema/agent.claude_code.Upstream.json"),
            )),
        }
    }
}
