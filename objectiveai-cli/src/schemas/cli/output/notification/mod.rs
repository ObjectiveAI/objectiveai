...
impl Commands {
    pub async fn handle(self, handle: &objectiveai_sdk::cli::output::Handle) -> Result<(), crate::error::Error> {
        match self {
            Commands::List => {
                const NAMES: &[&str] = &["agents", "api", "functions", "laboratories", "swarms", "Cleared", "CommandComplete", "Help", "Installed", "Instructions", "JqResults", "ListItem", "LogStreamReady", "Mcp", "Me", "Notification", "NotificationValue", "Ok", "PairListItem", "Plugin", "Plugins", "Published", "Schema", "Schemas", "SkipReason", "Tool", "ToolLine", "Tools", "TypedNotificationValue", "Updater", "ViewerSendResult"];
            ...
            Commands::CommandComplete { .. } => {
                let schema: serde_json::Value = serde_json::from_str(
                    include_str!("../../../../../../objectiveai-json-schema/cli.output.notification.CommandComplete.json"),
                ).expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
                        value: objectiveai_sdk::cli::output::Schema { schema }.into(),
            ...
            Commands::Mcp { .. } => {
                let schema: serde_json::Value = serde_json::from_str(
                    include_str!("../../../../../../objectiveai-json-schema/cli.output.notification.Mcp.json"),
                ).expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
                        value: objectiveai_sdk::cli::output::Schema { schema }.into(),
            ...
            Commands::Me { .. } => {
                let schema: serde_json::Value = serde_json::from_str(
                    include_str!("../../../../../../objectiveai-json-schema/cli.output.notification.Me.json"),
                ).expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
                        value: objectiveai_sdk::cli::output::Schema { schema }.into(),
            ...
            Commands::TypedNotificationValue { .. } => {
                let schema: serde_json::Value = serde_json::from_str(
                    include_str!("../../../../../../objectiveai-json-schema/cli.output.notification.TypedNotificationValue.json"),
                ).expect("embedded JSON Schema must parse");
                objectiveai_sdk::cli::output::Output::Notification(
                    objectiveai_sdk::cli::output::Notification {
                        value: objectiveai_sdk::cli::output::Schema { schema }.into(),
