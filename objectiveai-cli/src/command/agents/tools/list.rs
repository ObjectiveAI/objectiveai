//! `agents tools list` — connect to the agent's per-`response_id` MCP
...
use objectiveai_sdk::cli::command::agents::tools::list::{Request, Response};
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::agents::tools::list as sdk;
    use objectiveai_sdk::cli::command::agents::tools::list::request_schema::{
        Request, Response,
    };
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::agents::tools::list as sdk;
    use objectiveai_sdk::cli::command::agents::tools::list::response_schema::{
        Request, Response,
    };
