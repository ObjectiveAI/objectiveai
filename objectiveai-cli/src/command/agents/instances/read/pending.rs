...
use objectiveai_sdk::cli::command::agents::instances::read::pending::{Request, ResponseItem, Target};
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::agents::instances::read::pending as sdk;
    use objectiveai_sdk::cli::command::agents::instances::read::pending::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::agents::instances::read::pending as sdk;
    use objectiveai_sdk::cli::command::agents::instances::read::pending::response_schema::{Request, Response};
