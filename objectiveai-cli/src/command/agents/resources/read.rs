//! `agents resources read` — connect to the agent's per-`response_id`
...
use objectiveai_sdk::cli::command::agents::resources::read::{Request, Response};
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::agents::resources::read as sdk;
    use objectiveai_sdk::cli::command::agents::resources::read::request_schema::{
        Request, Response,
    };
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::agents::resources::read as sdk;
    use objectiveai_sdk::cli::command::agents::resources::read::response_schema::{
        Request, Response,
    };
