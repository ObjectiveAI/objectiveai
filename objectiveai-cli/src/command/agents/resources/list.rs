//! `agents resources list` — connect to the agent's per-`response_id`
...
use objectiveai_sdk::cli::command::agents::resources::list::{Request, Response};
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::agents::resources::list as sdk;
    use objectiveai_sdk::cli::command::agents::resources::list::request_schema::{
        Request, Response,
    };
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::agents::resources::list as sdk;
    use objectiveai_sdk::cli::command::agents::resources::list::response_schema::{
        Request, Response,
    };
