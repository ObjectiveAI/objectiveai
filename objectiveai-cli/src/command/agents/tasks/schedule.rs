...
pub mod request_schema {
    use objectiveai_sdk::cli::command::agents::tasks::schedule as sdk;
    use objectiveai_sdk::cli::command::agents::tasks::schedule::request_schema::{
        Request, Response,
    };
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::agents::tasks::schedule as sdk;
    use objectiveai_sdk::cli::command::agents::tasks::schedule::response_schema::{
        Request, Response,
    };
