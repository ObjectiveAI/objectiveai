...
pub mod request_schema {
    use objectiveai_sdk::cli::command::functions::inventions::recursive::create::alpha_scalar as sdk;
    use objectiveai_sdk::cli::command::functions::inventions::recursive::create::alpha_scalar::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::functions::inventions::recursive::create::alpha_scalar as sdk;
    use objectiveai_sdk::cli::command::functions::inventions::recursive::create::alpha_scalar::response_schema::{Request, Response};
