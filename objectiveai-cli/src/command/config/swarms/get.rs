...
pub mod request_schema {
    use objectiveai_sdk::cli::command::config::swarms::get as sdk;
    use objectiveai_sdk::cli::command::config::swarms::get::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::config::swarms::get as sdk;
    use objectiveai_sdk::cli::command::config::swarms::get::response_schema::{Request, Response};
