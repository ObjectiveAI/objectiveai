//! `config functions favorites edit` — mutate a named entry in the
//! function favorites list. Supports updating the note and the
//! commit-on-path (set or remove); drop and re-add to change
//! remote/owner/repo.

use objectiveai_sdk::RemotePathCommitOptional;
use objectiveai_sdk::cli::command::config::functions::favorites::edit::{
...
pub async fn execute(ctx: &Context, request: Request) -> Result<Response, Error> {
    ...
    let favorite = config.functions().edit_favorite(&request.name)?;
...
pub mod request_schema {
    use objectiveai_sdk::cli::command::config::functions::favorites::edit as sdk;
    use objectiveai_sdk::cli::command::config::functions::favorites::edit::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::config::functions::favorites::edit as sdk;
    use objectiveai_sdk::cli::command::config::functions::favorites::edit::response_schema::{Request, Response};
