...
pub async fn execute(ctx: &Context, _request: Request) -> Result<Response, Error> {
    ...
    let futures: Vec<ClearFuture<'_>> = vec![
        ...
        Box::pin(fs.clear_agent_completion_messages_assistant()),
        Box::pin(fs.clear_agent_completion_messages_tool()),
        Box::pin(fs.clear_agent_completion_message_assistant_logprobs()),
        Box::pin(fs.clear_agent_completion_message_assistant_reasoning()),
        Box::pin(fs.clear_agent_completion_message_assistant_refusal()),
        Box::pin(fs.clear_agent_completion_message_assistant_tool_calls()),
        Box::pin(fs.clear_agent_completion_message_assistant_images()),
        Box::pin(fs.clear_agent_completion_message_assistant_audio()),
        Box::pin(fs.clear_agent_completion_message_assistant_video()),
        Box::pin(fs.clear_agent_completion_message_assistant_files()),
