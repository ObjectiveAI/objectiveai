//! `logs agents completions request notifications text` sub-tier.

use std::pin::Pin;

use futures::Stream;
use objectiveai_sdk::cli::command::logs::agents::completions::request::notifications::text::{Request, Response};
