//! `logs agents completions request notifications` sub-tier — media multiplexer.

use std::pin::Pin;

use futures::{Stream, StreamExt};
use objectiveai_sdk::cli::command::logs::agents::completions::request::notifications::{Request, Response};
