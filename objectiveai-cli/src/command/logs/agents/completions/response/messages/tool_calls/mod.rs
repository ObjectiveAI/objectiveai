//! `logs agents completions response messages tool_calls` sub-tier.

use std::pin::Pin;

use futures::Stream;
use objectiveai_sdk::cli::command::logs::agents::completions::response::messages::tool_calls::{Request, Response};
