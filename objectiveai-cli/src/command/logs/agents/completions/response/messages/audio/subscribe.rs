...
pub mod request_schema {
    use objectiveai_sdk::cli::command::logs::agents::completions::response::messages::audio::subscribe as sdk;
    use objectiveai_sdk::cli::command::logs::agents::completions::response::messages::audio::subscribe::request_schema::{Request, Response};
...
pub mod response_schema {
    use objectiveai_sdk::cli::command::logs::agents::completions::response::messages::audio::subscribe as sdk;
    use objectiveai_sdk::cli::command::logs::agents::completions::response::messages::audio::subscribe::response_schema::{Request, Response};
