//! `logs agents completions response messages assistant text` sub-tier.

use std::pin::Pin;

use futures::Stream;
use objectiveai_sdk::cli::command::logs::agents::completions::response::messages::assistant::text::{Request, Response};
