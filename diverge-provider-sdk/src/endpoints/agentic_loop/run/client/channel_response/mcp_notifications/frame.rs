//! What a client's response frame carries on a notification channel.
...
///
/// # Many frames, unlike its four siblings
///
/// The other channels on this endpoint answer once and finish. This one
/// carries a frame per notification for as long as the channel lives,
/// because that is what it is: not an answer, but the stream a server
...
/// its four siblings give: what is being relayed is an MCP server's
...
///
/// Alone among this endpoint's frames, because
