...
/// it sits in says ([`file_mounts`](super::Frame::file_mounts) or
/// [`directory_mounts`](super::Frame::directory_mounts)), and the
...
pub struct Mount {
    ...
    /// crate takes, as
    /// [`container_path`](crate::shared::container::request::Mount::container_path)
    /// does for a laboratory's mounts.
    ///
