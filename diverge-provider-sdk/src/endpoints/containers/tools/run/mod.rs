//! Running a tool container from an image.
//!
...
//! the container's id on channel `0`, and then nothing more there for
//! as long as the container runs. Holding the scope open is what keeps
//! the container; the id is what names it to anything outside, and it
//! is minted in that stream and nowhere else.
//!
...
//! container. Same scope, opposite directions, and neither side's
//! channel numbers mean anything to the other.
