//! What a client's response frame carries on a fuse remove channel.

/// Ok, or an error. See [`fuse::remove::response::Frame`](crate::shared::containers::fuse::remove::response::Frame).
///
