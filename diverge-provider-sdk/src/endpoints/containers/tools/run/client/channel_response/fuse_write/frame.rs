//! What a client's response frame carries on a fuse write channel.

/// Ok, or an error. See [`fuse::write::response::Frame`](crate::shared::containers::fuse::write::response::Frame).
///
