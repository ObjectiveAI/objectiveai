...
/// [`Written`](Self::Written), `1` for [`Error`](Self::Error) — and the rest
...
/// [`write_path::response::Frame`](crate::shared::container::write_path::response::Frame),
...
/// endpoint's needs imposed on every endpoint that ever writes a file.
...
impl fmt::Display for FrameError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            FrameError::Empty => {
                f.write_str("write response frame is empty")
            }
