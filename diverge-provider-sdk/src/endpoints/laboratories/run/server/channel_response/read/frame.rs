...
/// specified here.
///
/// # The failure is this endpoint's, the bytes is not
///
/// [`Body`](Self::Body) carries
/// [`read::response::Frame`](crate::shared::container::read::response::Frame),
...
/// endpoint's needs imposed on every endpoint that ever reads a file.
...
impl fmt::Display for FrameError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            FrameError::Empty => {
                f.write_str("read response frame is empty")
            }
