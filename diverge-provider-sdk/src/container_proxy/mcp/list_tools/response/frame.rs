//! Frames the server sends on `/mcp/list-tools`.
...
pub enum Frame {
    ...
    ChannelResponse {
        ...
        channel: u8,
        /// The tools, one page of them, or the server's error.
        response: mcp::list_tools::response::Frame,
    },
...
impl Frame {
    ...
    pub fn decode(bytes: &[u8]) -> Result<Self, FrameError> {
        ...
        match r#type {
            0 => mcp::list_tools::response::Frame::decode(payload)
