//! Frames the server sends on `/mcp/list-resources`.
...
/// [`mcp::list_resources::response::Frame`].
...
pub enum Frame {
    ...
    ChannelResponse {
        ...
        channel: u8,
        /// The resources, one page of them, or the server's error.
        response: mcp::list_resources::response::Frame,
    },
...
impl Frame {
    ...
    pub fn decode(bytes: &[u8]) -> Result<Self, FrameError> {
        ...
        match r#type {
            0 => mcp::list_resources::response::Frame::decode(payload)
