...
/// write to fail wrap this in an enum of their own —
/// [`laboratories::run`](crate::endpoints::laboratories::run::server::channel_response::write_path::Frame)
/// and
/// [`laboratories::connect`](crate::endpoints::laboratories::connect::server::channel_response::write_path::Frame)
/// both do — and that enum's tag does the discriminating. A byte here
