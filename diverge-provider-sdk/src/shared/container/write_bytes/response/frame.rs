...
/// [`laboratories::run`](crate::endpoints::laboratories::run::client::channel_response::write_bytes::Frame)
/// and
/// [`laboratories::connect`](crate::endpoints::laboratories::connect::client::channel_response::write_bytes::Frame)
/// both do.
///
