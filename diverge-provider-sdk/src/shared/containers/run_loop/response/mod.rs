//! What comes back on an agentic loop channel.
//!
//! [`Frame`] is what carries it; everything else here is what goes
//! inside. A response is a **stream** of [`AgenticLoopChunk`]s. Each
//! chunk is one event — content, reasoning, a tool call, a refusal, a
//! tool result, usage, or a notification — rather than a partially-
//! filled record of everything that could have happened.
//!
