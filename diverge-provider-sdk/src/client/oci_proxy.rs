...
pub enum Body {
    ...
    ///
    /// The type is written out rather than aliased, here and in the
    /// other proxies that return one. What an alias would buy is forty
    /// characters; what it would cost is hiding exactly those bounds
    /// from the signature a reader is checking theirs against.
