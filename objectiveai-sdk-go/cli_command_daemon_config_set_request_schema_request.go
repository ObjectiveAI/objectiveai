...
type CliCommandDaemonConfigSetRequestSchemaRequest struct {
	...
	PathType CliCommandDaemonConfigSetRequestSchemaPath `json:"path_type"`
...
func (CliCommandDaemonConfigSetRequestSchemaRequest) SchemaTitle() string { return "cli.command.daemon.config.set.request_schema.Request" }
func (v CliCommandDaemonConfigSetRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonConfigSetRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonConfigSetRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonConfigSetRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonConfigSetRequestSchemaRequest(alias)
	return nil
}
