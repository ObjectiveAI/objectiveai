...
type CliCommandLaboratoriesConfigLocalGetRequest struct {
	...
	PathType CliCommandLaboratoriesConfigLocalGetPath `json:"path_type"`
...
func (CliCommandLaboratoriesConfigLocalGetRequest) SchemaTitle() string { return "cli.command.laboratories.config.local.get.Request" }
func (v CliCommandLaboratoriesConfigLocalGetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandLaboratoriesConfigLocalGetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type", "scope"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandLaboratoriesConfigLocalGetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandLaboratoriesConfigLocalGetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandLaboratoriesConfigLocalGetRequest(alias)
	return nil
}
