...
type CliCommandDaemonConfigSignatureGetRequest struct {
	...
	PathType CliCommandDaemonConfigSignatureGetPath `json:"path_type"`
...
func (CliCommandDaemonConfigSignatureGetRequest) SchemaTitle() string { return "cli.command.daemon.config.signature.get.Request" }
func (v CliCommandDaemonConfigSignatureGetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonConfigSignatureGetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonConfigSignatureGetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonConfigSignatureGetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonConfigSignatureGetRequest(alias)
	return nil
}
