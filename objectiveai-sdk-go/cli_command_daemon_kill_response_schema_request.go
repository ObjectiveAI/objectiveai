...
type CliCommandDaemonKillResponseSchemaRequest struct {
	...
	PathType CliCommandDaemonKillResponseSchemaPath `json:"path_type"`
...
func (CliCommandDaemonKillResponseSchemaRequest) SchemaTitle() string { return "cli.command.daemon.kill.response_schema.Request" }
func (v CliCommandDaemonKillResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonKillResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonKillResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonKillResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonKillResponseSchemaRequest(alias)
	return nil
}
