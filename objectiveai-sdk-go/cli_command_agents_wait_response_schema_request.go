...
type CliCommandAgentsWaitResponseSchemaRequest struct {
	...
	PathType CliCommandAgentsWaitResponseSchemaPath `json:"path_type"`
...
func (CliCommandAgentsWaitResponseSchemaRequest) SchemaTitle() string { return "cli.command.agents.wait.response_schema.Request" }
func (v CliCommandAgentsWaitResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsWaitResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsWaitResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsWaitResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsWaitResponseSchemaRequest(alias)
	return nil
}
