...
type CliCommandMcpConfigGetRequestSchemaRequest struct {
	...
	PathType CliCommandMcpConfigGetRequestSchemaPath `json:"path_type"`
...
func (CliCommandMcpConfigGetRequestSchemaRequest) SchemaTitle() string { return "cli.command.mcp.config.get.request_schema.Request" }
func (v CliCommandMcpConfigGetRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandMcpConfigGetRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandMcpConfigGetRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandMcpConfigGetRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandMcpConfigGetRequestSchemaRequest(alias)
	return nil
}
