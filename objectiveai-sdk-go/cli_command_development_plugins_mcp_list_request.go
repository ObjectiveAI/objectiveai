...
type CliCommandDevelopmentPluginsMcpListRequest struct {
	...
	PathType CliCommandDevelopmentPluginsMcpListPath `json:"path_type"`
...
func (CliCommandDevelopmentPluginsMcpListRequest) SchemaTitle() string { return "cli.command.development.plugins.mcp.list.Request" }
func (v CliCommandDevelopmentPluginsMcpListRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDevelopmentPluginsMcpListRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDevelopmentPluginsMcpListRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDevelopmentPluginsMcpListRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDevelopmentPluginsMcpListRequest(alias)
	return nil
}
