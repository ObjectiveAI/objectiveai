...
type CliCommandAgentsLogsOpenRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsLogsOpenRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsLogsOpenRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.logs.open.request_schema.Request" }
func (v CliCommandAgentsLogsOpenRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsLogsOpenRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsLogsOpenRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsLogsOpenRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsLogsOpenRequestSchemaRequest(alias)
	return nil
}
