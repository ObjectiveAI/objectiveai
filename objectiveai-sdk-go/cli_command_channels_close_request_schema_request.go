...
type CliCommandChannelsCloseRequestSchemaRequest struct {
	...
	PathType CliCommandChannelsCloseRequestSchemaPath `json:"path_type"`
...
func (CliCommandChannelsCloseRequestSchemaRequest) SchemaTitle() string { return "cli.command.channels.close.request_schema.Request" }
func (v CliCommandChannelsCloseRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandChannelsCloseRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandChannelsCloseRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandChannelsCloseRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandChannelsCloseRequestSchemaRequest(alias)
	return nil
}
