...
type CliCommandDevelopmentPluginsViewerDeleteRequest struct {
	...
	PathType CliCommandDevelopmentPluginsViewerDeletePath `json:"path_type"`
...
func (CliCommandDevelopmentPluginsViewerDeleteRequest) SchemaTitle() string { return "cli.command.development.plugins.viewer.delete.Request" }
func (v CliCommandDevelopmentPluginsViewerDeleteRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDevelopmentPluginsViewerDeleteRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"name", "owner", "path_type", "version"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDevelopmentPluginsViewerDeleteRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDevelopmentPluginsViewerDeleteRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDevelopmentPluginsViewerDeleteRequest(alias)
	return nil
}
