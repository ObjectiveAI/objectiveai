...
type CliCommandLaboratoriesConfigAddressesGetRequest struct {
	...
	PathType CliCommandLaboratoriesConfigAddressesGetPath `json:"path_type"`
...
func (CliCommandLaboratoriesConfigAddressesGetRequest) SchemaTitle() string { return "cli.command.laboratories.config.addresses.get.Request" }
func (v CliCommandLaboratoriesConfigAddressesGetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandLaboratoriesConfigAddressesGetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type", "scope"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandLaboratoriesConfigAddressesGetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandLaboratoriesConfigAddressesGetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandLaboratoriesConfigAddressesGetRequest(alias)
	return nil
}
