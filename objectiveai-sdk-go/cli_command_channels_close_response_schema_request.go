...
type CliCommandChannelsCloseResponseSchemaRequest struct {
	...
	PathType CliCommandChannelsCloseResponseSchemaPath `json:"path_type"`
...
func (CliCommandChannelsCloseResponseSchemaRequest) SchemaTitle() string { return "cli.command.channels.close.response_schema.Request" }
func (v CliCommandChannelsCloseResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandChannelsCloseResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandChannelsCloseResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandChannelsCloseResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandChannelsCloseResponseSchemaRequest(alias)
	return nil
}
