...
type CliCommandTasksDeleteRequestSchemaRequest struct {
	...
	PathType CliCommandTasksDeleteRequestSchemaPath `json:"path_type"`
...
func (CliCommandTasksDeleteRequestSchemaRequest) SchemaTitle() string { return "cli.command.tasks.delete.request_schema.Request" }
func (v CliCommandTasksDeleteRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandTasksDeleteRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandTasksDeleteRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandTasksDeleteRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandTasksDeleteRequestSchemaRequest(alias)
	return nil
}
