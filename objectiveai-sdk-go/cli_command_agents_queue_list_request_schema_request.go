...
type CliCommandAgentsQueueListRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsQueueListRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsQueueListRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.queue.list.request_schema.Request" }
func (v CliCommandAgentsQueueListRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsQueueListRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsQueueListRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsQueueListRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsQueueListRequestSchemaRequest(alias)
	return nil
}
