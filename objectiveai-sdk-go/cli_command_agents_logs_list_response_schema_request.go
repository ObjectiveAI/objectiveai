...
type CliCommandAgentsLogsListResponseSchemaRequest struct {
	...
	PathType CliCommandAgentsLogsListResponseSchemaPath `json:"path_type"`
...
func (CliCommandAgentsLogsListResponseSchemaRequest) SchemaTitle() string { return "cli.command.agents.logs.list.response_schema.Request" }
func (v CliCommandAgentsLogsListResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsLogsListResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsLogsListResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsLogsListResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsLogsListResponseSchemaRequest(alias)
	return nil
}
