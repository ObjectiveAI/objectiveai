...
type CliCommandSwarmsListResponseSchemaRequest struct {
	...
	PathType CliCommandSwarmsListResponseSchemaPath `json:"path_type"`
...
func (CliCommandSwarmsListResponseSchemaRequest) SchemaTitle() string { return "cli.command.swarms.list.response_schema.Request" }
func (v CliCommandSwarmsListResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandSwarmsListResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandSwarmsListResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandSwarmsListResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandSwarmsListResponseSchemaRequest(alias)
	return nil
}
