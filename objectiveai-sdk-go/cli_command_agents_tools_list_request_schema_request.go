...
type CliCommandAgentsToolsListRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsToolsListRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsToolsListRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.tools.list.request_schema.Request" }
func (v CliCommandAgentsToolsListRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsToolsListRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsToolsListRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsToolsListRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsToolsListRequestSchemaRequest(alias)
	return nil
}
