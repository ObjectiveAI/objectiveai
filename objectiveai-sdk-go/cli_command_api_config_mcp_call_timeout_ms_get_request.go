...
type CliCommandApiConfigMcpCallTimeoutMsGetRequest struct {
	...
	PathType CliCommandApiConfigMcpCallTimeoutMsGetPath `json:"path_type"`
...
func (CliCommandApiConfigMcpCallTimeoutMsGetRequest) SchemaTitle() string { return "cli.command.api.config.mcp_call_timeout_ms.get.Request" }
func (v CliCommandApiConfigMcpCallTimeoutMsGetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandApiConfigMcpCallTimeoutMsGetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandApiConfigMcpCallTimeoutMsGetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandApiConfigMcpCallTimeoutMsGetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandApiConfigMcpCallTimeoutMsGetRequest(alias)
	return nil
}
