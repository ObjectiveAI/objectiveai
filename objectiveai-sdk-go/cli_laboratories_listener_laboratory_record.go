...
type CliLaboratoriesListenerLaboratoryRecord struct {
	...
	Attachments []CliLaboratoriesListenerLaboratoryAttachment `json:"attachments" default:"[]"`
...
func (CliLaboratoriesListenerLaboratoryRecord) SchemaTitle() string { return "cli.laboratories_listener.LaboratoryRecord" }
func (v CliLaboratoriesListenerLaboratoryRecord) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliLaboratoriesListenerLaboratoryRecord) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"attachments", "connected", "env", "id", "mounts"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliLaboratoriesListenerLaboratoryRecord: missing required field %q", key)
		}
	}
	type Alias CliLaboratoriesListenerLaboratoryRecord
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliLaboratoriesListenerLaboratoryRecord(alias)
	return nil
}
