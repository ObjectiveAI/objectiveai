...
type CliCommandPluginsLogsListRequestSchemaRequest struct {
	...
	PathType CliCommandPluginsLogsListRequestSchemaPath `json:"path_type"`
...
func (CliCommandPluginsLogsListRequestSchemaRequest) SchemaTitle() string { return "cli.command.plugins.logs.list.request_schema.Request" }
func (v CliCommandPluginsLogsListRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandPluginsLogsListRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandPluginsLogsListRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandPluginsLogsListRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandPluginsLogsListRequestSchemaRequest(alias)
	return nil
}
