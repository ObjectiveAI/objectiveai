...
type CliCommandDaemonSpawnResponseSchemaRequest struct {
	...
	PathType CliCommandDaemonSpawnResponseSchemaPath `json:"path_type"`
...
func (CliCommandDaemonSpawnResponseSchemaRequest) SchemaTitle() string { return "cli.command.daemon.spawn.response_schema.Request" }
func (v CliCommandDaemonSpawnResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonSpawnResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonSpawnResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonSpawnResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonSpawnResponseSchemaRequest(alias)
	return nil
}
