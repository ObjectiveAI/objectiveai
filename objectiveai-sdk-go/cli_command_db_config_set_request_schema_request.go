...
type CliCommandDbConfigSetRequestSchemaRequest struct {
	...
	PathType CliCommandDbConfigSetRequestSchemaPath `json:"path_type"`
...
func (CliCommandDbConfigSetRequestSchemaRequest) SchemaTitle() string { return "cli.command.db.config.set.request_schema.Request" }
func (v CliCommandDbConfigSetRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDbConfigSetRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDbConfigSetRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDbConfigSetRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDbConfigSetRequestSchemaRequest(alias)
	return nil
}
