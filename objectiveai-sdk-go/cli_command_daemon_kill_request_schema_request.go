...
type CliCommandDaemonKillRequestSchemaRequest struct {
	...
	PathType CliCommandDaemonKillRequestSchemaPath `json:"path_type"`
...
func (CliCommandDaemonKillRequestSchemaRequest) SchemaTitle() string { return "cli.command.daemon.kill.request_schema.Request" }
func (v CliCommandDaemonKillRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonKillRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonKillRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonKillRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonKillRequestSchemaRequest(alias)
	return nil
}
