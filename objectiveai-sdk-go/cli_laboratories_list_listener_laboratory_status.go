...
// the only provenance.
type CliLaboratoriesListListenerLaboratoryStatus struct {
...
func (v CliLaboratoriesListListenerLaboratoryStatus) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliLaboratoriesListListenerLaboratoryStatus) UnmarshalJSON(data []byte) error {
	...
	type Alias CliLaboratoriesListListenerLaboratoryStatus
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliLaboratoriesListListenerLaboratoryStatus(alias)
	return nil
}
