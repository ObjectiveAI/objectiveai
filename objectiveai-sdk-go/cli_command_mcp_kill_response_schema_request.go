...
type CliCommandMcpKillResponseSchemaRequest struct {
	...
	PathType CliCommandMcpKillResponseSchemaPath `json:"path_type"`
...
func (CliCommandMcpKillResponseSchemaRequest) SchemaTitle() string { return "cli.command.mcp.kill.response_schema.Request" }
func (v CliCommandMcpKillResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandMcpKillResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandMcpKillResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandMcpKillResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandMcpKillResponseSchemaRequest(alias)
	return nil
}
