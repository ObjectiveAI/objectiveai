...
func (AgentScriptAgent) SchemaTitle() string { return "agent.script.Agent" }
func (v AgentScriptAgent) Validate() error {
	return variantValidator.Struct(v)
}

func (v *AgentScriptAgent) UnmarshalJSON(data []byte) error {
...
func (v AgentScriptAgent) MarshalJSON() ([]byte, error) {
