...
type CliCommandKillAllResponseSchemaRequest struct {
	...
	PathType CliCommandKillAllResponseSchemaPath `json:"path_type"`
...
func (CliCommandKillAllResponseSchemaRequest) SchemaTitle() string { return "cli.command.kill_all.response_schema.Request" }
func (v CliCommandKillAllResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandKillAllResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandKillAllResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandKillAllResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandKillAllResponseSchemaRequest(alias)
	return nil
}
