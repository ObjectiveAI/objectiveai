...
type CliCommandDaemonConfigSecretGetRequest struct {
	...
	PathType CliCommandDaemonConfigSecretGetPath `json:"path_type"`
...
func (CliCommandDaemonConfigSecretGetRequest) SchemaTitle() string { return "cli.command.daemon.config.secret.get.Request" }
func (v CliCommandDaemonConfigSecretGetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonConfigSecretGetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonConfigSecretGetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonConfigSecretGetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonConfigSecretGetRequest(alias)
	return nil
}
