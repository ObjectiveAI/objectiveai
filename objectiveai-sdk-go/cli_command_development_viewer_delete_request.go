...
type CliCommandDevelopmentViewerDeleteRequest struct {
	...
	PathType CliCommandDevelopmentViewerDeletePath `json:"path_type"`
...
func (CliCommandDevelopmentViewerDeleteRequest) SchemaTitle() string { return "cli.command.development.viewer.delete.Request" }
func (v CliCommandDevelopmentViewerDeleteRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDevelopmentViewerDeleteRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDevelopmentViewerDeleteRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDevelopmentViewerDeleteRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDevelopmentViewerDeleteRequest(alias)
	return nil
}
