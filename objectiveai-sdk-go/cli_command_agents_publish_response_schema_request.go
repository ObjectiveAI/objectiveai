...
type CliCommandAgentsPublishResponseSchemaRequest struct {
	...
	PathType CliCommandAgentsPublishResponseSchemaPath `json:"path_type"`
...
func (CliCommandAgentsPublishResponseSchemaRequest) SchemaTitle() string { return "cli.command.agents.publish.response_schema.Request" }
func (v CliCommandAgentsPublishResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsPublishResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsPublishResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsPublishResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsPublishResponseSchemaRequest(alias)
	return nil
}
