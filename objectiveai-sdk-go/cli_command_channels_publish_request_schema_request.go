...
type CliCommandChannelsPublishRequestSchemaRequest struct {
	...
	PathType CliCommandChannelsPublishRequestSchemaPath `json:"path_type"`
...
func (CliCommandChannelsPublishRequestSchemaRequest) SchemaTitle() string { return "cli.command.channels.publish.request_schema.Request" }
func (v CliCommandChannelsPublishRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandChannelsPublishRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandChannelsPublishRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandChannelsPublishRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandChannelsPublishRequestSchemaRequest(alias)
	return nil
}
