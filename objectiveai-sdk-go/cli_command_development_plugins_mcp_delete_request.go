...
type CliCommandDevelopmentPluginsMcpDeleteRequest struct {
	...
	PathType CliCommandDevelopmentPluginsMcpDeletePath `json:"path_type"`
...
func (CliCommandDevelopmentPluginsMcpDeleteRequest) SchemaTitle() string { return "cli.command.development.plugins.mcp.delete.Request" }
func (v CliCommandDevelopmentPluginsMcpDeleteRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDevelopmentPluginsMcpDeleteRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"name", "owner", "path_type", "version"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDevelopmentPluginsMcpDeleteRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDevelopmentPluginsMcpDeleteRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDevelopmentPluginsMcpDeleteRequest(alias)
	return nil
}
