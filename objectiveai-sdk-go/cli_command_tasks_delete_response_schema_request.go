...
type CliCommandTasksDeleteResponseSchemaRequest struct {
	...
	PathType CliCommandTasksDeleteResponseSchemaPath `json:"path_type"`
...
func (CliCommandTasksDeleteResponseSchemaRequest) SchemaTitle() string { return "cli.command.tasks.delete.response_schema.Request" }
func (v CliCommandTasksDeleteResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandTasksDeleteResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandTasksDeleteResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandTasksDeleteResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandTasksDeleteResponseSchemaRequest(alias)
	return nil
}
