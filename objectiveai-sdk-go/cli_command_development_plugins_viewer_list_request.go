...
type CliCommandDevelopmentPluginsViewerListRequest struct {
	...
	PathType CliCommandDevelopmentPluginsViewerListPath `json:"path_type"`
...
func (CliCommandDevelopmentPluginsViewerListRequest) SchemaTitle() string { return "cli.command.development.plugins.viewer.list.Request" }
func (v CliCommandDevelopmentPluginsViewerListRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDevelopmentPluginsViewerListRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDevelopmentPluginsViewerListRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDevelopmentPluginsViewerListRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDevelopmentPluginsViewerListRequest(alias)
	return nil
}
