...
type CliCommandPythonResponseSchemaRequest struct {
	...
	PathType CliCommandPythonResponseSchemaPath `json:"path_type"`
...
func (CliCommandPythonResponseSchemaRequest) SchemaTitle() string { return "cli.command.python.response_schema.Request" }
func (v CliCommandPythonResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandPythonResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandPythonResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandPythonResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandPythonResponseSchemaRequest(alias)
	return nil
}
