...
type CliCommandAgentsQueueOpenRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsQueueOpenRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsQueueOpenRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.queue.open.request_schema.Request" }
func (v CliCommandAgentsQueueOpenRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsQueueOpenRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsQueueOpenRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsQueueOpenRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsQueueOpenRequestSchemaRequest(alias)
	return nil
}
