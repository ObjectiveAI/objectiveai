...
type CliCommandApiConfigMcpBackoffSetRequest struct {
	...
	PathType CliCommandApiConfigMcpBackoffSetPath `json:"path_type"`
...
func (CliCommandApiConfigMcpBackoffSetRequest) SchemaTitle() string { return "cli.command.api.config.mcp_backoff.set.Request" }
func (v CliCommandApiConfigMcpBackoffSetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandApiConfigMcpBackoffSetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type", "scope", "value"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandApiConfigMcpBackoffSetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandApiConfigMcpBackoffSetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandApiConfigMcpBackoffSetRequest(alias)
	return nil
}
