...
type CliCommandDaemonConfigGetRequestSchemaRequest struct {
	...
	PathType CliCommandDaemonConfigGetRequestSchemaPath `json:"path_type"`
...
func (CliCommandDaemonConfigGetRequestSchemaRequest) SchemaTitle() string { return "cli.command.daemon.config.get.request_schema.Request" }
func (v CliCommandDaemonConfigGetRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonConfigGetRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonConfigGetRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonConfigGetRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonConfigGetRequestSchemaRequest(alias)
	return nil
}
