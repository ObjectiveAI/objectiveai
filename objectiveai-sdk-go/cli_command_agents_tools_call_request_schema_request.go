...
type CliCommandAgentsToolsCallRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsToolsCallRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsToolsCallRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.tools.call.request_schema.Request" }
func (v CliCommandAgentsToolsCallRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsToolsCallRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsToolsCallRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsToolsCallRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsToolsCallRequestSchemaRequest(alias)
	return nil
}
