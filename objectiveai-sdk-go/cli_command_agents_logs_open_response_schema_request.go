...
type CliCommandAgentsLogsOpenResponseSchemaRequest struct {
	...
	PathType CliCommandAgentsLogsOpenResponseSchemaPath `json:"path_type"`
...
func (CliCommandAgentsLogsOpenResponseSchemaRequest) SchemaTitle() string { return "cli.command.agents.logs.open.response_schema.Request" }
func (v CliCommandAgentsLogsOpenResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsLogsOpenResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsLogsOpenResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsLogsOpenResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsLogsOpenResponseSchemaRequest(alias)
	return nil
}
