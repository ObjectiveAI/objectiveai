...
type CliCommandSwarmsGetResponseSchemaRequest struct {
	...
	PathType CliCommandSwarmsGetResponseSchemaPath `json:"path_type"`
...
func (CliCommandSwarmsGetResponseSchemaRequest) SchemaTitle() string { return "cli.command.swarms.get.response_schema.Request" }
func (v CliCommandSwarmsGetResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandSwarmsGetResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandSwarmsGetResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandSwarmsGetResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandSwarmsGetResponseSchemaRequest(alias)
	return nil
}
