...
type CliCommandApiConfigMcpConnectTimeoutMsSetRequest struct {
	...
	PathType CliCommandApiConfigMcpConnectTimeoutMsSetPath `json:"path_type"`
...
func (CliCommandApiConfigMcpConnectTimeoutMsSetRequest) SchemaTitle() string { return "cli.command.api.config.mcp_connect_timeout_ms.set.Request" }
func (v CliCommandApiConfigMcpConnectTimeoutMsSetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandApiConfigMcpConnectTimeoutMsSetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type", "scope", "value"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandApiConfigMcpConnectTimeoutMsSetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandApiConfigMcpConnectTimeoutMsSetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandApiConfigMcpConnectTimeoutMsSetRequest(alias)
	return nil
}
