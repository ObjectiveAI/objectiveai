...
type CliCommandPythonRequestSchemaRequest struct {
	...
	PathType CliCommandPythonRequestSchemaPath `json:"path_type"`
...
func (CliCommandPythonRequestSchemaRequest) SchemaTitle() string { return "cli.command.python.request_schema.Request" }
func (v CliCommandPythonRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandPythonRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandPythonRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandPythonRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandPythonRequestSchemaRequest(alias)
	return nil
}
