...
type CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest struct {
...
func (CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest) SchemaTitle() string { return "cli.command.api.config.backoff_max_elapsed_time_ms.set.Request" }
func (v CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type", "scope", "value"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandApiConfigBackoffMaxElapsedTimeMsSetRequest(alias)
	return nil
}
