...
type CliCommandDbConfigSetResponseSchemaRequest struct {
	...
	PathType CliCommandDbConfigSetResponseSchemaPath `json:"path_type"`
...
func (CliCommandDbConfigSetResponseSchemaRequest) SchemaTitle() string { return "cli.command.db.config.set.response_schema.Request" }
func (v CliCommandDbConfigSetResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDbConfigSetResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDbConfigSetResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDbConfigSetResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDbConfigSetResponseSchemaRequest(alias)
	return nil
}
