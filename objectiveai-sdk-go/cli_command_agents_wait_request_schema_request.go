...
type CliCommandAgentsWaitRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsWaitRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsWaitRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.wait.request_schema.Request" }
func (v CliCommandAgentsWaitRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsWaitRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsWaitRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsWaitRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsWaitRequestSchemaRequest(alias)
	return nil
}
