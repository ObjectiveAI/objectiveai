...
type CliCommandAgentsMcpToolsCallRequest struct {
	...
	PathType CliCommandAgentsMcpToolsCallPath `json:"path_type"`
...
func (CliCommandAgentsMcpToolsCallRequest) SchemaTitle() string { return "cli.command.agents.mcp.tools.call.Request" }
func (v CliCommandAgentsMcpToolsCallRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsMcpToolsCallRequest) UnmarshalJSON(data []byte) error {
	...
	type Alias CliCommandAgentsMcpToolsCallRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsMcpToolsCallRequest(alias)
	return nil
}
