...
type CliCommandFunctionsListResponseSchemaRequest struct {
	...
	PathType CliCommandFunctionsListResponseSchemaPath `json:"path_type"`
...
func (CliCommandFunctionsListResponseSchemaRequest) SchemaTitle() string { return "cli.command.functions.list.response_schema.Request" }
func (v CliCommandFunctionsListResponseSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandFunctionsListResponseSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandFunctionsListResponseSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandFunctionsListResponseSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandFunctionsListResponseSchemaRequest(alias)
	return nil
}
