...
type CliCommandAgentsLogsListRequestSchemaRequest struct {
	...
	PathType CliCommandAgentsLogsListRequestSchemaPath `json:"path_type"`
...
func (CliCommandAgentsLogsListRequestSchemaRequest) SchemaTitle() string { return "cli.command.agents.logs.list.request_schema.Request" }
func (v CliCommandAgentsLogsListRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsLogsListRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsLogsListRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsLogsListRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsLogsListRequestSchemaRequest(alias)
	return nil
}
