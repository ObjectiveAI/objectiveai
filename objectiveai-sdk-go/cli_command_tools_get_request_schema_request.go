...
type CliCommandToolsGetRequestSchemaRequest struct {
	...
	PathType CliCommandToolsGetRequestSchemaPath `json:"path_type"`
...
func (CliCommandToolsGetRequestSchemaRequest) SchemaTitle() string { return "cli.command.tools.get.request_schema.Request" }
func (v CliCommandToolsGetRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandToolsGetRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandToolsGetRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandToolsGetRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandToolsGetRequestSchemaRequest(alias)
	return nil
}
