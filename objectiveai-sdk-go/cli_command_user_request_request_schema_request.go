...
type CliCommandUserRequestRequestSchemaRequest struct {
	...
	PathType CliCommandUserRequestRequestSchemaPath `json:"path_type"`
...
func (CliCommandUserRequestRequestSchemaRequest) SchemaTitle() string { return "cli.command.user.request.request_schema.Request" }
func (v CliCommandUserRequestRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandUserRequestRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandUserRequestRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandUserRequestRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandUserRequestRequestSchemaRequest(alias)
	return nil
}
