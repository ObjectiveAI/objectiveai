...
func (v *FunctionsInventionsRequestFunctionInventionCreateParams) UnmarshalJSON(data []byte) error {
	...
	type Alias FunctionsInventionsRequestFunctionInventionCreateParams
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = FunctionsInventionsRequestFunctionInventionCreateParams(alias)
	return nil
}
