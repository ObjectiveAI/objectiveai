...
type CliCommandRequestBase struct {
...
func (CliCommandRequestBase) SchemaTitle() string { return "cli.command.RequestBase" }
func (v CliCommandRequestBase) Validate() error {
