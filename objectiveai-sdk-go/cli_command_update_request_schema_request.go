...
type CliCommandUpdateRequestSchemaRequest struct {
	...
	PathType CliCommandUpdateRequestSchemaPath `json:"path_type"`
...
func (CliCommandUpdateRequestSchemaRequest) SchemaTitle() string { return "cli.command.update.request_schema.Request" }
func (v CliCommandUpdateRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandUpdateRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandUpdateRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandUpdateRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandUpdateRequestSchemaRequest(alias)
	return nil
}
