...
type CliCommandDaemonConfigAddressGetRequest struct {
	...
	PathType CliCommandDaemonConfigAddressGetPath `json:"path_type"`
...
func (CliCommandDaemonConfigAddressGetRequest) SchemaTitle() string { return "cli.command.daemon.config.address.get.Request" }
func (v CliCommandDaemonConfigAddressGetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonConfigAddressGetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonConfigAddressGetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonConfigAddressGetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonConfigAddressGetRequest(alias)
	return nil
}
