...
type CliCommandDaemonSpawnRequestSchemaRequest struct {
	...
	PathType CliCommandDaemonSpawnRequestSchemaPath `json:"path_type"`
...
func (CliCommandDaemonSpawnRequestSchemaRequest) SchemaTitle() string { return "cli.command.daemon.spawn.request_schema.Request" }
func (v CliCommandDaemonSpawnRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandDaemonSpawnRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandDaemonSpawnRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandDaemonSpawnRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandDaemonSpawnRequestSchemaRequest(alias)
	return nil
}
