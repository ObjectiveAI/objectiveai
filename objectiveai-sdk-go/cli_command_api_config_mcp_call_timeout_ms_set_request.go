...
type CliCommandApiConfigMcpCallTimeoutMsSetRequest struct {
	...
	PathType CliCommandApiConfigMcpCallTimeoutMsSetPath `json:"path_type"`
...
func (CliCommandApiConfigMcpCallTimeoutMsSetRequest) SchemaTitle() string { return "cli.command.api.config.mcp_call_timeout_ms.set.Request" }
func (v CliCommandApiConfigMcpCallTimeoutMsSetRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandApiConfigMcpCallTimeoutMsSetRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type", "scope", "value"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandApiConfigMcpCallTimeoutMsSetRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandApiConfigMcpCallTimeoutMsSetRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandApiConfigMcpCallTimeoutMsSetRequest(alias)
	return nil
}
