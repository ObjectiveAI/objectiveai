...
type CliCommandAgentsResourcesListRequest struct {
	...
	PathType CliCommandAgentsResourcesListPath `json:"path_type"`
...
func (CliCommandAgentsResourcesListRequest) SchemaTitle() string { return "cli.command.agents.resources.list.Request" }
func (v CliCommandAgentsResourcesListRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandAgentsResourcesListRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"params", "path_type", "response_id"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandAgentsResourcesListRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandAgentsResourcesListRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandAgentsResourcesListRequest(alias)
	return nil
}
