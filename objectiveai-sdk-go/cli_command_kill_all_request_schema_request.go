...
type CliCommandKillAllRequestSchemaRequest struct {
	...
	PathType CliCommandKillAllRequestSchemaPath `json:"path_type"`
...
func (CliCommandKillAllRequestSchemaRequest) SchemaTitle() string { return "cli.command.kill_all.request_schema.Request" }
func (v CliCommandKillAllRequestSchemaRequest) Validate() error {
	return variantValidator.Struct(v)
}

func (v *CliCommandKillAllRequestSchemaRequest) UnmarshalJSON(data []byte) error {
	...
	for _, key := range []string{"path_type"} {
		if _, ok := raw[key]; !ok {
			return fmt.Errorf("CliCommandKillAllRequestSchemaRequest: missing required field %q", key)
		}
	}
	type Alias CliCommandKillAllRequestSchemaRequest
	var alias Alias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*v = CliCommandKillAllRequestSchemaRequest(alias)
	return nil
}
