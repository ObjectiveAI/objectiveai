...
pub fn json_schemas() -> Vec<schemars::Schema> {
    let mut schemas = vec![
        ...
        schemars::schema_for!(crate::agent::claude_code::AgentBase),
        schemars::schema_for!(crate::agent::claude_code::Agent),
        schemars::schema_for!(crate::agent::claude_code::Effort),
        schemars::schema_for!(crate::agent::claude_code::OutputMode),
        schemars::schema_for!(crate::agent::claude_code::Upstream),
        ...
        schemars::schema_for!(crate::agent::claude_code::Continuation),
