...
/// One item the command produced, or the news that it will not produce another. See [`command::response::Frame`](crate::shared::containers::command::response::Frame).
///
...
pub type Frame<'a> = crate::shared::containers::command::response::Frame<'a>;
