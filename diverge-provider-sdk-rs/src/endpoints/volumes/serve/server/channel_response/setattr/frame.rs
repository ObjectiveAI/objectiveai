//! What a server's channel response frame carries on a setattr
//! channel of a serve.

/// Ok, read only, or why not. See [`fuse::setattr::response::Frame`](crate::shared::containers::fuse::setattr::response::Frame).
///
