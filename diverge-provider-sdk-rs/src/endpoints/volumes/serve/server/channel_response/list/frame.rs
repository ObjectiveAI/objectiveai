//! What a server's channel response frame carries on a list
//! channel of a serve.

/// The entries, that there is no such directory, or an error. See [`fuse::list::response::Frame`](crate::shared::containers::fuse::list::response::Frame).
///
