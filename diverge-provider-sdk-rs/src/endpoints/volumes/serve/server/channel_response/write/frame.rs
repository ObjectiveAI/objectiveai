//! What a server's channel response frame carries on a write
//! channel of a serve.

/// Ok, ephemeral, or why not. See [`fuse::write::response::Frame`](crate::shared::containers::fuse::write::response::Frame).
///
...
pub type Frame<'a> = crate::shared::containers::fuse::write::response::Frame<'a>;
