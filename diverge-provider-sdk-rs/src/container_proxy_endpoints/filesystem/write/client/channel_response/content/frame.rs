//! What a client's channel response frame carries on a content
//! channel.
...
/// abandoned: the proxy discards what it wrote, and answers the
...
pub enum Frame<'a> {
    ...
    /// A failure. Tag `1`.
    ///
    /// The server cannot supply the content it was asked for — the
    /// caller's source went away, the read it was piping stopped,
    /// whatever it knows. See
