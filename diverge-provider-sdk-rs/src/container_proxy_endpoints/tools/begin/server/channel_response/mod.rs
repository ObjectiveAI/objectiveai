...
//! connection. The five `mcp_*` are what the container's own MCP
//! server answered — the family's own, each an alias of the shape
//! [`shared::mcp`](crate::shared::mcp) defines.
