//! What a server's response frame carries on an enqueue channel.

/// The enqueued message's fate. See [`enqueue::response::Frame`](crate::shared::containers::enqueue::response::Frame).
///
...
pub type Frame = crate::shared::containers::enqueue::response::Frame;
