...
/// Begin the server's work on an agent container.
///
...
/// [`Error`](crate::container_proxy_endpoints::agents::begin::server::response::Frame::Error)
...
/// A agents begin request that could not be read.
///
