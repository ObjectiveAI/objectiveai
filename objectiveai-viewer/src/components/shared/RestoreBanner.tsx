  ...
  return (
    <div className={cn("flex", "items-center", "gap-3", "px-4", "py-2", "border-b", "border-copper-warm/30", "bg-copper-warm/5", "text-xs", "text-info-mid", "select-none")}>
      ...
      <div className={cn("ml-auto", "flex", "gap-2")}>
        <button
          onClick={onBrowse}
          className={cn("px-2", "py-0.5", "rounded-sm", "text-copper-bright", "hover:bg-copper-warm/20", "transition-colors")}
        >
          Browse sessions
        </button>
        <button
          onClick={onDismiss}
          className={cn("px-2", "py-0.5", "rounded-sm", "text-info-dim", "hover:text-info-mid", "hover:bg-ground-surface/50", "transition-colors")}
        >
          Dismiss
        </button>
      </div>
