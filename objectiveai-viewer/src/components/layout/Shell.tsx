...
export function Shell({ children, statusBar, banner, sidebar, detailPanel, entryCount }: { children: ReactNode; statusBar?: ReactNode; banner?: ReactNode; sidebar?: ReactNode; detailPanel?: ReactNode; entryCount?: number }) {
