...
export const mockEntries: Entry[] = [
  ...
  },
  {
    ...
    chunk: {
      ...
      inventions: [
        {
          index: 0,
          state: { type: "scalar", name: "quality-scorer" },
          path: { remote: "filesystem", owner: "objectiveai", repository: "functions" },
          completions: [{ id: "fi-c0", object: "agent.completion.chunk", created: now - 13, index: 0, model: "claude-opus-4-6", upstream: "anthropic", messages: [{ role: "assistant", model: "claude-opus-4-6", upstream: "anthropic", reasoning: "I need to invent a scalar scoring function for quality.", content: "```json\n{\"type\": \"scalar\", \"name\": \"quality-scorer\", \"tasks\": [{\"type\": \"vector.completion\"}]}\n```", finish_reason: "stop" }], error: null }],
          error: null,
        },
        {
          index: 1,
          state: { type: "vector", name: "style-ranker" },
          path: { remote: "filesystem", owner: "objectiveai", repository: "functions" },
          completions: [],
          error: { code: 500, message: "Circular dependency detected in function graph at depth 4" },
        },
      ],
    } as any,
    error: null,
  ...
  },
  {
    ...
    request: { id: "lab-001" } as any,
    chunk: {
      id: "lab-001",
      object: "laboratory.execution.chunk",
      created: now - 10,
      dataset_size: 50,
      completed: 23,
      loss: 0.0847,
