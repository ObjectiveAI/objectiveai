  ...
  return (
    <>
      {!entry.chunk && !entry.error && (
        <div className="max-w-content mx-auto mb-4 px-4">
          <div className="flex items-center gap-2 py-3 text-xs text-info-dim">
            <div className="flex gap-0.5">
              <span className="w-1 h-3 bg-copper-bright/60 rounded-sm animate-pulse" />
              <span className="w-1 h-3 bg-copper-bright/40 rounded-sm animate-pulse [animation-delay:150ms]" />
              <span className="w-1 h-3 bg-copper-bright/20 rounded-sm animate-pulse [animation-delay:300ms]" />
            </div>
