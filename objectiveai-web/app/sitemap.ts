...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    "/docs/api/get/functions/fremote/fowner/frepository/fcommit",
    "/docs/api/get/functions/fremote/fowner/frepository/fcommit/usage",
    "/docs/api/get/functions/fremote/fowner/frepository/fcommit/profiles/premote/powner/prepository/pcommit",
    "/docs/api/get/functions/fremote/fowner/frepository/fcommit/profiles/premote/powner/prepository/pcommit/usage",
    "/docs/api/get/functions/profiles",
    "/docs/api/get/functions/profiles/pairs",
    "/docs/api/get/functions/profiles/premote/powner/prepository/pcommit",
    "/docs/api/get/functions/profiles/premote/powner/prepository/pcommit/usage",
    ...
    "/docs/api/post/functions/fremote/fowner/frepository/fcommit",
    "/docs/api/post/functions/fremote/fowner/frepository/fcommit/profiles/premote/powner/prepository/pcommit",
    "/docs/api/post/functions/fremote/fowner/frepository/fcommit/profiles/compute",
    "/docs/api/post/functions/profiles/premote/powner/prepository/pcommit",
