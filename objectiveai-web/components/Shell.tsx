      ...
      {!isHome && !isDemo && !isViewerPreview && (
        <header className={styles.header}>
          <Link href="/" className={styles.logo}>
            <svg className={styles.logoMark} viewBox="0 0 324 324" fill="currentColor">
          ...
          <nav className={styles.nav}>
            <Link
              ...
              className={`${styles.navLink} ${
                pathname.startsWith("/explore") || pathname.startsWith("/functions") || pathname.startsWith("/swarms") || pathname.startsWith("/profiles") ? styles.navLinkActive : ""
              }`}
            >
              explore
            </Link>
