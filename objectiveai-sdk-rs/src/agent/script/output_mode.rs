...
//!
//! The output mode determines how the agent is constrained to select from
...
///
/// In vector completions, the agent must select from a predefined set of
...
#[schemars(rename = "agent.script.OutputMode")]
pub enum OutputMode {
