...
impl AlphaScalarBranchState {
    ...
    pub fn append_task_tool(
        ...
        crate::functions::inventions::InventionTool::new_sync::<crate::functions::inventions::ScalarBranchTaskObject>(
            "AppendTask",
            "Append Task",
            {
                let state = Arc::clone(this);
...
impl AlphaScalarBranchState {
    ...
    pub(super) fn deserialize_from_files(
        ...
        let (input_schema, tasks, description) = match function {
            Some(functions::alpha_scalar::RemoteFunction::Branch { description, input_schema, tasks }) => {
...
impl super::InventionState for AlphaScalarBranchState {
    ...
    fn prompt_type() -> crate::functions::inventions::prompts::StepPromptType { crate::functions::inventions::prompts::StepPromptType::AlphaScalarBranchFunction }
