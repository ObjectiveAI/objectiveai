...
impl AlphaVectorBranchState {
    ...
    pub fn append_task_tool(
        ...
        crate::functions::inventions::InventionTool::new_sync::<
            crate::functions::inventions::VectorBranchTaskObject,
...
impl AlphaVectorBranchState {
    ...
    pub(super) fn deserialize_from_files(
        ...
        let (input_schema, tasks, description) = match function {
            Some(functions::alpha_vector::RemoteFunction::Branch {
                description,
                input_schema,
                tasks,
...
impl super::InventionState for AlphaVectorBranchState {
    ...
    fn prompt_type() -> crate::functions::inventions::prompts::StepPromptType {
        crate::functions::inventions::prompts::StepPromptType::AlphaVectorBranchFunction
    }
    ...
    fn into_state(self) -> super::State {
        super::State::AlphaVectorBranch(self)
    }
    ...
    fn tasks_tools(
        ...
        tools.extend(crate::functions::inventions::schema_tools(&[
            "functions.alpha_vector.PlaceholderVectorFunctionTaskExpression",
            "functions.alpha_vector.PlaceholderScalarFunctionTaskExpression",
