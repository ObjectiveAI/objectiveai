...
#[serde(untagged)]
#[schemars(
    rename = "functions.inventions.prompts.InlinePromptOrRemoteCommitOptional"
)]
...
impl Prompt {
    ...
    pub fn essay_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        match self {
            Prompt::Remote(r) => r.essay_for_type(t),
            Prompt::Inline(i) => i.essay_for_type(t),
        }
    }
    pub fn input_schema_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        match self {
...
impl RemotePrompt {
    ...
    pub fn supports_type(&self, t: StepPromptType) -> bool {
        self.inner.supports_type(t)
    }
    pub fn essay_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        self.inner.essay_for_type(t)
    }
    pub fn input_schema_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        self.inner.input_schema_for_type(t)
    }
    pub fn essay_tasks_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        self.inner.essay_tasks_for_type(t)
    }
    pub fn tasks_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        self.inner.tasks_for_type(t)
    }
    pub fn description_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        self.inner.description_for_type(t)
    }
}
...
impl InlinePrompt {
    ...
    pub fn input_schema(&self) -> &[StepPromptExpression] {
        &self.input_schema_step
    }
    pub fn essay_tasks(&self) -> &[StepPromptExpression] {
        &self.essay_tasks_step
    }
    pub fn tasks(&self) -> &[StepPromptExpression] {
        &self.tasks_step
    }
    ...
    pub fn essay_for_type(
        ...
        find_for_type(&self.essay_step, t)
    }
    pub fn input_schema_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        find_for_type(&self.input_schema_step, t)
    }
    pub fn essay_tasks_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        find_for_type(&self.essay_tasks_step, t)
    }
    pub fn tasks_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        find_for_type(&self.tasks_step, t)
    }
    pub fn description_for_type(
        &self,
        t: StepPromptType,
    ) -> Option<&StepPromptExpression> {
        find_for_type(&self.description_step, t)
    }
}
