...
#[serde(untagged)]
#[schemars(rename = "cli.command.logs.agents.completions.response.messages.assistant.logprobs.Request")]
pub enum Request {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.logs.agents.completions.response.messages.assistant.logprobs.Response")]
#[serde(untagged)]
pub enum Response {
    #[schemars(title = "Clear")]
