...
#[schemars(rename = "cli.command.logs.agents.completions.response.continuations.get.response_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.logs.agents.completions.response.continuations.get.response_schema.Path")]
pub enum Path {
