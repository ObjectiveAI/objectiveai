...
#[schemars(rename = "cli.command.logs.agents.completions.response.clear.response_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.logs.agents.completions.response.clear.response_schema.Path")]
pub enum Path {
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::LogsAgentsCompletionsResponseClearResponseSchema, jq: args.jq })
    }
}
