...
#[schemars(rename = "cli.command.logs.agents.completions.response.messages.logprobs.subscribe.Request")]
pub struct Request {
    pub path_type: Path,
    pub id: String,
...
#[schemars(rename = "cli.command.logs.agents.completions.response.messages.logprobs.subscribe.Path")]
pub enum Path {
