...
#[schemars(rename = "cli.command.logs.agents.completions.response.messages.tool_calls.get.Request")]
pub struct Request {
    pub path_type: Path,
    pub id: String,
...
#[schemars(rename = "cli.command.logs.agents.completions.response.messages.tool_calls.get.Path")]
pub enum Path {
