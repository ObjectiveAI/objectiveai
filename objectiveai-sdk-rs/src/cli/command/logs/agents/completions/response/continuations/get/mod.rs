...
#[schemars(rename = "cli.command.logs.agents.completions.response.continuations.get.Request")]
pub struct Request {
    pub path_type: Path,
    pub id: String,
...
#[schemars(rename = "cli.command.logs.agents.completions.response.continuations.get.Path")]
pub enum Path {
