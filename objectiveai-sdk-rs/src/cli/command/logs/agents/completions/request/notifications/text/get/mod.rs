...
#[schemars(rename = "cli.command.logs.agents.completions.request.notifications.text.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.logs.agents.completions.request.notifications.text.get.Path")]
pub enum Path {
