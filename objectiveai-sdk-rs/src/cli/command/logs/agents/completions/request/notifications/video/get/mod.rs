...
#[schemars(rename = "cli.command.logs.agents.completions.request.notifications.video.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.logs.agents.completions.request.notifications.video.get.Path")]
pub enum Path {
