...
#[schemars(rename = "cli.command.logs.agents.completions.request.messages.text.get.Request")]
pub struct Request {
    pub path_type: Path,
    pub id: String,
...
#[schemars(rename = "cli.command.logs.agents.completions.request.messages.text.get.Path")]
pub enum Path {
