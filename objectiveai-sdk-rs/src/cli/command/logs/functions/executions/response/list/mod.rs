...
#[schemars(rename = "cli.command.logs.functions.executions.response.list.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.logs.functions.executions.response.list.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.logs.functions.executions.response.list.ResponseItem")]
