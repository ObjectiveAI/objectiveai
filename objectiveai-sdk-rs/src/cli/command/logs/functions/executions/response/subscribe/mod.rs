...
#[schemars(rename = "cli.command.logs.functions.executions.response.subscribe.Request")]
pub struct Request {
    pub path_type: Path,
    pub id: String,
    pub timeout_ms: u64,
...
#[schemars(rename = "cli.command.logs.functions.executions.response.subscribe.Path")]
pub enum Path {
