...
#[schemars(rename = "cli.command.logs.functions.executions.response.retry_tokens.clear.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.logs.functions.executions.response.retry_tokens.clear.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.logs.functions.executions.response.retry_tokens.clear.Response")]
pub struct Response {
    pub count: u64,
}
