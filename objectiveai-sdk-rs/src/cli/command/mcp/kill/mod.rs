...
#[schemars(rename = "cli.command.mcp.kill.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.mcp.kill.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.mcp.kill.Response")]
pub struct Response {
    pub killed: usize,
}
...
#[schemars(rename = "cli.command.mcp.kill.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.mcp.kill.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::McpKill, scope, base: args.base.into() })
    }
}
