...
#[schemars(rename = "cli.command.mcp.config.port.get.Path")]
pub enum Path {
    #[serde(rename = "mcp/config/port/get")]
    McpConfigPortGet,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.mcp.config.port.get.Response")]
pub struct Response {
    pub port: u16,
}
...
#[schemars(rename = "cli.command.mcp.config.port.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.mcp.config.port.get.ViewerResponse")]
