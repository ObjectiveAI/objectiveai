...
#[schemars(rename = "cli.command.mcp.config.port.set.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.mcp.config.port.set.Path")]
pub enum Path {
    #[serde(rename = "mcp/config/port/set")]
    McpConfigPortSet,
}
...
#[schemars(rename = "cli.command.mcp.config.port.set.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.mcp.config.port.set.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            base: args.base.into(), path_type: Path::McpConfigPortSet,
            scope,
