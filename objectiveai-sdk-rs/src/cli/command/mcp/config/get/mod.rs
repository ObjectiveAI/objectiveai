...
#[schemars(rename = "cli.command.mcp.config.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.mcp.config.get.Path")]
pub enum Path {
...
#[schemars(rename = "cli.command.mcp.config.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.mcp.config.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.mcp.config.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::McpConfigGet,
            scope,
            base: args.base.into(),
        })
    }
