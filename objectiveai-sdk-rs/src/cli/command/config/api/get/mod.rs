...
#[schemars(rename = "cli.command.config.api.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.api.get.Path")]
pub enum Path {
    #[serde(rename = "config/api/get")]
    ConfigApiGet,
}

impl CommandRequest for Request {
    fn into_command(&self) -> Vec<String> {
        let mut argv = vec!["config".to_string(), "api".to_string(), "get".to_string()];
...
#[schemars(rename = "cli.command.config.api.get.Response")]
pub struct Response {
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::ConfigApiGet,
            jq: args.jq,
        })
    }
}
