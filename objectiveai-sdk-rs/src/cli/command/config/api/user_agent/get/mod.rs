...
#[schemars(rename = "cli.command.config.api.user_agent.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.api.user_agent.get.Path")]
pub enum Path {
    #[serde(rename = "config/api/user_agent/get")]
    ConfigApiUserAgentGet,
}

impl CommandRequest for Request {
    fn into_command(&self) -> Vec<String> {
        let mut argv = vec!["config".to_string(), "api".to_string(), "user-agent".to_string(), "get".to_string()];
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.config.api.user_agent.get.Response")]
pub struct Response {
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ConfigApiUserAgentGet,
            scope,
            jq: args.jq,
        })
    }
