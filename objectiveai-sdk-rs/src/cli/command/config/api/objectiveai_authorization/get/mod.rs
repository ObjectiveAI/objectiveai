...
#[schemars(rename = "cli.command.config.api.objectiveai_authorization.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.api.objectiveai_authorization.get.Path")]
pub enum Path {
    #[serde(rename = "config/api/objectiveai_authorization/get")]
    ConfigApiObjectiveaiAuthorizationGet,
}

impl CommandRequest for Request {
    fn into_command(&self) -> Vec<String> {
        let mut argv = vec!["config".to_string(), "api".to_string(), "objectiveai-authorization".to_string(), "get".to_string()];
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.config.api.objectiveai_authorization.get.Response")]
pub struct Response {
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ConfigApiObjectiveaiAuthorizationGet,
            scope,
            jq: args.jq,
        })
    }
