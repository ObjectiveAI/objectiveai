...
#[schemars(rename = "cli.command.config.swarms.favorites.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.swarms.favorites.get.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.config.swarms.favorites.get.ResponseItem")]
