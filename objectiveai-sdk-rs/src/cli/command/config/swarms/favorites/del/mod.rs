...
#[schemars(rename = "cli.command.config.swarms.favorites.del.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.swarms.favorites.del.Path")]
pub enum Path {
...
impl CommandRequest for Request {
    fn into_command(&self) -> Vec<String> {
        let mut argv = vec!["config".to_string(), "swarms".to_string(), "favorites".to_string(), "del".to_string(), self.name.clone()];
