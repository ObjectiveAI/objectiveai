...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.favorites.add.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.favorites.add.Path")]
pub enum Path {
