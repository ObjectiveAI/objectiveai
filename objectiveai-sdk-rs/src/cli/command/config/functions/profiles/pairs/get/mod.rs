...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.get.Path")]
pub enum Path {
...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.get.Response")]
pub struct Response {
