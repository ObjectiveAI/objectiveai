...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.favorites.edit.response_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.functions.profiles.pairs.favorites.edit.response_schema.Path")]
pub enum Path {
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::ConfigFunctionsProfilesPairsFavoritesEditResponseSchema, jq: args.jq })
    }
}
