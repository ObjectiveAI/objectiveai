...
pub mod request_schema {
    ...
    impl TryFrom<Args> for Request {
        type Error = crate::cli::command::FromArgsError;
        fn try_from(args: Args) -> Result<Self, Self::Error> {
            Ok(Self { path_type: Path::ConfigFunctionsProfilesFavoritesEditRequestSchema, jq: args.jq })
        }
    }
...
pub mod response_schema {
    ...
    impl TryFrom<Args> for Request {
        type Error = crate::cli::command::FromArgsError;
        fn try_from(args: Args) -> Result<Self, Self::Error> {
            Ok(Self { path_type: Path::ConfigFunctionsProfilesFavoritesEditResponseSchema, jq: args.jq })
        }
    }
