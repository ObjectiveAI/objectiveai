...
#[schemars(rename = "cli.command.config.functions.profiles.favorites.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.functions.profiles.favorites.get.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.config.functions.profiles.favorites.get.ResponseItem")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ConfigFunctionsProfilesFavoritesGet, scope, jq: args.jq })
    }
}
