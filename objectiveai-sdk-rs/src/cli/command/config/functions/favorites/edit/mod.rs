...
#[schemars(rename = "cli.command.config.functions.favorites.edit.Request")]
pub struct Request {
    pub path_type: Path,
    pub name: String,
...
#[schemars(rename = "cli.command.config.functions.favorites.edit.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.config.functions.favorites.edit.RequestCommitChange")]
