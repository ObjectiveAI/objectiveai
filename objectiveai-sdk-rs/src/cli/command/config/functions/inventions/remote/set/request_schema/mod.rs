...
#[schemars(rename = "cli.command.config.functions.inventions.remote.set.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.functions.inventions.remote.set.request_schema.Path")]
pub enum Path {
