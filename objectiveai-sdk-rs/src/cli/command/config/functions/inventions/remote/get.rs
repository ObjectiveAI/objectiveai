...
pub enum Path {
    #[serde(rename = "config/functions/inventions/remote/get")]
    ConfigFunctionsInventionsRemoteGet,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::ConfigFunctionsInventionsRemoteGet,
            filter: args.filter,
            jq: args.jq,
        })
    }
...
pub mod request_schema {
    ...
    #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
    pub enum Path {
        #[serde(rename = "config/functions/inventions/remote/get/request_schema")]
        ConfigFunctionsInventionsRemoteGetRequestSchema,
    }
    #[derive(clap::Args)]
    pub struct Args {
        #[arg(long)]
    ...
    impl TryFrom<Args> for Request {
        type Error = crate::cli::command::FromArgsError;
        fn try_from(args: Args) -> Result<Self, Self::Error> {
            Ok(Self { path_type: Path::ConfigFunctionsInventionsRemoteGetRequestSchema, jq: args.jq })
        }
    }
...
pub mod response_schema {
    ...
    #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
    pub enum Path {
        #[serde(rename = "config/functions/inventions/remote/get/response_schema")]
        ConfigFunctionsInventionsRemoteGetResponseSchema,
    }
    #[derive(clap::Args)]
    pub struct Args {
        #[arg(long)]
    ...
    impl TryFrom<Args> for Request {
        type Error = crate::cli::command::FromArgsError;
        fn try_from(args: Args) -> Result<Self, Self::Error> {
            Ok(Self { path_type: Path::ConfigFunctionsInventionsRemoteGetResponseSchema, jq: args.jq })
        }
    }
