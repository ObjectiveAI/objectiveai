...
#[schemars(rename = "cli.command.config.functions.inventions.remote.set.response_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.functions.inventions.remote.set.response_schema.Path")]
pub enum Path {
