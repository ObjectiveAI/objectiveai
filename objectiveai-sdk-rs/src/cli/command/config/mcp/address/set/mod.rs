...
#[schemars(rename = "cli.command.config.mcp.address.set.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.config.mcp.address.set.Path")]
pub enum Path {
...
impl CommandRequest for Request {
    fn into_command(&self) -> Vec<String> {
        let mut argv = vec!["config".to_string(), "mcp".to_string(), "address".to_string(), "set".to_string(), self.value.clone()];
