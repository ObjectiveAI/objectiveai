...
#[schemars(rename = "cli.command.db.query.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.db.query.request_schema.Path")]
pub enum Path {
    #[serde(rename = "db/query/request_schema")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self {
            path_type: Path::DbQueryRequestSchema,
            base: args.base.into(),
        })
    }
}
...
/// One `/listen` broadcast run of `db query request_schema`: the actual
