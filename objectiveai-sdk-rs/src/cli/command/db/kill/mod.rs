...
#[schemars(rename = "cli.command.db.kill.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.db.kill.Path")]
pub enum Path {
    #[serde(rename = "db/kill")]
    DbKill,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.db.kill.Response")]
pub struct Response {
    pub killed: usize,
}
...
#[schemars(rename = "cli.command.db.kill.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.db.kill.ViewerResponse")]
