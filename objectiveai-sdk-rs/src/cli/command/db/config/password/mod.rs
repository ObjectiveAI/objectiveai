...
#[serde(untagged)]
#[schemars(rename = "cli.command.db.config.password.Request")]
pub enum Request {
    #[schemars(title = "Get")]
    Get(get::Request),
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.db.config.password.Response")]
#[serde(untagged)]
pub enum Response {
    #[schemars(title = "Get")]
    Get(get::Response),
...
#[serde(untagged)]
#[schemars(rename = "cli.command.db.config.password.ViewerRequest")]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.db.config.password.ViewerResponseItem")]
