//! `config db database get` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.db.config.database.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.db.config.database.get.Path")]
pub enum Path {
    #[serde(rename = "db/config/database/get")]
    DbConfigDatabaseGet,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.db.config.database.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.db.config.database.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.db.config.database.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::DbConfigDatabaseGet,
            scope,
            base: args.base.into(),
        })
    }
