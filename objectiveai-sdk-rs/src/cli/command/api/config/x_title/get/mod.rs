//! `config api x-title get` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.x_title.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.api.config.x_title.get.Path")]
pub enum Path {
    #[serde(rename = "api/config/x_title/get")]
    ApiConfigXTitleGet,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.x_title.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.api.config.x_title.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.x_title.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ApiConfigXTitleGet,
            scope,
            base: args.base.into(),
        })
    }
