//! `config api user-agent get` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.user_agent.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.api.config.user_agent.get.Path")]
pub enum Path {
    #[serde(rename = "api/config/user_agent/get")]
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.user_agent.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.api.config.user_agent.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.user_agent.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ApiConfigUserAgentGet,
            scope,
            base: args.base.into(),
        })
    }
