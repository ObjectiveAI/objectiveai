...
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.github_authorization.ViewerRequest")]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.github_authorization.ViewerResponseItem")]
