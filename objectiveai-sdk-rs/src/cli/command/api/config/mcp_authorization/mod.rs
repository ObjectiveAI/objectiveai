...
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.mcp_authorization.ViewerRequest")]
pub enum ViewerRequest {
    #[schemars(title = "Add")]
    Add(add::ViewerRequest),
    #[schemars(title = "Del")]
    Del(del::ViewerRequest),
    #[schemars(title = "Get")]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.mcp_authorization.ViewerResponseItem")]
pub enum ViewerResponseItem {
    #[schemars(title = "Add")]
    Add(add::ViewerResponse),
    #[schemars(title = "Del")]
    Del(del::ViewerResponse),
    #[schemars(title = "Get")]
