//! `config api get` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.api.config.get.Path")]
pub enum Path {
...
#[schemars(rename = "cli.command.api.config.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.api.config.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ApiConfigGet,
            scope,
            base: args.base.into(),
        })
    }
