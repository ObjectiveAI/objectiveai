...
#[schemars(rename = "cli.command.api.config.http_referer.set.Path")]
pub enum Path {
    #[serde(rename = "api/config/http_referer/set")]
...
#[schemars(rename = "cli.command.api.config.http_referer.set.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.http_referer.set.ViewerResponse")]
