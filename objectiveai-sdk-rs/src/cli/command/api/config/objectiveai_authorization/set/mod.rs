//! `config api objectiveai-authorization set` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.objectiveai_authorization.set.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.api.config.objectiveai_authorization.set.Path")]
pub enum Path {
    #[serde(rename = "api/config/objectiveai_authorization/set")]
...
#[schemars(rename = "cli.command.api.config.objectiveai_authorization.set.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.objectiveai_authorization.set.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            base: args.base.into(), path_type: Path::ApiConfigObjectiveaiAuthorizationSet,
            scope,
