//! `config api mcp-call-timeout-ms set` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.mcp_call_timeout_ms.set.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.api.config.mcp_call_timeout_ms.set.Path")]
pub enum Path {
    #[serde(rename = "api/config/mcp_call_timeout_ms/set")]
    ApiConfigMcpCallTimeoutMsSet,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self {
            base: args.base.into(), path_type: Path::ApiConfigMcpCallTimeoutMsSet,
...
/// One `/listen` broadcast run of `api config mcp_call_timeout_ms set`: the actual
