...
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.commit_author_name.Request")]
pub enum Request {
    #[schemars(title = "Get")]
    Get(get::Request),
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.commit_author_name.Response")]
#[serde(untagged)]
pub enum Response {
    #[schemars(title = "Get")]
    Get(get::Response),
...
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.commit_author_name.ViewerRequest")]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.commit_author_name.ViewerResponseItem")]
