...
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.Request")]
pub enum Request {
    #[schemars(title = "Get")]
    Get(get::Request),
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.Response")]
#[serde(untagged)]
pub enum Response {
    #[schemars(title = "Get")]
    Get(get::Response),
...
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.ViewerRequest")]
pub enum ViewerRequest {
    #[schemars(title = "Get")]
    Get(get::ViewerRequest),
    #[schemars(title = "Set")]
    Set(set::ViewerRequest),
}
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.ViewerResponseItem")]
pub enum ViewerResponseItem {
    #[schemars(title = "Get")]
    Get(get::ViewerResponse),
    #[schemars(title = "Set")]
    Set(set::ViewerResponse),
}
