//! `config api backoff-max-elapsed-time-ms get` — async handler stub.

use crate::cli::command::CommandRequest;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.get.Path")]
pub enum Path {
    #[serde(rename = "api/config/backoff_max_elapsed_time_ms/get")]
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ApiConfigBackoffMaxElapsedTimeMsGet,
            scope,
            base: args.base.into(),
        })
    }
