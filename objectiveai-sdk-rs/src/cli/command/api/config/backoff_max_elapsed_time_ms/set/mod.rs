...
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.set.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.api.config.backoff_max_elapsed_time_ms.set.ViewerResponse")]
