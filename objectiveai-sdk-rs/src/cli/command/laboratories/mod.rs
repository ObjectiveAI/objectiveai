...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.laboratories.ViewerRequest")]
pub enum ViewerRequest {
    #[schemars(title = "Create")]
    Create(create::ViewerRequest),
    #[schemars(title = "List")]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.laboratories.ViewerResponseItem")]
pub enum ViewerResponseItem {
    #[schemars(title = "Create")]
    Create(create::ViewerResponse),
    #[schemars(title = "List")]
