...
#[schemars(rename = "cli.command.laboratories.create.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.laboratories.create.request_schema.Path")]
pub enum Path {
    #[serde(rename = "laboratories/create/request_schema")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self {
            path_type: Path::LaboratoriesCreateRequestSchema,
            base: args.base.into(),
        })
    }
}
...
/// One `/listen` broadcast run of `laboratories create request_schema`: the actual
