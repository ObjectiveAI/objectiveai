...
#[schemars(rename = "cli.command.laboratories.kill.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.laboratories.kill.Path")]
pub enum Path {
    #[serde(rename = "laboratories/kill")]
    LaboratoriesKill,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.laboratories.kill.Response")]
pub struct Response {
    pub killed: usize,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::LaboratoriesKill, scope, base: args.base.into() })
    }
}
...
/// One `/listen` broadcast run of `laboratories kill`: the actual
