...
#[schemars(rename = "cli.command.plugins.install.github.Request")]
pub struct Request {
    pub path_type: Path,
    pub owner: String,
...
#[schemars(rename = "cli.command.plugins.install.github.Path")]
pub enum Path {
...
#[schemars(rename = "cli.command.plugins.install.github.Response")]
pub struct Response {
    pub installed: bool,
}
...
/// One `/listen` broadcast run of `plugins install github`: the actual
