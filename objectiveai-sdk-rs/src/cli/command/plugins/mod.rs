...
#[serde(untagged)]
#[schemars(rename = "cli.command.plugins.ViewerRequest")]
pub enum ViewerRequest {
    #[schemars(title = "Get")]
    Get(get::ViewerRequest),
    #[schemars(title = "Install")]
    Install(install::ViewerRequest),
    #[schemars(title = "List")]
    List(list::ViewerRequest),
    #[schemars(title = "Logs")]
    Logs(logs::ViewerRequest),
    #[schemars(title = "Run")]
    Run(run::ViewerRequest),
}
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.plugins.ViewerResponseItem")]
pub enum ViewerResponseItem {
    #[schemars(title = "Get")]
    Get(get::ViewerResponse),
    #[schemars(title = "Install")]
    Install(install::ViewerResponseItem),
    #[schemars(title = "List")]
    List(list::ViewerResponseItem),
    #[schemars(title = "Logs")]
    Logs(logs::ViewerResponseItem),
    #[schemars(title = "Run")]
    Run(run::ViewerResponseItem),
}
