...
#[schemars(rename = "cli.command.functions.executions.create.standard.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.functions.executions.create.standard.request_schema.Path")]
pub enum Path {
