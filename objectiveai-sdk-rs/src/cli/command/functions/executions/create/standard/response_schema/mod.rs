...
#[schemars(rename = "cli.command.functions.executions.create.standard.response_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.functions.executions.create.standard.response_schema.Path")]
pub enum Path {
