//! `functions inventions recursive create alpha-vector` â€” async handler stub.

use crate::cli::command::CommandRequest;
use crate::cli::command::agents::instances::spawn::AgentSpec;

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.functions.inventions.recursive.create.alpha_vector.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.functions.inventions.recursive.create.alpha_vector.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.functions.inventions.recursive.create.alpha_vector.RequestParams")]
...
#[schemars(rename = "cli.command.functions.inventions.recursive.create.alpha_vector.RequestDangerousAdvanced")]
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.functions.inventions.recursive.create.alpha_vector.ResponseItem")]
