...
#[schemars(rename = "cli.command.functions.inventions.recursive.create.remote.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.functions.inventions.recursive.create.remote.request_schema.Path")]
pub enum Path {
