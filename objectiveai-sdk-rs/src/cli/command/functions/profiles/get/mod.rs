...
pub struct Response {
    ...
    #[serde(flatten)]
    #[schemars(
        schema_with = "crate::flatten_schema::<crate::functions::RemoteProfile>"
    )]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::FunctionsProfilesGet, path, base: args.base.into() })
    }
}
...
/// One `/listen` broadcast run of `functions profiles get`: the actual
