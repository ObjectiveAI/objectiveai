...
#[schemars(rename = "cli.command.agents.list.active.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.agents.list.active.Path")]
pub enum Path {
    #[serde(rename = "agents/list/active")]
    AgentsListActive,
}
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.agents.list.active.ResponseItem")]
