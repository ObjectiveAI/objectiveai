...
#[serde(untagged)]
#[schemars(rename = "cli.command.agents.laboratories.Request")]
pub enum Request {
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.agents.laboratories.ResponseItem")]
#[serde(untagged)]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.agents.laboratories.ViewerRequest")]
pub enum ViewerRequest {
    #[schemars(title = "Attach")]
    Attach(attach::ViewerRequest),
    #[schemars(title = "Detach")]
    Detach(detach::ViewerRequest),
    #[schemars(title = "List")]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.agents.laboratories.ViewerResponseItem")]
pub enum ViewerResponseItem {
    #[schemars(title = "Attach")]
    Attach(attach::ViewerResponse),
    #[schemars(title = "Detach")]
    Detach(detach::ViewerResponse),
    #[schemars(title = "List")]
