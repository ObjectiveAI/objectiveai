...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.agents.ViewerRequest")]
pub enum ViewerRequest {
    #[schemars(title = "Enqueue")]
    Enqueue(enqueue::ViewerRequest),
    #[schemars(title = "Get")]
    Get(get::ViewerRequest),
    #[schemars(title = "Instances")]
    Instances(instances::ViewerRequest),
    #[schemars(title = "Laboratories")]
    Laboratories(laboratories::ViewerRequest),
    #[schemars(title = "List")]
    List(list::ViewerRequest),
    #[schemars(title = "Logs")]
    Logs(logs::ViewerRequest),
    #[schemars(title = "Mcp")]
    Mcp(mcp::ViewerRequest),
    #[schemars(title = "Message")]
    Message(message::ViewerRequest),
    #[schemars(title = "Publish")]
    Publish(publish::ViewerRequest),
    #[schemars(title = "Queue")]
    Queue(queue::ViewerRequest),
    #[schemars(title = "Spawn")]
    Spawn(spawn::ViewerRequest),
    #[schemars(title = "Tags")]
    Tags(tags::ViewerRequest),
    #[schemars(title = "Wait")]
    Wait(wait::ViewerRequest),
}
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[serde(untagged)]
#[schemars(rename = "cli.command.agents.ViewerResponseItem")]
pub enum ViewerResponseItem {
    #[schemars(title = "Enqueue")]
    Enqueue(enqueue::ViewerResponse),
    #[schemars(title = "Get")]
    Get(get::ViewerResponse),
    #[schemars(title = "Instances")]
    Instances(instances::ViewerResponseItem),
    #[schemars(title = "Laboratories")]
    Laboratories(laboratories::ViewerResponseItem),
    #[schemars(title = "List")]
    List(list::ViewerResponseItem),
    #[schemars(title = "Logs")]
    Logs(logs::ViewerResponseItem),
    #[schemars(title = "Mcp")]
    Mcp(mcp::ViewerResponseItem),
    #[schemars(title = "Message")]
    Message(message::ViewerResponse),
    #[schemars(title = "Publish")]
    Publish(publish::ViewerResponse),
    #[schemars(title = "Queue")]
    Queue(queue::ViewerResponseItem),
    #[schemars(title = "Spawn")]
    Spawn(spawn::ViewerResponseItem),
    #[schemars(title = "Tags")]
    Tags(tags::ViewerResponseItem),
    #[schemars(title = "Wait")]
    Wait(wait::ViewerResponse),
}
