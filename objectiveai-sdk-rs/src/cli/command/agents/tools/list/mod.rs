//! `agents tools list` — run `tools/list` against the per-`response_id`
...
#[schemars(rename = "cli.command.agents.tools.list.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.agents.tools.list.Path")]
pub enum Path {
    #[serde(rename = "agents/tools/list")]
    AgentsToolsList,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            path_type: Path::AgentsToolsList,
            response_id,
            params,
            base: args.base.into(),
        })
