//! `agents tools call` — run `tools/call` against the per-`response_id`
...
#[schemars(rename = "cli.command.agents.tools.call.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.agents.tools.call.Path")]
pub enum Path {
    #[serde(rename = "agents/tools/call")]
    AgentsToolsCall,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            path_type: Path::AgentsToolsCall,
            response_id,
            params,
            base: args.base.into(),
        })
