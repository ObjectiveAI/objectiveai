...
#[schemars(rename = "cli.command.agents.tags.remove.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.agents.tags.remove.request_schema.Path")]
pub enum Path {
    #[serde(rename = "agents/tags/remove/request_schema")]
    AgentsTagsRemoveRequestSchema,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self {
            path_type: Path::AgentsTagsRemoveRequestSchema,
            base: args.base.into(),
        })
    }
}
