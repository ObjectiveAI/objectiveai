...
#[schemars(rename = "cli.command.agents.read.id.request_schema.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.agents.read.id.request_schema.Path")]
pub enum Path {
    #[serde(rename = "agents/read/id/request_schema")]
    AgentsReadIdRequestSchema,
}
