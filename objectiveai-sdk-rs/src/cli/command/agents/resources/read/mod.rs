//! `agents resources read` — run `resources/read` against the
...
#[schemars(rename = "cli.command.agents.resources.read.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.agents.resources.read.Path")]
pub enum Path {
    #[serde(rename = "agents/resources/read")]
    AgentsResourcesRead,
}
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            path_type: Path::AgentsResourcesRead,
            response_id,
            params,
            base: args.base.into(),
        })
