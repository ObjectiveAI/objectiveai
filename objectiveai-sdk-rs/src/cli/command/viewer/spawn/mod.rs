...
#[schemars(rename = "cli.command.viewer.spawn.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.viewer.spawn.Path")]
pub enum Path {
    #[serde(rename = "viewer/spawn")]
    ViewerSpawn,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.spawn.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.viewer.spawn.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.spawn.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::ViewerSpawn, base: args.base.into() })
    }
}
