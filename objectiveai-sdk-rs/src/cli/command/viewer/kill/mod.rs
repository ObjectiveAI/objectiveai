...
#[schemars(rename = "cli.command.viewer.kill.Path")]
pub enum Path {
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.kill.Response")]
pub struct Response {
    pub killed: usize,
}
...
#[schemars(rename = "cli.command.viewer.kill.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.kill.ViewerResponse")]
