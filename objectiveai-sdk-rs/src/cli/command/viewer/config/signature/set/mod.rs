...
#[schemars(rename = "cli.command.viewer.config.signature.set.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.viewer.config.signature.set.Path")]
pub enum Path {
    #[serde(rename = "viewer/config/signature/set")]
...
#[schemars(rename = "cli.command.viewer.config.signature.set.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.config.signature.set.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            base: args.base.into(), path_type: Path::ViewerConfigSignatureSet,
            scope,
