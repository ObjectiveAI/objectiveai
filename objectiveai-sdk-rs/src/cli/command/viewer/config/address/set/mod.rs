...
#[schemars(rename = "cli.command.viewer.config.address.set.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.viewer.config.address.set.Path")]
pub enum Path {
    #[serde(rename = "viewer/config/address/set")]
...
#[schemars(rename = "cli.command.viewer.config.address.set.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.config.address.set.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            base: args.base.into(), path_type: Path::ViewerConfigAddressSet,
            scope,
