...
#[schemars(rename = "cli.command.viewer.config.address.get.Request")]
pub struct Request {
    pub path_type: Path,
...
#[schemars(rename = "cli.command.viewer.config.address.get.Path")]
pub enum Path {
    #[serde(rename = "viewer/config/address/get")]
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.config.address.get.Response")]
pub struct Response {
...
#[schemars(rename = "cli.command.viewer.config.address.get.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.viewer.config.address.get.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ...
        Ok(Self { path_type: Path::ViewerConfigAddressGet,
            scope,
            base: args.base.into(),
        })
    }
