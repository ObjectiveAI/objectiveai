...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::ViewerSpawn, jq: args.jq })
    }
}
...
pub mod request_schema {
    ...
    impl TryFrom<Args> for Request {
        type Error = crate::cli::command::FromArgsError;
        fn try_from(args: Args) -> Result<Self, Self::Error> {
            Ok(Self { path_type: Path::ViewerSpawnRequestSchema, jq: args.jq })
        }
    }
...
pub mod response_schema {
    ...
    impl TryFrom<Args> for Request {
        type Error = crate::cli::command::FromArgsError;
        fn try_from(args: Args) -> Result<Self, Self::Error> {
            Ok(Self { path_type: Path::ViewerSpawnResponseSchema, jq: args.jq })
        }
    }
