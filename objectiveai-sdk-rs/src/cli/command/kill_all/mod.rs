...
#[schemars(rename = "cli.command.kill_all.Request")]
pub struct Request {
    pub path_type: Path,
    #[serde(flatten)]
...
#[schemars(rename = "cli.command.kill_all.Path")]
pub enum Path {
    #[serde(rename = "kill-all")]
    KillAll,
}
...
#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.kill_all.Response")]
pub struct Response {
    pub killed: usize,
}
...
#[schemars(rename = "cli.command.kill_all.ViewerRequest")]
...
/// `path_type`.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, schemars::JsonSchema)]
#[schemars(rename = "cli.command.kill_all.ViewerResponse")]
...
impl TryFrom<Args> for Request {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        Ok(Self { path_type: Path::KillAll, base: args.base.into() })
    }
}
