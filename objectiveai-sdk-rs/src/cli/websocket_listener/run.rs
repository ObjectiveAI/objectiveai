...
//! transform (their items are post-transform JSON). A run whose
//! `path_type` this build's types predate — or whose request fails
//! to deserialize — is SKIPPED: no envelope, its frames dropped.
//!
...
pub enum Run {
    ...
    /// items are post-transform JSON, so the response is raw values
    /// (the request itself still parses as the typed root aggregate).
    Transformed {
        request: Box<crate::cli::command::Request>,
        agent_arguments: AgentArguments,
        response: ResponseItemStream<Value>,
    },
}

/// One run's feed side, held by the listener pump keyed by broadcast
/// id: response frames go through [`RunFeed::push`] into the typed
/// channel captured inside; [`RunFeed::close`] (the terminator, or
/// connection end) drops the captured sender — which ends the stream,
/// or settles an unresolved unary future with the synthesized
/// ended-without-response error.
pub(crate) struct RunFeed {
    push_fn: Box<dyn FnMut(Value) + Send>,
}
...
fn unary_feed<T: serde::de::DeserializeOwned + Send + 'static>(
    ...
    let mut tx = Some(tx);
    let push_fn = Box::new(move |value: Value| {
...
/// Open a run from its broadcast request frame: discriminate over the
/// request, build the matching [`Run`] variant, and hand back the
/// feed its response frames go through. Transform-bearing requests
/// (jq/python set) land on [`Run::Transformed`] regardless of leaf —
/// their items are post-transform JSON. `None` — an unrecognized
/// `path_type` or a request that fails to deserialize — means the
...
pub(crate) fn open_run(
    ...
    let transformed = request.get("jq").is_some_and(|v| !v.is_null())
        || request.get("python").is_some_and(|v| !v.is_null());
    if transformed {
        let parsed = serde_json::from_value::<crate::cli::command::Request>(request).ok()?;
        let (response, feed) = stream_feed::<Value>();
        return Some((
            Run::Transformed {
    ...
    match path_type {
        "agents/enqueue" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::enqueue::Request>(request).ok()?;
        ...
        "agents/enqueue/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::enqueue::request_schema::Request>(request).ok()?;
        ...
        "agents/enqueue/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::enqueue::response_schema::Request>(request).ok()?;
        ...
        "agents/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::get::Request>(request).ok()?;
        ...
        "agents/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::get::request_schema::Request>(request).ok()?;
        ...
        "agents/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::get::response_schema::Request>(request).ok()?;
        ...
        "agents/instances/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::instances::get::Request>(request).ok()?;
        ...
        "agents/instances/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::instances::get::request_schema::Request>(request).ok()?;
        ...
        "agents/instances/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::instances::get::response_schema::Request>(request).ok()?;
        ...
        "agents/instances/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::instances::list::Request>(request).ok()?;
        ...
        "agents/instances/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::instances::list::request_schema::Request>(request).ok()?;
        ...
        "agents/instances/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::instances::list::response_schema::Request>(request).ok()?;
        ...
        "agents/laboratories/attach" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::attach::Request>(request).ok()?;
        ...
        "agents/laboratories/attach/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::attach::request_schema::Request>(request).ok()?;
        ...
        "agents/laboratories/attach/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::attach::response_schema::Request>(request).ok()?;
        ...
        "agents/laboratories/detach" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::detach::Request>(request).ok()?;
        ...
        "agents/laboratories/detach/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::detach::request_schema::Request>(request).ok()?;
        ...
        "agents/laboratories/detach/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::detach::response_schema::Request>(request).ok()?;
        ...
        "agents/laboratories/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::list::Request>(request).ok()?;
        ...
        "agents/laboratories/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::list::request_schema::Request>(request).ok()?;
        ...
        "agents/laboratories/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::laboratories::list::response_schema::Request>(request).ok()?;
        ...
        "agents/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::list::Request>(request).ok()?;
        ...
        "agents/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::list::request_schema::Request>(request).ok()?;
        ...
        "agents/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::list::response_schema::Request>(request).ok()?;
        ...
        "agents/logs/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::list::Request>(request).ok()?;
        ...
        "agents/logs/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::list::request_schema::Request>(request).ok()?;
        ...
        "agents/logs/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::list::response_schema::Request>(request).ok()?;
        ...
        "agents/logs/open" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::open::Request>(request).ok()?;
        ...
        "agents/logs/open/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::open::request_schema::Request>(request).ok()?;
        ...
        "agents/logs/open/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::open::response_schema::Request>(request).ok()?;
        ...
        "agents/logs/subscribe" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::subscribe::Request>(request).ok()?;
        ...
        "agents/logs/subscribe/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::subscribe::request_schema::Request>(request).ok()?;
        ...
        "agents/logs/subscribe/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::subscribe::response_schema::Request>(request).ok()?;
        ...
        "agents/logs/token-usage/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::token_usage::get::Request>(request).ok()?;
        ...
        "agents/logs/token-usage/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::token_usage::get::request_schema::Request>(request).ok()?;
        ...
        "agents/logs/token-usage/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::token_usage::get::response_schema::Request>(request).ok()?;
        ...
        "agents/logs/token-usage/subscribe" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::token_usage::subscribe::Request>(request).ok()?;
        ...
        "agents/logs/token-usage/subscribe/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::token_usage::subscribe::request_schema::Request>(request).ok()?;
        ...
        "agents/logs/token-usage/subscribe/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::logs::token_usage::subscribe::response_schema::Request>(request).ok()?;
        ...
        "agents/mcp/resources/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::resources::list::Request>(request).ok()?;
        ...
        "agents/mcp/resources/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::resources::list::request_schema::Request>(request).ok()?;
        ...
        "agents/mcp/resources/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::resources::list::response_schema::Request>(request).ok()?;
        ...
        "agents/mcp/resources/read" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::resources::read::Request>(request).ok()?;
        ...
        "agents/mcp/resources/read/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::resources::read::request_schema::Request>(request).ok()?;
        ...
        "agents/mcp/resources/read/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::resources::read::response_schema::Request>(request).ok()?;
        ...
        "agents/mcp/servers/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::servers::list::Request>(request).ok()?;
        ...
        "agents/mcp/servers/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::servers::list::request_schema::Request>(request).ok()?;
        ...
        "agents/mcp/servers/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::servers::list::response_schema::Request>(request).ok()?;
        ...
        "agents/mcp/tools/call" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::tools::call::Request>(request).ok()?;
        ...
        "agents/mcp/tools/call/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::tools::call::request_schema::Request>(request).ok()?;
        ...
        "agents/mcp/tools/call/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::tools::call::response_schema::Request>(request).ok()?;
        ...
        "agents/mcp/tools/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::tools::list::Request>(request).ok()?;
        ...
        "agents/mcp/tools/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::tools::list::request_schema::Request>(request).ok()?;
        ...
        "agents/mcp/tools/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::mcp::tools::list::response_schema::Request>(request).ok()?;
        ...
        "agents/message" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::message::Request>(request).ok()?;
        ...
        "agents/message/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::message::request_schema::Request>(request).ok()?;
        ...
        "agents/message/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::message::response_schema::Request>(request).ok()?;
        ...
        "agents/publish" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::publish::Request>(request).ok()?;
        ...
        "agents/publish/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::publish::request_schema::Request>(request).ok()?;
        ...
        "agents/publish/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::publish::response_schema::Request>(request).ok()?;
        ...
        "agents/queue/delete" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::delete::Request>(request).ok()?;
        ...
        "agents/queue/delete/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::delete::request_schema::Request>(request).ok()?;
        ...
        "agents/queue/delete/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::delete::response_schema::Request>(request).ok()?;
        ...
        "agents/queue/deliver" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::deliver::Request>(request).ok()?;
        ...
        "agents/queue/deliver/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::deliver::request_schema::Request>(request).ok()?;
        ...
        "agents/queue/deliver/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::deliver::response_schema::Request>(request).ok()?;
        ...
        "agents/queue/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::list::Request>(request).ok()?;
        ...
        "agents/queue/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::list::request_schema::Request>(request).ok()?;
        ...
        "agents/queue/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::list::response_schema::Request>(request).ok()?;
        ...
        "agents/queue/open" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::open::Request>(request).ok()?;
        ...
        "agents/queue/open/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::open::request_schema::Request>(request).ok()?;
        ...
        "agents/queue/open/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::queue::open::response_schema::Request>(request).ok()?;
        ...
        "agents/spawn" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::spawn::Request>(request).ok()?;
        ...
        "agents/spawn/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::spawn::request_schema::Request>(request).ok()?;
        ...
        "agents/spawn/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::spawn::response_schema::Request>(request).ok()?;
        ...
        "agents/tags/apply" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::tags::apply::Request>(request).ok()?;
        ...
        "agents/tags/apply/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::tags::apply::request_schema::Request>(request).ok()?;
        ...
        "agents/tags/apply/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::tags::apply::response_schema::Request>(request).ok()?;
        ...
        "agents/tags/lookup/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::tags::lookup::request_schema::Request>(request).ok()?;
        ...
        "agents/tags/lookup/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::tags::lookup::response_schema::Request>(request).ok()?;
        ...
        "agents/wait" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::wait::Request>(request).ok()?;
        ...
        "agents/wait/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::wait::request_schema::Request>(request).ok()?;
        ...
        "agents/wait/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::agents::wait::response_schema::Request>(request).ok()?;
        ...
        "api/config/address/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::address::get::Request>(request).ok()?;
        ...
        "api/config/address/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::address::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/address/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::address::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/address/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::address::set::Request>(request).ok()?;
        ...
        "api/config/address/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::address::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/address/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::address::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/backoff_max_elapsed_time_ms/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::backoff_max_elapsed_time_ms::get::Request>(request).ok()?;
        ...
        "api/config/backoff_max_elapsed_time_ms/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::backoff_max_elapsed_time_ms::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/backoff_max_elapsed_time_ms/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::backoff_max_elapsed_time_ms::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/backoff_max_elapsed_time_ms/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::backoff_max_elapsed_time_ms::set::Request>(request).ok()?;
        ...
        "api/config/backoff_max_elapsed_time_ms/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::backoff_max_elapsed_time_ms::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/backoff_max_elapsed_time_ms/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::backoff_max_elapsed_time_ms::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_email/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_email::get::Request>(request).ok()?;
        ...
        "api/config/commit_author_email/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_email::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_email/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_email::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_email/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_email::set::Request>(request).ok()?;
        ...
        "api/config/commit_author_email/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_email::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_email/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_email::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_name/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_name::get::Request>(request).ok()?;
        ...
        "api/config/commit_author_name/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_name::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_name/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_name::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_name/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_name::set::Request>(request).ok()?;
        ...
        "api/config/commit_author_name/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_name::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/commit_author_name/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::commit_author_name::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::get::Request>(request).ok()?;
        ...
        "api/config/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/github_authorization/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::github_authorization::get::Request>(request).ok()?;
        ...
        "api/config/github_authorization/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::github_authorization::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/github_authorization/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::github_authorization::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/github_authorization/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::github_authorization::set::Request>(request).ok()?;
        ...
        "api/config/github_authorization/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::github_authorization::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/github_authorization/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::github_authorization::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/http_referer/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::http_referer::get::Request>(request).ok()?;
        ...
        "api/config/http_referer/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::http_referer::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/http_referer/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::http_referer::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/http_referer/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::http_referer::set::Request>(request).ok()?;
        ...
        "api/config/http_referer/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::http_referer::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/http_referer/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::http_referer::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/add" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::add::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/add/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::add::request_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/add/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::add::response_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/del" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::del::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/del/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::del::request_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/del/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::del::response_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::get::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_authorization/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_authorization::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_timeout_ms/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_timeout_ms::get::Request>(request).ok()?;
        ...
        "api/config/mcp_timeout_ms/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_timeout_ms::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_timeout_ms/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_timeout_ms::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_timeout_ms/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_timeout_ms::set::Request>(request).ok()?;
        ...
        "api/config/mcp_timeout_ms/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_timeout_ms::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/mcp_timeout_ms/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::mcp_timeout_ms::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/objectiveai_authorization/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::objectiveai_authorization::get::Request>(request).ok()?;
        ...
        "api/config/objectiveai_authorization/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::objectiveai_authorization::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/objectiveai_authorization/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::objectiveai_authorization::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/objectiveai_authorization/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::objectiveai_authorization::set::Request>(request).ok()?;
        ...
        "api/config/objectiveai_authorization/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::objectiveai_authorization::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/objectiveai_authorization/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::objectiveai_authorization::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/openrouter_authorization/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::openrouter_authorization::get::Request>(request).ok()?;
        ...
        "api/config/openrouter_authorization/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::openrouter_authorization::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/openrouter_authorization/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::openrouter_authorization::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/openrouter_authorization/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::openrouter_authorization::set::Request>(request).ok()?;
        ...
        "api/config/openrouter_authorization/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::openrouter_authorization::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/openrouter_authorization/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::openrouter_authorization::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/user_agent/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::user_agent::get::Request>(request).ok()?;
        ...
        "api/config/user_agent/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::user_agent::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/user_agent/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::user_agent::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/user_agent/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::user_agent::set::Request>(request).ok()?;
        ...
        "api/config/user_agent/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::user_agent::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/user_agent/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::user_agent::set::response_schema::Request>(request).ok()?;
        ...
        "api/config/x_title/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::x_title::get::Request>(request).ok()?;
        ...
        "api/config/x_title/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::x_title::get::request_schema::Request>(request).ok()?;
        ...
        "api/config/x_title/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::x_title::get::response_schema::Request>(request).ok()?;
        ...
        "api/config/x_title/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::x_title::set::Request>(request).ok()?;
        ...
        "api/config/x_title/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::x_title::set::request_schema::Request>(request).ok()?;
        ...
        "api/config/x_title/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::config::x_title::set::response_schema::Request>(request).ok()?;
        ...
        "api/kill" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::kill::Request>(request).ok()?;
        ...
        "api/kill/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::kill::request_schema::Request>(request).ok()?;
        ...
        "api/kill/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::kill::response_schema::Request>(request).ok()?;
        ...
        "api/spawn" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::spawn::Request>(request).ok()?;
        ...
        "api/spawn/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::spawn::request_schema::Request>(request).ok()?;
        ...
        "api/spawn/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::api::spawn::response_schema::Request>(request).ok()?;
        ...
        "daemon/kill" => {
            let parsed = serde_json::from_value::<crate::cli::command::daemon::kill::Request>(request).ok()?;
        ...
        "daemon/kill/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::daemon::kill::request_schema::Request>(request).ok()?;
        ...
        "daemon/kill/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::daemon::kill::response_schema::Request>(request).ok()?;
        ...
        "daemon/spawn" => {
            let parsed = serde_json::from_value::<crate::cli::command::daemon::spawn::Request>(request).ok()?;
        ...
        "daemon/spawn/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::daemon::spawn::request_schema::Request>(request).ok()?;
        ...
        "daemon/spawn/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::daemon::spawn::response_schema::Request>(request).ok()?;
        ...
        "db/config/address/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::address::get::Request>(request).ok()?;
        ...
        "db/config/address/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::address::get::request_schema::Request>(request).ok()?;
        ...
        "db/config/address/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::address::get::response_schema::Request>(request).ok()?;
        ...
        "db/config/address/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::address::set::Request>(request).ok()?;
        ...
        "db/config/address/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::address::set::request_schema::Request>(request).ok()?;
        ...
        "db/config/address/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::address::set::response_schema::Request>(request).ok()?;
        ...
        "db/config/database/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::database::get::Request>(request).ok()?;
        ...
        "db/config/database/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::database::get::request_schema::Request>(request).ok()?;
        ...
        "db/config/database/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::database::get::response_schema::Request>(request).ok()?;
        ...
        "db/config/database/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::database::set::Request>(request).ok()?;
        ...
        "db/config/database/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::database::set::request_schema::Request>(request).ok()?;
        ...
        "db/config/database/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::database::set::response_schema::Request>(request).ok()?;
        ...
        "db/config/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::get::Request>(request).ok()?;
        ...
        "db/config/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::get::request_schema::Request>(request).ok()?;
        ...
        "db/config/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::get::response_schema::Request>(request).ok()?;
        ...
        "db/config/password/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::password::get::Request>(request).ok()?;
        ...
        "db/config/password/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::password::get::request_schema::Request>(request).ok()?;
        ...
        "db/config/password/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::password::get::response_schema::Request>(request).ok()?;
        ...
        "db/config/password/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::password::set::Request>(request).ok()?;
        ...
        "db/config/password/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::password::set::request_schema::Request>(request).ok()?;
        ...
        "db/config/password/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::password::set::response_schema::Request>(request).ok()?;
        ...
        "db/config/user/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::user::get::Request>(request).ok()?;
        ...
        "db/config/user/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::user::get::request_schema::Request>(request).ok()?;
        ...
        "db/config/user/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::user::get::response_schema::Request>(request).ok()?;
        ...
        "db/config/user/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::user::set::Request>(request).ok()?;
        ...
        "db/config/user/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::user::set::request_schema::Request>(request).ok()?;
        ...
        "db/config/user/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::config::user::set::response_schema::Request>(request).ok()?;
        ...
        "db/kill" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::kill::Request>(request).ok()?;
        ...
        "db/kill/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::kill::request_schema::Request>(request).ok()?;
        ...
        "db/kill/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::kill::response_schema::Request>(request).ok()?;
        ...
        "db/query" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::query::Request>(request).ok()?;
        ...
        "db/query/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::query::request_schema::Request>(request).ok()?;
        ...
        "db/query/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::query::response_schema::Request>(request).ok()?;
        ...
        "db/spawn" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::spawn::Request>(request).ok()?;
        ...
        "db/spawn/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::spawn::request_schema::Request>(request).ok()?;
        ...
        "db/spawn/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::db::spawn::response_schema::Request>(request).ok()?;
        ...
        "functions/execute/standard" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::execute::standard::Request>(request).ok()?;
            if parsed.dangerous_advanced.as_ref().and_then(|a| a.stream) == Some(true) {
        ...
        "functions/execute/standard/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::execute::standard::request_schema::Request>(request).ok()?;
        ...
        "functions/execute/standard/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::execute::standard::response_schema::Request>(request).ok()?;
        ...
        "functions/execute/swiss_system" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::execute::swiss_system::Request>(request).ok()?;
            if parsed.dangerous_advanced.as_ref().and_then(|a| a.stream) == Some(true) {
        ...
        "functions/execute/swiss_system/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::execute::swiss_system::request_schema::Request>(request).ok()?;
        ...
        "functions/execute/swiss_system/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::execute::swiss_system::response_schema::Request>(request).ok()?;
        ...
        "functions/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::get::Request>(request).ok()?;
        ...
        "functions/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::get::request_schema::Request>(request).ok()?;
        ...
        "functions/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::get::response_schema::Request>(request).ok()?;
        ...
        "functions/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::list::Request>(request).ok()?;
        ...
        "functions/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::list::request_schema::Request>(request).ok()?;
        ...
        "functions/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::list::response_schema::Request>(request).ok()?;
        ...
        "functions/profiles/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::get::Request>(request).ok()?;
        ...
        "functions/profiles/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::get::request_schema::Request>(request).ok()?;
        ...
        "functions/profiles/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::get::response_schema::Request>(request).ok()?;
        ...
        "functions/profiles/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::list::Request>(request).ok()?;
        ...
        "functions/profiles/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::list::request_schema::Request>(request).ok()?;
        ...
        "functions/profiles/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::list::response_schema::Request>(request).ok()?;
        ...
        "functions/profiles/publish" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::publish::Request>(request).ok()?;
        ...
        "functions/profiles/publish/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::publish::request_schema::Request>(request).ok()?;
        ...
        "functions/profiles/publish/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::profiles::publish::response_schema::Request>(request).ok()?;
        ...
        "functions/publish" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::publish::Request>(request).ok()?;
        ...
        "functions/publish/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::publish::request_schema::Request>(request).ok()?;
        ...
        "functions/publish/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::functions::publish::response_schema::Request>(request).ok()?;
        ...
        "kill-all" => {
            let parsed = serde_json::from_value::<crate::cli::command::kill_all::Request>(request).ok()?;
        ...
        "kill-all/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::kill_all::request_schema::Request>(request).ok()?;
        ...
        "kill-all/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::kill_all::response_schema::Request>(request).ok()?;
        ...
        "laboratories/create" => {
            let parsed = serde_json::from_value::<crate::cli::command::laboratories::create::Request>(request).ok()?;
        ...
        "laboratories/create/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::laboratories::create::request_schema::Request>(request).ok()?;
        ...
        "laboratories/create/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::laboratories::create::response_schema::Request>(request).ok()?;
        ...
        "laboratories/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::laboratories::list::Request>(request).ok()?;
        ...
        "laboratories/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::laboratories::list::request_schema::Request>(request).ok()?;
        ...
        "laboratories/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::laboratories::list::response_schema::Request>(request).ok()?;
        ...
        "mcp/config/address/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::address::get::Request>(request).ok()?;
        ...
        "mcp/config/address/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::address::get::request_schema::Request>(request).ok()?;
        ...
        "mcp/config/address/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::address::get::response_schema::Request>(request).ok()?;
        ...
        "mcp/config/address/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::address::set::Request>(request).ok()?;
        ...
        "mcp/config/address/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::address::set::request_schema::Request>(request).ok()?;
        ...
        "mcp/config/address/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::address::set::response_schema::Request>(request).ok()?;
        ...
        "mcp/config/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::get::Request>(request).ok()?;
        ...
        "mcp/config/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::get::request_schema::Request>(request).ok()?;
        ...
        "mcp/config/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::get::response_schema::Request>(request).ok()?;
        ...
        "mcp/config/port/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::port::get::Request>(request).ok()?;
        ...
        "mcp/config/port/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::port::get::request_schema::Request>(request).ok()?;
        ...
        "mcp/config/port/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::port::get::response_schema::Request>(request).ok()?;
        ...
        "mcp/config/port/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::port::set::Request>(request).ok()?;
        ...
        "mcp/config/port/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::port::set::request_schema::Request>(request).ok()?;
        ...
        "mcp/config/port/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::config::port::set::response_schema::Request>(request).ok()?;
        ...
        "mcp/kill" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::kill::Request>(request).ok()?;
        ...
        "mcp/kill/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::kill::request_schema::Request>(request).ok()?;
        ...
        "mcp/kill/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::kill::response_schema::Request>(request).ok()?;
        ...
        "mcp/spawn" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::spawn::Request>(request).ok()?;
        ...
        "mcp/spawn/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::spawn::request_schema::Request>(request).ok()?;
        ...
        "mcp/spawn/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::mcp::spawn::response_schema::Request>(request).ok()?;
        ...
        "plugins/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::get::Request>(request).ok()?;
        ...
        "plugins/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::get::request_schema::Request>(request).ok()?;
        ...
        "plugins/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::get::response_schema::Request>(request).ok()?;
        ...
        "plugins/install/filesystem" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::install::filesystem::Request>(request).ok()?;
        ...
        "plugins/install/filesystem/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::install::filesystem::request_schema::Request>(request).ok()?;
        ...
        "plugins/install/filesystem/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::install::filesystem::response_schema::Request>(request).ok()?;
        ...
        "plugins/install/github" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::install::github::Request>(request).ok()?;
        ...
        "plugins/install/github/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::install::github::request_schema::Request>(request).ok()?;
        ...
        "plugins/install/github/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::install::github::response_schema::Request>(request).ok()?;
        ...
        "plugins/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::list::Request>(request).ok()?;
        ...
        "plugins/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::list::request_schema::Request>(request).ok()?;
        ...
        "plugins/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::list::response_schema::Request>(request).ok()?;
        ...
        "plugins/logs/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::logs::list::Request>(request).ok()?;
        ...
        "plugins/logs/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::logs::list::request_schema::Request>(request).ok()?;
        ...
        "plugins/logs/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::logs::list::response_schema::Request>(request).ok()?;
        ...
        "plugins/run" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::run::Request>(request).ok()?;
        ...
        "plugins/run/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::run::request_schema::Request>(request).ok()?;
        ...
        "plugins/run/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::plugins::run::response_schema::Request>(request).ok()?;
        ...
        "python" => {
            let parsed = serde_json::from_value::<crate::cli::command::python::Request>(request).ok()?;
        ...
        "python/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::python::request_schema::Request>(request).ok()?;
        ...
        "python/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::python::response_schema::Request>(request).ok()?;
        ...
        "swarms/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::get::Request>(request).ok()?;
        ...
        "swarms/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::get::request_schema::Request>(request).ok()?;
        ...
        "swarms/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::get::response_schema::Request>(request).ok()?;
        ...
        "swarms/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::list::Request>(request).ok()?;
        ...
        "swarms/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::list::request_schema::Request>(request).ok()?;
        ...
        "swarms/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::list::response_schema::Request>(request).ok()?;
        ...
        "swarms/publish" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::publish::Request>(request).ok()?;
        ...
        "swarms/publish/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::publish::request_schema::Request>(request).ok()?;
        ...
        "swarms/publish/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::swarms::publish::response_schema::Request>(request).ok()?;
        ...
        "tools/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::get::Request>(request).ok()?;
        ...
        "tools/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::get::request_schema::Request>(request).ok()?;
        ...
        "tools/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::get::response_schema::Request>(request).ok()?;
        ...
        "tools/install/filesystem" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::install::filesystem::Request>(request).ok()?;
        ...
        "tools/install/filesystem/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::install::filesystem::request_schema::Request>(request).ok()?;
        ...
        "tools/install/filesystem/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::install::filesystem::response_schema::Request>(request).ok()?;
        ...
        "tools/install/github" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::install::github::Request>(request).ok()?;
        ...
        "tools/install/github/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::install::github::request_schema::Request>(request).ok()?;
        ...
        "tools/install/github/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::install::github::response_schema::Request>(request).ok()?;
        ...
        "tools/list" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::list::Request>(request).ok()?;
        ...
        "tools/list/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::list::request_schema::Request>(request).ok()?;
        ...
        "tools/list/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::list::response_schema::Request>(request).ok()?;
        ...
        "tools/run" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::run::Request>(request).ok()?;
        ...
        "tools/run/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::run::request_schema::Request>(request).ok()?;
        ...
        "tools/run/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::tools::run::response_schema::Request>(request).ok()?;
        ...
        "update" => {
            let parsed = serde_json::from_value::<crate::cli::command::update::Request>(request).ok()?;
        ...
        "update/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::update::request_schema::Request>(request).ok()?;
        ...
        "update/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::update::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/address/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::address::get::Request>(request).ok()?;
        ...
        "viewer/config/address/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::address::get::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/address/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::address::get::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/address/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::address::set::Request>(request).ok()?;
        ...
        "viewer/config/address/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::address::set::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/address/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::address::set::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::get::Request>(request).ok()?;
        ...
        "viewer/config/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::get::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::get::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/secret/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::secret::get::Request>(request).ok()?;
        ...
        "viewer/config/secret/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::secret::get::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/secret/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::secret::get::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/secret/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::secret::set::Request>(request).ok()?;
        ...
        "viewer/config/secret/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::secret::set::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/secret/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::secret::set::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/signature/get" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::signature::get::Request>(request).ok()?;
        ...
        "viewer/config/signature/get/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::signature::get::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/signature/get/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::signature::get::response_schema::Request>(request).ok()?;
        ...
        "viewer/config/signature/set" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::signature::set::Request>(request).ok()?;
        ...
        "viewer/config/signature/set/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::signature::set::request_schema::Request>(request).ok()?;
        ...
        "viewer/config/signature/set/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::config::signature::set::response_schema::Request>(request).ok()?;
        ...
        "viewer/generate_secret_signature_pair" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::generate_secret_signature_pair::Request>(request).ok()?;
        ...
        "viewer/generate_secret_signature_pair/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::generate_secret_signature_pair::request_schema::Request>(request).ok()?;
        ...
        "viewer/generate_secret_signature_pair/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::generate_secret_signature_pair::response_schema::Request>(request).ok()?;
        ...
        "viewer/kill" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::kill::Request>(request).ok()?;
        ...
        "viewer/kill/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::kill::request_schema::Request>(request).ok()?;
        ...
        "viewer/kill/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::kill::response_schema::Request>(request).ok()?;
        ...
        "viewer/spawn" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::spawn::Request>(request).ok()?;
        ...
        "viewer/spawn/request_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::spawn::request_schema::Request>(request).ok()?;
        ...
        "viewer/spawn/response_schema" => {
            let parsed = serde_json::from_value::<crate::cli::command::viewer::spawn::response_schema::Request>(request).ok()?;
