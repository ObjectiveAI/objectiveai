...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    #[cfg(feature = "cli")]
    {
        schemas.extend([
            ...
            schemars::schema_for!(crate::cli::output::notification::CommandComplete),
            ...
            schemars::schema_for!(crate::cli::output::notification::Mcp),
            ...
            schemars::schema_for!(crate::cli::output::notification::agents::Inactive),
