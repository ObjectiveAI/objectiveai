...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    let mut schemas: Vec<schemars::Schema> = vec![
        ...
        schemars::schema_for!(crate::laboratories::filetree::FileKind),
        schemars::schema_for!(crate::laboratories::filetree::FileTreeEntry),
    ...
    schemas.extend([
        schemars::schema_for!(crate::cli::websocket_agents_instances_list_listener::AgentEvent),
