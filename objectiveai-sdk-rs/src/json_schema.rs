...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    let mut schemas: Vec<schemars::Schema> = vec![
        ...
        schemars::schema_for!(crate::agent::gemini::Agent),
        schemars::schema_for!(crate::agent::gemini::AgentBase),
        schemars::schema_for!(crate::agent::gemini::Continuation),
        schemars::schema_for!(crate::agent::gemini::ContentPart),
        schemars::schema_for!(crate::agent::gemini::Effort),
        schemars::schema_for!(crate::agent::gemini::Message),
        schemars::schema_for!(crate::agent::gemini::OutputMode),
        schemars::schema_for!(crate::agent::gemini::ToolCall),
        schemars::schema_for!(crate::agent::gemini::upstream::Upstream),
