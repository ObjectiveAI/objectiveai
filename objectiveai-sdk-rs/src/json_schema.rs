...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    schemas.extend([
        ...
        schemars::schema_for!(crate::cli::command::agents::list::response_schema::Request),        schemars::schema_for!(crate::cli::command::agents::logs::read::all::AssistantResponsePart),
