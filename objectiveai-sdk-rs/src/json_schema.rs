...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    schemas.extend([
        ...
        schemars::schema_for!(crate::cli::command::plugins::daemon::Request),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::Path),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::Request),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::Response),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::request_schema::Path),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::request_schema::Request),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::response_schema::Path),
        schemars::schema_for!(crate::cli::command::plugins::daemon::notify::response_schema::Request),
