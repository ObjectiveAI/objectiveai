...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    let mut schemas: Vec<schemars::Schema> = vec![
        ...
        schemars::schema_for!(crate::agent::openrouter::system_prompt::DeveloperMessage),
        schemars::schema_for!(crate::agent::openrouter::system_prompt::SystemMessage),
        schemars::schema_for!(crate::agent::openrouter::system_prompt::SystemPromptMessage),
