...
pub fn json_schemas() -> Vec<schemars::Schema> {
    ...
    schemas.extend([
        ...
        // `mcp.Backoff` lives in the otherwise-unshipped `src/mcp/`
        // module (skipped by the coverage walk), but `mcp_backoff get`'s
        // `Response` `$ref`s it — register it so that `$ref` resolves.
        // It's a flat numeric struct, so downstream generators handle it
        // fine (unlike the MCP wire types the skip exists for).
        schemars::schema_for!(crate::mcp::Backoff),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::Request),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::Path),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::Request),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::Response),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::request_schema::Path),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::request_schema::Request),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::response_schema::Path),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::get::response_schema::Request),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::set::Path),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::set::Request),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::set::request_schema::Path),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::set::request_schema::Request),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::set::response_schema::Path),
        schemars::schema_for!(crate::cli::command::api::config::mcp_backoff::set::response_schema::Request),
