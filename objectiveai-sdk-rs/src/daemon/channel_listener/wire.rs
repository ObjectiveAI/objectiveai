...
#[schemars(rename = "daemon.channel_listener.ChannelOffer")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, schemars::JsonSchema)]
#[schemars(rename = "daemon.channel_listener.ChannelEvent")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, schemars::JsonSchema)]
#[schemars(rename = "daemon.channel_listener.ChannelAccepted")]
