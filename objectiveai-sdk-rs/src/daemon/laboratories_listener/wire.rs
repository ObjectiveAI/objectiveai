...
#[schemars(rename = "daemon.laboratories_listener.LaboratoryAttachment")]
...
#[schemars(rename = "daemon.laboratories_listener.LaboratoryRecord")]
...
#[schemars(rename = "daemon.laboratories_listener.LaboratoryInstanceEvent")]
#[serde(tag = "type", rename_all = "snake_case")]
