...
#[schemars(rename = "daemon.command_listener.ListenerRequest.{T}")]
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[schemars(rename = "daemon.command_listener.ListenerResponse.{T}")]
...
/// docs.
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[schemars(rename = "daemon.command_listener.ListenerEnd")]
